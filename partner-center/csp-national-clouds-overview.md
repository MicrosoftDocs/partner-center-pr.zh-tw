...
-   [**由中國的世紀營運的 Azure 和 Office 365**](https://www.microsoft.com/trustcenter/cloudservices/nationalcloud#Microsoft_Cloud_for_China)Microsoft 透過與上海藍色雲端技術共同的獨特合作關係，在中國提供雲端服務。（世紀），這是一家全屬北京世紀寬頻資料中心 Co 的子公司，而有限公司則是最大的電訊商中立網際網路中國的資料中心、裝載、管理的網路和雲端運算基礎結構服務的提供者。 
