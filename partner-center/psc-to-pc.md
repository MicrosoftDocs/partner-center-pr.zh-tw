...
如您所知，您的公司將無法存取于2020年12月31日之後的 PSC。 您將會發現您想要建立共同銷售交易、管理您的交易，以及在合作夥伴中心的 Microsoft 銷售人員所傳送的交易方面採取行動。 不過，也會有一些差異，而下列指引將有助於讓您的轉換合作夥伴中心更順暢且更簡單的進展。
...
- 在合作夥伴中心中為所有您的 PSC 使用者 (系統管理員、交易管理員和賣方) 角色設定使用者帳戶，並為其指派 [參考系統管理員](https://docs.microsoft.com/partner-center/permissions-overview#manage-referrals) 角色。

### <a name="if-you-are-psc-deal-manager-or-seller"></a>如果您是 PSC 交易經理或賣方

- 您需要有工作電子郵件才能登入 [合作夥伴中心](https://partner.microsoft.com/)。
- 如果您在 PSC 中使用非工作帳戶，或您的公司電子郵件與夥伴組織的公司不同，請洽詢您的 PSC 系統管理員，以取得帳戶設定協助。
...
- OCP 見解-如果 Pdm 小組只是要查看與其相關的交易 & 進度，他們可以使用 OCP 見解入口網站來取得您的組織觀點。 這是內部工具，僅供 Pdm 小組和您的使用者使用。 請注意，您的公司使用者無法使用 OCP 見解。
