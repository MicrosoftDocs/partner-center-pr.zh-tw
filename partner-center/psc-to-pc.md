...
如您所知，您的公司將無法存取于2020年12月31日之後的 PSC。 您將會發現您想要管理交易的所有專案，並處理 Microsoft 銷售人員傳送給您合作夥伴中心的交易。 不過，也會有一些差異，而下列指引將有助於讓您的轉換合作夥伴中心更順暢且更簡單的進展。
...
- 使用合作夥伴中心 [帳戶管理員](https://docs.microsoft.com/partner-center/permissions-overview#manage-mpn-membership-and-your-company-non-aad-roles-these-roles-manage-the-company-business-rather-than-the-tenant)的協助來設定您的帳戶。
- 閱讀這份檔，瞭解如何在合作夥伴中心中共同銷售。
- 在合作夥伴中心中設定您的 PSC 交易管理員和賣方帳戶，並為其指派 [參考系統管理員](https://docs.microsoft.com/partner-center/permissions-overview#manage-referrals) 角色。

### <a name="if-you-are-psc-deal-manager-or-seller"></a>如果您是 PSC 交易經理或賣方

- 您需要有工作電子郵件才能登入 [合作夥伴中心](https://partner.microsoft.com/)。
- 如果您在 PSC 中使用非工作帳戶，或與其他人在 PSC 中使用的網域不同，請洽詢您的 PSC 系統管理員，以取得帳戶設定的說明。
...
如果您的公司有 PDM （當您的合作夥伴中心帳戶已設定，而且您的使用者已移動並具有角色和許可權）時，您可以將共同銷售活動移至合作夥伴中心。 通知 PDM 進行切換，讓您所有的新交易都流入合作夥伴中心。
>[!Note]
...
## <a name="next-steps-for-psc-admins-psc-deal-managers-and-psc-sellers"></a>適用于 PSC 管理員、PSC 交易經理和 PSC 銷售人員的後續步驟
...
|共同銷售要求|由 Microsoft 賣方起始，沒有合作夥伴的明確要求。|如果需要 Microsoft 銷售人員協助，合作夥伴將必須提出 [明確的要求](https://docs.microsoft.com/partner-center/manage-co-sell-opportunities#add-solutions) 。 Microsoft 賣方有一個拒絕要求的選項。|
...
|方案|只有一個價位清單的解決方案可以新增到交易中。|夥伴可以加入屬於下列清單的 [解決方案](https://docs.microsoft.com/partner-center/manage-co-sell-opportunities#add-solutions) 。 ) 自己的解決方案 b) 來自 Microsoft 第一方類別目錄的解決方案 (交易角色： PSC 中的交易) 和 c) 來自其他協力廠商合作夥伴的共同銷售解決方案 (交易角色： PSC) 中的 ISV。|
...
本節將協助您瞭解 PSC 與合作夥伴中心之間的確切屬性對應。 PSC 中的每個畫面都會與合作夥伴中心共同銷售商機一節中的相關觀點進行比較。 

>[!Note]
>遵循 PSC 螢幕擷取畫面中的黃色氣泡上的數位，在合作夥伴中心中尋找對等的屬性。 紅色的氣泡表示合作夥伴中心中未提供該欄位。

### <a name="home-page-of-psc-and-default-view-of-the-co-sell-opportunities-in-partner-center"></a>合作夥伴中心中共同銷售商機的 PSC 首頁和預設觀點

 :::image type="content" source="images/pscmigration/homepage.png" alt-text="顯示夥伴銷售 Connect 首頁之間的欄位對應，以及合作夥伴中心中共同銷售商機的預設觀點的影像。":::

### <a name="psc-grid-view-and-the-partner-center-deal-view"></a>PSC 格線視圖和合作夥伴中心交易視圖
...
### <a name="deal-details-view-in-psc-and-partner-center"></a>PSC 和合作夥伴中心的交易詳細資料檢視
...
- 預估的解決方案結束日期僅適用于 OEM IOT 交易。 任何其他交易類型都不會顯示。
...
### <a name="psc-add-products-view-and-the-partner-center-add-solutions-view"></a>PSC 新增產品視圖和合作夥伴中心新增解決方案視圖
...
### <a name="user-management-in-psc-and-partner-center"></a>PSC 和合作夥伴中心中的使用者管理
...
### <a name="q-the-new-deal-button-is-greyed-out-for-our-account-what-should-i-do-to-start-creating-deals"></a>Q. 我們的帳戶的 [+ 新增交易] 按鈕會呈現灰色。 我該怎麼做才能開始建立交易？

只有當您在合作夥伴中心中使用的 MPN 組織未附加共同銷售就緒的解決方案時，才會發生這種情況。 請洽詢您的 PDM 以取得解決方案的 MPN 識別碼，或建立支援票證，其中提及問題「新的交易按鈕在 PSC 遷移後呈現灰色」。

### <a name="q-can-i-assign-deals-to-a-specific-person-from-our-organization-like-psc"></a>Q. 我可以將交易指派給組織中的特定人員，例如 PSC 嗎？

您可以將小組成員指派給特定的交易。 它不會封鎖其他的參考管理員來進行流覽或處理這些交易。 

### <a name="q-is-there-a-view-of-all-the-deals-assigned-to-me"></a>Q. 是否有所有指派給我的交易的觀點？

您可以使用 [我的最愛] 功能，也就是使用者層級索引標籤。您可以將指派給您的所有交易都標示為 [我的最愛]，以快速存取交易。

### <a name="q-is-there-a-read-only-view-for-the-deals"></a>Q. 交易是否有唯讀的查看？

否，在 [參考] 區段中不會顯示交易的唯讀狀態。 所有的參考系統管理員都將擁有所有交易的完整讀取和寫入存取權。

### <a name="q-how-can-i-register-a-deal-after-making-it-as-won"></a>Q. 如何在將交易變成獲勝之後進行註冊？
...
### <a name="q-i-get-an-error-message-when-i-click-on-new-deal-registration-button-in-the-deal-registration-section-how-can-i-register-my-deals"></a>Q. 當我按一下交易登記區段中的 [+ 新增交易註冊] 按鈕時，我收到錯誤訊息。 如何註冊我的交易？

「+ 新交易註冊」僅供在 ISV connect 計畫中註冊的合作夥伴使用，在合作夥伴中心中沒有對應的共同銷售商機來註冊交易。 若要註冊具有共同銷售商機的交易，當交易被標示為「成功」且符合交易註冊的準則時，就會顯示快顯視窗。

### <a name="q-is-adding-a-customer-organization-mandatory"></a>Q. 是否要新增客戶組織的必要專案？
...
### <a name="q-are-customer-contact-details-mandatory"></a>Q. 客戶連絡人詳細資料是否為必要？
...
### <a name="q-how-many-solutions-can-i-add-to-a-deal"></a>Q. 我可以將多少解決方案新增到交易中？

您最多可以將50個解決方案 (PSC 中的產品) 至某項交易。 與 PSC 不同的是，您可以將解決方案與您自己的共同銷售合格解決方案、Microsoft 第一方 Sku 和其他協力廠商共同銷售合格的解決方案混合。 在合作夥伴中心內，不需要選取或提供任何交易角色。 針對 Microsoft Sku，您可以選擇性地為每個新增至交易的 SKU 新增數量和價格。

### <a name="q-when-will-i-get-to-know-the-microsoft-seller-details-after-creating-a-deal"></a>Q. 何時會在建立交易之後得知 Microsoft 賣方詳細資料？
...
### <a name="q-where-can-i-find-the-opportunity-id"></a>Q. 我可以在哪裡找到商機識別碼？

PSC 的商機識別碼與 PC 中的交易識別碼相同。 當您開啟任何交易時，您可以在交易名稱旁邊找到交易識別碼。

### <a name="q-how-can-my-pdm-get-access-to-pc"></a>Q. 我的 PDM 如何取得電腦的存取權？

您的 Pdm 小組無法直接存取與 PSC 不同的合作夥伴中心。 有多個選項可啟用這項功能，如下所述。

- OCP 見解-如果 Pdm 小組只是要查看與其相關的交易 & 進度，他們可以使用 OCP 見解入口網站來取得您的組織觀點。 這是內部工具，僅供 Pdm 小組和您的使用者使用。
