...
完成使用者遷移之後，請使用 [共同銷售商機] 頁面中的 [交易遷移嚮導]，將所有符合資格的 open 交易從 PSC 帶入電腦。 **交易遷移連結將只會顯示合作夥伴中心中整個組織範圍的推薦系統管理員。** 在共同銷售商機頁面的右上方會有稱為「 **PSC 交易遷移** 」的連結，該頁面將會開啟「交易遷移嚮導」。

開始進行交易遷移之前，請先閱讀本節。

**適用于遷移**

只有部分交易才有資格從 PSC 遷移至電腦。 這個遷移嚮導的設計，是為了協助合作夥伴將交易帶入合作夥伴中心他們仍在主動與客戶合作，以達成交易。 **只有處於開啟狀態且具有有效合作夥伴帳戶詳細資料的交易， (有效的 MPN 識別碼) 而不是進行交易註冊，才有資格進行遷移。**
...
合作夥伴中心的交易遷移是以單鍵體驗的形式來建立。 只要您的公司準備好遷移符合資格的交易，您只需要按一下 [ **遷移交易]** 按鈕即可。 **您無法選擇要從 PSC 遷移的交易。如果您不想要將任何交易遷移至合作夥伴中心，請在開始進行遷移之前，先將它們移到 PSC 的「已關閉」狀態。**
...
1. **合作夥伴中心 engagement** 識別碼-參與的所有交易合作夥伴中心中的唯一識別碼。 有兩個交易：一個適用于合作夥伴，另一個用於 Microsoft 的共同銷售參與合作夥伴中心。
2. **合作夥伴中心的參考** 識別碼-屬於夥伴之交易合作夥伴中心中的唯一識別碼。
