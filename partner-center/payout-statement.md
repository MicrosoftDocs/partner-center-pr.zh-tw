...
使用頁面右上角的日期範圍選取範圍來篩選頁面的輸出，以顯示過去3、6、12或36個月。 或者，選取最多36個月的自訂日期範圍。 預設的日期範圍為12個月。 您也可以依註冊識別碼、程式、付款識別碼、收益類型、杠杆和狀態進行篩選。 資料適用于目前的會計年度 (7 月1日到6月30日) 和前兩個會計年度。
...
- **狀態** –有三個選項：
    ...
    - 已 **處理**–已針對下一個付款準備收益。
    - 已 **傳送**–已支付收益。
- **預估的付款月份** –應支付收益的月份。 如需詳細資訊，請參閱 [下一節](#estimated-payment-month) 。
...
### <a name="transaction-adjustment-codes"></a>交易調整碼
...
### <a name="payments-download"></a>付款下載
 ...
 下表說明報表中的每個資料行。 若要查看您付款的詳細資料，請選取 [付款] 頁面頂端的 [ **下載** ]。
