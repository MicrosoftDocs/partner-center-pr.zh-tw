...
3. 從 [新增要求]**** 下拉式功能表中，選取 **Azure** 或 **Office 365、Dynamics 365、Enterprise Mobility Suite**。 您會被重新導向至 Microsoft Azure 入口網站或 Office 365 系統管理中心。
...
如果您直接登入 Office 365 系統管理中心，則會在您自己的內容中看到中心，而不是客戶的內容。 因此，當您為自己的訂用帳戶建立服務要求時，只應直接登入 Office 365 系統管理中心。
