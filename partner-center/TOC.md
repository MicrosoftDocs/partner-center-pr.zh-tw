...
## [取得公司電子郵件地址](buy-email-domain.md)
## 移至合作夥伴中心
### [從 PAC 移動 - 概觀](pac-to-pc-overview.md)
### [比較 PAC 和 PC 中的工作](moving-from-pac-to-pc.md)
### [在電腦上執行 PAC 工作](o365-partner-admin-center-to-partner-center.md)
## 從 PMC 移動
### [準備從 PMC 移轉](prepare-pmc-pc-migration.md)
### [從 PMC 移動的指南](guide-to-migration.md)
### [比較 PMC 和 PC](move-pmc-pc-map.md)
### [移動許多公司](move-multiple-companies.md)
### [合併公司](consolidate-accounts.md)
...
## [成為 Azure Expert MSP](azure-expert-msp.md)
## 優點
...
## 軟體保證
### [計畫概觀](software-assurance-lp.md)
### [教育訓練憑券 (SATV)](software-assurance-satv.md)
### [規劃服務 (PS)](software-assurance-dps.md)
#### [資格要求](software-assurance-dps-requirements.md)
## 發票和稅金
### [MPN 中的發票和稅金](mpn-view-print-maps-invoice.md)
## [測試新功能](test-drive-new-features.md)

# [雲端解決方案提供者 (CSP)](csp-overview.md)
## [註冊雲端解決方案提供者計畫](enrolling-in-the-csp-program.md)
## [Microsoft 合作夥伴合約 - 雲端解決方案提供者](microsoft-partner-agreement.md)
## [雲端解決方案提供者直接合作夥伴需求](direct-partner-new-requirements.md)
## [Microsoft 客戶合約 (依地區和語言)](agreements.md)
## [受限制的直接計費存取](restricted-direct-bill-capabilities.md)
## [從雲端解決方案提供者直接計費轉換到間接轉銷商](transition-direct-to-indirect.md)
## [雲端解決方案提供者合約、價目表和供應項目](csp-documents-and-learning-resources.md)
## [Cloudyn 提供適用於 CSP 的 Azure 成本管理](azure-cost-management-app-for-csp-partners.md)
## [雲端解決方案提供者地區市場及貨幣](regional-authorization-overview.md)
...
### [常見問題集 - Microsoft Cloud for US Government](faq-for-us-govt-cloud.md)
...
### [恢復 Azure CSP 訂用帳戶的系統管理員權限](revoke-reinstate-csp.md)
## [軟體訂閱](csp-software-subscriptions.md)
## [透過雲端解決方案提供者計畫銷售內部部署軟體](csp-on-premise-software.md)
