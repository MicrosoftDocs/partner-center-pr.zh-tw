...
---
# <a name="sample-monthly-billing-scenarios-for-new-subscriptions-changing-license-amounts-or-suspensions"></a>新訂用帳戶、變更授權數量或暫停的每月計費案例範例
...
如果您在合作夥伴中心中使用每月計費，則適用這些 [常見的計費案例](common-billing-scenarios.md) 。

## <a name="new-monthly-subscription"></a>新的每月訂閱
...
在2月1日，您會暫停訂用帳戶。 2 月 15 日的授權型對帳檔案將包含下列帳務明細：
...
因此，unit price =-1.716 (12 x 0.143 x (-1) # A3。

## <a name="next-steps"></a>後續步驟

- [一次性和選取週期性購買的計費案例](common-billing-scenarios-onetime-recurring.md)