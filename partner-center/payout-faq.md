...
本文將回答有關合作夥伴中心內支出和稅務詳細資料的常見問題。涵蓋的主題包含付款時間、檢查您的收益資格，以及正確設定款項和稅務設定檔的重要性。
...
#### <a name="how-do-i-find-set-up-or-update-payout-and-tax-details"></a>如何尋找、設定或更新支出和稅務詳細資料？

如需有關如何在合作夥伴中心更新付款和稅務詳細資料的詳細資訊，請參閱 [設定您的支出帳戶和稅務表單](set-up-your-payout-account.md)。
...
如果稅務設定檔已過期或即將到期，即表示您提供給 Microsoft 的稅務表單必須更新。 使用下列步驟來更新您的稅務設定檔：

1. 登入 [合作夥伴中心] [儀表板](https://partner.microsoft.com/dashboard/home)，然後選取齒輪圖示以開啟 [ **設定** ] 功能表。
2. 選取 [ **帳戶設定**]，展開 [支付 **和稅務** ] 區段，然後選取 [支付 **和稅務** 設定檔]。
3. 選取 **稅務** 設定檔
4. 檢查資料行的 **到期日** ，並流覽至已過期或即將到期的稅務設定檔。
5. 選取 [ **編輯** ] 以啟動稅務設定檔編輯流程。
6. 在 [稅務表單] 區段中，提供更新的詳細資料。
...
#### <a name="how-do-i-set-my-account-to-not-receive-payment"></a>如何將我的帳戶設定為不接受付款？
...
#### <a name="how-do-i-download-a-withholding-tax-form-in-pdf"></a>如何使用 PDF 下載預繳稅金表單？
...
#### <a name="how-do-i-view-historical-information"></a>如何查看歷程記錄資訊？
