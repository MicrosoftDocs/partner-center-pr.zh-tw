...
### <a name="impacted-audience"></a><span data-ttu-id="1c3b1-110">影響對象</span><span class="sxs-lookup"><span data-stu-id="1c3b1-110">Impacted audience</span></span>
...
### <a name="next-steps"></a><span data-ttu-id="1c3b1-125">後續步驟</span><span class="sxs-lookup"><span data-stu-id="1c3b1-125">Next steps</span></span>
...
### <a name="details"></a><span data-ttu-id="1c3b1-136">詳細資料</span><span class="sxs-lookup"><span data-stu-id="1c3b1-136">Details</span></span>
...
### <a name="categories"></a><span data-ttu-id="1c3b1-149">類別</span><span class="sxs-lookup"><span data-stu-id="1c3b1-149">Categories</span></span>
...
### <a name="next-steps"></a><span data-ttu-id="1c3b1-166">後續步驟：</span><span class="sxs-lookup"><span data-stu-id="1c3b1-166">Next steps:</span></span> 
...
### <a name="partner-center-enhancements"></a><span data-ttu-id="1c3b1-182">合作夥伴中心的增強功能</span><span class="sxs-lookup"><span data-stu-id="1c3b1-182">Partner Center enhancements</span></span> 
...
- <span data-ttu-id="1c3b1-207">日期：2020-09-29</span><span class="sxs-lookup"><span data-stu-id="1c3b1-207">Date: 2020-09-29</span></span>
...
| <span data-ttu-id="1c3b1-223">**計量**</span><span class="sxs-lookup"><span data-stu-id="1c3b1-223">**Metric**</span></span> | <span data-ttu-id="1c3b1-224">**更新的定義**</span><span class="sxs-lookup"><span data-stu-id="1c3b1-224">**Updated definitions**</span></span> |
|---------|:---------|
...
### <a name="categories"></a><span data-ttu-id="1c3b1-257">類別</span><span class="sxs-lookup"><span data-stu-id="1c3b1-257">Categories</span></span>
...
<span data-ttu-id="1c3b1-272">最近新增的報告：</span><span class="sxs-lookup"><span data-stu-id="1c3b1-272">Recently added reports:</span></span>
...
### <a name="summary"></a><span data-ttu-id="1c3b1-285">摘要</span><span class="sxs-lookup"><span data-stu-id="1c3b1-285">Summary</span></span>
...
- <span data-ttu-id="1c3b1-303">下載最新版本的 [.NET SDK v1.16.2](https://www.nuget.org/packages/Microsoft.Store.PartnerCenter/1.16.2)</span><span class="sxs-lookup"><span data-stu-id="1c3b1-303">Download the latest version of the [.NET SDK v1.16.2](https://www.nuget.org/packages/Microsoft.Store.PartnerCenter/1.16.2)</span></span>
...
<span data-ttu-id="1c3b1-332">將會對 CSP O365 使用量 API 進行更新，以協助合作夥伴測量其 O365 使用量。</span><span class="sxs-lookup"><span data-stu-id="1c3b1-332">Updates will be made to the CSP O365 usage APIs to help partners measure their O365 usage.</span></span>
...
<span data-ttu-id="1c3b1-358">動作：</span><span class="sxs-lookup"><span data-stu-id="1c3b1-358">Actions:</span></span>
...
- <span data-ttu-id="1c3b1-374">參加即將舉辦的一系列網路研討會，以取得 API 和合作夥伴中心報告更新的逐步解說。</span><span class="sxs-lookup"><span data-stu-id="1c3b1-374">Attend the upcoming webinar series for a walkthrough of the API and Partner Center reporting updates.</span></span> <span data-ttu-id="1c3b1-375">加入以下研討會：</span><span class="sxs-lookup"><span data-stu-id="1c3b1-375">Join below:</span></span> 
...
<span data-ttu-id="1c3b1-387">注意：如果您的間接轉銷商至少有一個租用戶已接受相同區域內的 MPA，則不需要採取進一步的動作。</span><span class="sxs-lookup"><span data-stu-id="1c3b1-387">Note: If your indirect reseller has at least one tenant that has accepted the MPA within the same region, no further action is required of them.</span></span> 
...
<span data-ttu-id="1c3b1-399">注意：自助式購買功能目前不適用於印度、巴西、剛果民主共和國 (DRC)，也不適用於符合政府或教育版優惠的客戶。</span><span class="sxs-lookup"><span data-stu-id="1c3b1-399">Note:  Self-service purchase capabilities aren’t currently available in India, Brazil, Democratic Republic of Congo (DRC), or to customers who are eligible for Government or Education offers.</span></span>  <span data-ttu-id="1c3b1-400">如需完整的國家/地區可用性和更新，請參閱[自助式購買常見問題](/microsoft-365/commerce/subscriptions/self-service-purchase-faq?preserve-view=true&view=o365-worldwide)。</span><span class="sxs-lookup"><span data-stu-id="1c3b1-400">Check the [self-service purchase FAQ](/microsoft-365/commerce/subscriptions/self-service-purchase-faq?preserve-view=true&view=o365-worldwide) for full country availability and updates.</span></span>

#### <a name="partner-benefits"></a><span data-ttu-id="1c3b1-401">合作夥伴權益</span><span class="sxs-lookup"><span data-stu-id="1c3b1-401">Partner benefits</span></span>

<span data-ttu-id="1c3b1-402">您將能夠為個人和團隊提供服務，而不需要經過集中化的 IT 採購程序來取得所需的授權。</span><span class="sxs-lookup"><span data-stu-id="1c3b1-402">You’ll be able to offer your services to individuals and teams without needing to go through a centralized IT procurement process to obtain required licenses.</span></span> <span data-ttu-id="1c3b1-403">根據 Microsoft 365 和 Power Platform 的整合案例，您的服務可以橫跨 Project 和 Visio。</span><span class="sxs-lookup"><span data-stu-id="1c3b1-403">Your services can span Project and Visio, based on integration scenarios with Microsoft 365 and Power Platform.</span></span> <span data-ttu-id="1c3b1-404">客戶也可以在購買之前先試用 Visio 和 Project 試用版，現已推出 [Visio 方案 1 和 Visio 方案 2](https://partner.microsoft.com/resources/collection/visio-availability-announcing-trial-offers#/)，以及 [Project 方案 1](https://www.microsoft.com/microsoft-365/project/compare-microsoft-project-management-software)。</span><span class="sxs-lookup"><span data-stu-id="1c3b1-404">Customers can also try before they buy with Visio and Project trials, available now for [Visio Plan 1 and Visio Plan 2](https://partner.microsoft.com/resources/collection/visio-availability-announcing-trial-offers#/), and [Project Plan 1](https://www.microsoft.com/microsoft-365/project/compare-microsoft-project-management-software).</span></span>


### <a name="next-steps"></a><span data-ttu-id="1c3b1-405">後續步驟</span><span class="sxs-lookup"><span data-stu-id="1c3b1-405">Next steps</span></span>

- <span data-ttu-id="1c3b1-406">請檢閱「作業整備度」資源庫中的所有整備資源：[客戶自助式購買功能](https://partner.microsoft.com/resources/collection/customer-self-serve-purchase#/)。</span><span class="sxs-lookup"><span data-stu-id="1c3b1-406">Review all readiness resources in the Operations Readiness resources gallery: [Customer self-serve purchase capability](https://partner.microsoft.com/resources/collection/customer-self-serve-purchase#/).</span></span> <span data-ttu-id="1c3b1-407">在 Microsoft Inspire 研習會「[利用 Microsoft Visio 和 Power Platform 重建和重新構思業務](https://www.microsoft.com/microsoft-365/partners/videos/inspire-visio-power-platform)」中，深入了解具有 Visio 和 Power Platform 解決方案的合作夥伴商機。</span><span class="sxs-lookup"><span data-stu-id="1c3b1-407">-Learn more about partner opportunities with Visio and Power Platform solutions in the Microsoft Inspire session [Rebuild and reimagine business with Microsoft Visio and Power Platform](https://www.microsoft.com/microsoft-365/partners/videos/inspire-visio-power-platform).</span></span>
- <span data-ttu-id="1c3b1-408">如需其他資訊，請參閱[自助式系統管理員指南](/microsoft-365/commerce/subscriptions/manage-self-service-purchases-admins?preserve-view=true&view=o365-worldwide)。</span><span class="sxs-lookup"><span data-stu-id="1c3b1-408">Refer to the [self-service admin guide](/microsoft-365/commerce/subscriptions/manage-self-service-purchases-admins?preserve-view=true&view=o365-worldwide) for additional information.</span></span>

________________

## <a name="new-skus-bring-the-power-of-project-cortex-and-more-to-customers"></a><a name="5"></a><span data-ttu-id="1c3b1-409">新的 SKU 將 Project Cortex 等技術的威力帶給客戶</span><span class="sxs-lookup"><span data-stu-id="1c3b1-409">New SKUs bring the power of Project Cortex and more to customers</span></span>

### <a name="categories"></a><span data-ttu-id="1c3b1-410">類別</span><span class="sxs-lookup"><span data-stu-id="1c3b1-410">Categories</span></span>

- <span data-ttu-id="1c3b1-411">日期：2020-09-08</span><span class="sxs-lookup"><span data-stu-id="1c3b1-411">Date: 2020-09-08</span></span>
- <span data-ttu-id="1c3b1-412">供應項目/市場</span><span class="sxs-lookup"><span data-stu-id="1c3b1-412">Offers/Markets</span></span>

### <a name="impacted-audience"></a><span data-ttu-id="1c3b1-413">影響對象</span><span class="sxs-lookup"><span data-stu-id="1c3b1-413">Impacted audience</span></span>

<span data-ttu-id="1c3b1-414">透過雲端解決方案提供者 (CSP) 方案交易的所有合作夥伴</span><span class="sxs-lookup"><span data-stu-id="1c3b1-414">All partners transacting through the Cloud Solution Provider (CSP) program</span></span>

### <a name="summary"></a><span data-ttu-id="1c3b1-415">摘要</span><span class="sxs-lookup"><span data-stu-id="1c3b1-415">Summary</span></span>

<span data-ttu-id="1c3b1-416">可協助客戶充分利用 [Project Cortex](https://resources.techcommunity.microsoft.com/project-cortex-microsoft-365/) 和 [Project Turing](https://msturing.org/) 威力的新 SKU 將於 2020 年 10 月 1 日起開放交易。</span><span class="sxs-lookup"><span data-stu-id="1c3b1-416">New SKUs to help customers harness the power of [Project Cortex](https://resources.techcommunity.microsoft.com/project-cortex-microsoft-365/) and [Project Turing](https://msturing.org/) will be available to transact from October 1, 2020.</span></span>

### <a name="details"></a><span data-ttu-id="1c3b1-417">詳細資料</span><span class="sxs-lookup"><span data-stu-id="1c3b1-417">Details</span></span>

<span data-ttu-id="1c3b1-418">我們很高興地宣佈包括 [Project Cortex](https://resources.techcommunity.microsoft.com/project-cortex-microsoft-365/) (智慧型內容服務) 和 Microsoft Search (包括適用於 Microsoft Search 的 Microsoft Graph 連接器) 在內的新 SKU 將於 2020 年 10 月 1 日正式推出，可讓使用者更有效率地尋找及管理資訊。</span><span class="sxs-lookup"><span data-stu-id="1c3b1-418">We’re excited to announce the October 1, 2020 availability of new SKUs including [Project Cortex](https://resources.techcommunity.microsoft.com/project-cortex-microsoft-365/) (Intelligent Content Services) and Microsoft Search (including Microsoft Graph Connectors for Search) that will enable users to find and manage information more efficiently.</span></span>  

#### <a name="intelligent-content-services"></a><span data-ttu-id="1c3b1-419">智慧型內容服務</span><span class="sxs-lookup"><span data-stu-id="1c3b1-419">Intelligent Content Services</span></span>
  
<span data-ttu-id="1c3b1-420">智慧型內容服務使用進階 AI 來自動擷取、標記和管理內容。</span><span class="sxs-lookup"><span data-stu-id="1c3b1-420">Intelligent Content Services uses advanced AI to automate the capture, tagging, and management of content.</span></span> <span data-ttu-id="1c3b1-421">其建置於 SharePoint 之上，以便能夠處理大量內容、擷取中繼資料以進行程序自動化，以及實現更細微的安全性和合規性。</span><span class="sxs-lookup"><span data-stu-id="1c3b1-421">It builds on SharePoint for high-volume content processing, extracting metadata for process automation, and fine-grained security and compliance.</span></span> <span data-ttu-id="1c3b1-422">智慧型內容服務會藉由將更正確且更精確的內容推送至您的知識網路，來改善知識的鑑藏和探索體驗。</span><span class="sxs-lookup"><span data-stu-id="1c3b1-422">Intelligent content services improve knowledge curation and discovery experiences by pushing more accurate and precise content into your knowledge network.</span></span> <span data-ttu-id="1c3b1-423">新的智慧型內容服務 SKU 可於 **10 月 1 日的價目表** (以及 9 月 1 日的價目表預覽) 中取得。</span><span class="sxs-lookup"><span data-stu-id="1c3b1-423">New Intelligent Content Services SKUs will be available on the **October 1 price list** (and on the September 1 price list preview).</span></span> 
 
<span data-ttu-id="1c3b1-424">**注意：** 智慧型內容服務是此產品的預留位置名稱，2020 年 10 月 1 日之後可能會更名。</span><span class="sxs-lookup"><span data-stu-id="1c3b1-424">**Note:** Intelligent Content Services is a placeholder name for this product, which is likely to be rebranded after October 1, 2020.</span></span>
 
<span data-ttu-id="1c3b1-425">**適用於 Microsoft Search 的 Microsoft Graph 連接器** Microsoft Graph 連接器可讓客戶為外部存放庫中的項目編制索引，以納入 Microsoft Search 結果。</span><span class="sxs-lookup"><span data-stu-id="1c3b1-425">**Microsoft Graph connectors for Microsoft Search** Microsoft Graph connectors enable customers to index items in external repositories for inclusion in Microsoft Search results.</span></span> 

<span data-ttu-id="1c3b1-426">自 2020 年 10 月 1 日起：</span><span class="sxs-lookup"><span data-stu-id="1c3b1-426">From October 1, 2020:</span></span> 

- <span data-ttu-id="1c3b1-427">Microsoft 365 E5 和 Office 365 E5 將能夠使用適用於 Microsoft Search 的 Microsoft Graph 連接器 (A5 中未包含)，為多達 500 個項目編制索引。</span><span class="sxs-lookup"><span data-stu-id="1c3b1-427">Microsoft 365 E5 and Office 365 E5 will include the ability to index up to 500 items using Microsoft Graph connectors for Microsoft Search (not included with A5).</span></span>  
- <span data-ttu-id="1c3b1-428">任何具有套件或獨立授權 (包含 SharePoint 或 OneDrive 方案) 的使用者，都可以從適用於 Microsoft Search 的 Microsoft Graph 連接器查看搜尋結果。</span><span class="sxs-lookup"><span data-stu-id="1c3b1-428">Any user with a suite or standalone license that includes a SharePoint or OneDrive plan will be able to see search results from Microsoft Graph connectors for Microsoft Search.</span></span> 
- <span data-ttu-id="1c3b1-429">將有新的**額外 Graph 連接器容量 SKU** 可供您另外編制多達 100 萬個項目的索引。</span><span class="sxs-lookup"><span data-stu-id="1c3b1-429">A new **Extra Graph Connector Capacity SKU** will be available for indexing up to 1 million additional items.</span></span>  

#### <a name="offer-details"></a><span data-ttu-id="1c3b1-430">供應項目詳細資料</span><span class="sxs-lookup"><span data-stu-id="1c3b1-430">Offer details</span></span>

   |<span data-ttu-id="1c3b1-431">**供應項目名稱**</span><span class="sxs-lookup"><span data-stu-id="1c3b1-431">**Offer name**</span></span>|<span data-ttu-id="1c3b1-432">**優惠識別碼**</span><span class="sxs-lookup"><span data-stu-id="1c3b1-432">**Offer ID**</span></span>|<span data-ttu-id="1c3b1-433">**材質識別碼**</span><span class="sxs-lookup"><span data-stu-id="1c3b1-433">**Material ID**</span></span>|
   |-------------------|:------|:------|
   |<span data-ttu-id="1c3b1-434">智慧型內容服務</span><span class="sxs-lookup"><span data-stu-id="1c3b1-434">Intelligent Content Services</span></span>|<span data-ttu-id="1c3b1-435">2e969027-6eca-44a3-88fb-e7923e2c147f</span><span class="sxs-lookup"><span data-stu-id="1c3b1-435">2e969027-6eca-44a3-88fb-e7923e2c147f</span></span>|<span data-ttu-id="1c3b1-436">5YI-00004</span><span class="sxs-lookup"><span data-stu-id="1c3b1-436">5YI-00004</span></span>|
   |<span data-ttu-id="1c3b1-437">智慧型內容服務 (非盈利組織員工定價)</span><span class="sxs-lookup"><span data-stu-id="1c3b1-437">Intelligent Content Services (Nonprofit Staff Pricing)</span></span>|<span data-ttu-id="1c3b1-438">48db24e2-0aac-47bd-bd74-40bde9ff7748</span><span class="sxs-lookup"><span data-stu-id="1c3b1-438">48db24e2-0aac-47bd-bd74-40bde9ff7748</span></span>|<span data-ttu-id="1c3b1-439">5YI-00005</span><span class="sxs-lookup"><span data-stu-id="1c3b1-439">5YI-00005</span></span>|
   |<span data-ttu-id="1c3b1-440">適用於教職員的智慧型內容服務</span><span class="sxs-lookup"><span data-stu-id="1c3b1-440">Intelligent Content Services for faculty</span></span>|<span data-ttu-id="1c3b1-441">4a8f9036-791e-4ce4-a788-6c5af859fd82</span><span class="sxs-lookup"><span data-stu-id="1c3b1-441">4a8f9036-791e-4ce4-a788-6c5af859fd82</span></span>|<span data-ttu-id="1c3b1-442">5Z1-00005</span><span class="sxs-lookup"><span data-stu-id="1c3b1-442">5Z1-00005</span></span>|
   |<span data-ttu-id="1c3b1-443">額外的 Graph 連接器容量</span><span class="sxs-lookup"><span data-stu-id="1c3b1-443">Extra Graph Connector Capacity</span></span>|<span data-ttu-id="1c3b1-444">9c8b008f-d84f-46cd-a588-fea84947161d</span><span class="sxs-lookup"><span data-stu-id="1c3b1-444">9c8b008f-d84f-46cd-a588-fea84947161d</span></span>|<span data-ttu-id="1c3b1-445">1LA-00002</span><span class="sxs-lookup"><span data-stu-id="1c3b1-445">1LA-00002</span></span>|
   |<span data-ttu-id="1c3b1-446">適用於教職員的額外 Graph 連接器容量</span><span class="sxs-lookup"><span data-stu-id="1c3b1-446">Extra Graph Connector Capacity for faculty</span></span>|<span data-ttu-id="1c3b1-447">0e0eb210-86e7-4038-9905-4fd5bf71c4bd</span><span class="sxs-lookup"><span data-stu-id="1c3b1-447">0e0eb210-86e7-4038-9905-4fd5bf71c4bd</span></span>|<span data-ttu-id="1c3b1-448">1TL-00003</span><span class="sxs-lookup"><span data-stu-id="1c3b1-448">1TL-00003</span></span>|

### <a name="next-steps"></a><span data-ttu-id="1c3b1-449">後續步驟</span><span class="sxs-lookup"><span data-stu-id="1c3b1-449">Next steps</span></span>

- <span data-ttu-id="1c3b1-450">檢閱本主題的資源，並與您組織中適當的利害關係人分享這些資源。</span><span class="sxs-lookup"><span data-stu-id="1c3b1-450">Review the resources for this topic and share them with the appropriate stakeholders in your organization.</span></span>
- <span data-ttu-id="1c3b1-451">如果您對這些供應項目有任何疑問，請洽詢相關的 Yammer 社群。</span><span class="sxs-lookup"><span data-stu-id="1c3b1-451">If you have any questions about these offers, check your relevant Yammer communities.</span></span>

________________

## <a name="enhanced-incentives-support-experience-and-ticket-creation-process"></a><a name="4"></a><span data-ttu-id="1c3b1-452">提升的獎勵支援體驗和票證建立程式</span><span class="sxs-lookup"><span data-stu-id="1c3b1-452">Enhanced Incentives support experience and ticket creation process</span></span>

### <a name="categories"></a><span data-ttu-id="1c3b1-453">類別</span><span class="sxs-lookup"><span data-stu-id="1c3b1-453">Categories</span></span>

- <span data-ttu-id="1c3b1-454">日期：2020-09-02</span><span class="sxs-lookup"><span data-stu-id="1c3b1-454">Date: 2020-09-02</span></span>
- <span data-ttu-id="1c3b1-455">功能</span><span class="sxs-lookup"><span data-stu-id="1c3b1-455">Capabilities</span></span>

### <a name="impacted-audience"></a><span data-ttu-id="1c3b1-456">影響對象</span><span class="sxs-lookup"><span data-stu-id="1c3b1-456">Impacted audience</span></span>

<span data-ttu-id="1c3b1-457">所有合作夥伴</span><span class="sxs-lookup"><span data-stu-id="1c3b1-457">All partners</span></span>

### <a name="summary"></a><span data-ttu-id="1c3b1-458">摘要</span><span class="sxs-lookup"><span data-stu-id="1c3b1-458">Summary</span></span>

<span data-ttu-id="1c3b1-459">合作夥伴獎勵支援體驗已透過改良的自助式內容探索能力和簡化的線上票證提交程序獲得強化。</span><span class="sxs-lookup"><span data-stu-id="1c3b1-459">The Partner Incentives support experience has been enhanced with improved self-help content discoverability and a streamlined online ticket submission process.</span></span>

### <a name="details"></a><span data-ttu-id="1c3b1-460">詳細資料</span><span class="sxs-lookup"><span data-stu-id="1c3b1-460">Details</span></span>

<span data-ttu-id="1c3b1-461">已增對合作夥伴獎勵新增增強功能，透過更優異的自助式內容探索能力和簡化的票證提交程序來改善您的整體支援體驗，以減少支援過程中必須來回收集資料的情形。</span><span class="sxs-lookup"><span data-stu-id="1c3b1-461">Enhancements have been added for Partner Incentives to improve your overall support experience through better self-help content discoverability and a streamlined ticket submission process that reduces back-and-forth data collection during the support process.</span></span>

#### <a name="new-capabilities"></a><span data-ttu-id="1c3b1-462">新功能</span><span class="sxs-lookup"><span data-stu-id="1c3b1-462">New capabilities</span></span>

- <span data-ttu-id="1c3b1-463">新的搜尋式自助體驗可在[合作夥伴中心](https://aka.ms/IncentivesSupport)內以及 [Microsoft 合作夥伴網路](https://partner.microsoft.com/support/?stage=1) (若使用非合作夥伴中心帳戶) 上存取。</span><span class="sxs-lookup"><span data-stu-id="1c3b1-463">New search-based self-help experience is accessible within [Partner Center](https://aka.ms/IncentivesSupport) and on [Microsoft Partner Network](https://partner.microsoft.com/support/?stage=1) for non-Partner Center accounts.</span></span> <span data-ttu-id="1c3b1-464">新的體驗包含新的疑難排解步驟、常見問題集和相關自助文章的連結，以及在 Microsoft 合作夥伴網路支援頁面上。</span><span class="sxs-lookup"><span data-stu-id="1c3b1-464">The new experience includes new troubleshooting steps, FAQs, and links to relevant self-help articles as well as on the Microsoft Partner Network Support page.</span></span>
- <span data-ttu-id="1c3b1-465">直接在合作夥伴中心起始新的支援要求。</span><span class="sxs-lookup"><span data-stu-id="1c3b1-465">Initiate a new support request directly in Partner Center.</span></span> <span data-ttu-id="1c3b1-466">在檢視可用的主題特定說明之後，如果您仍然需要協助，就只能直接從合作夥伴中心建立票證。</span><span class="sxs-lookup"><span data-stu-id="1c3b1-466">After viewing the available topic-specific help, if you still need assistance, you can only create a ticket directly from Partner Center.</span></span>
- <span data-ttu-id="1c3b1-467">每個自助主題都有新的問題界定問題。</span><span class="sxs-lookup"><span data-stu-id="1c3b1-467">New problem-scoping questions are available for every self-help topic.</span></span> <span data-ttu-id="1c3b1-468">完成這些問題可讓服務專員事先獲得許多重要的詳細資料，藉此大量降低支援票證一開始就必須來回收集資料的情形。</span><span class="sxs-lookup"><span data-stu-id="1c3b1-468">Completing these questions reduces much of the back-and-forth at the beginning of the support ticket by providing the agent with many of the important details up front.</span></span>


### <a name="next-steps"></a><span data-ttu-id="1c3b1-469">後續步驟</span><span class="sxs-lookup"><span data-stu-id="1c3b1-469">Next steps</span></span>

- <span data-ttu-id="1c3b1-470">與您組織中的其他人共用這項資訊。</span><span class="sxs-lookup"><span data-stu-id="1c3b1-470">Share this information with others in your organization.</span></span> 
- <span data-ttu-id="1c3b1-471">透過[合作夥伴中心](https://aka.ms/IncentivesSupport)或在 [Microsoft 合作夥伴網路](https://partner.microsoft.com/support/?stage=1)上使用新的支援體驗，以滿足您所有的獎勵支援需求。</span><span class="sxs-lookup"><span data-stu-id="1c3b1-471">Use the new support experience via [Partner Center](https://aka.ms/IncentivesSupport) or on [Microsoft Partner Network](https://partner.microsoft.com/support/?stage=1) for all your Incentives support requirements.</span></span> 

<span data-ttu-id="1c3b1-472">**注意：** 不接受透過直接電子郵件來提交支援要求，因此此功能已遭到淘汰。</span><span class="sxs-lookup"><span data-stu-id="1c3b1-472">**Note:** Support requests will not be accepted through direct email, as this function is retired.</span></span>

________________

## <a name="upcoming-new-microsoft-dynamics-365-offers"></a><a name="3"></a><span data-ttu-id="1c3b1-473">即將推出新的 Microsoft Dynamics 365 供應項目</span><span class="sxs-lookup"><span data-stu-id="1c3b1-473">Upcoming new Microsoft Dynamics 365 offers</span></span>

### <a name="categories"></a><span data-ttu-id="1c3b1-474">類別</span><span class="sxs-lookup"><span data-stu-id="1c3b1-474">Categories</span></span>

- <span data-ttu-id="1c3b1-475">日期：2020-09-01</span><span class="sxs-lookup"><span data-stu-id="1c3b1-475">Date: 2020-09-01</span></span>
- <span data-ttu-id="1c3b1-476">供應項目/市場</span><span class="sxs-lookup"><span data-stu-id="1c3b1-476">Offers/Markets</span></span>

### <a name="impacted-audience"></a><span data-ttu-id="1c3b1-477">影響對象</span><span class="sxs-lookup"><span data-stu-id="1c3b1-477">Impacted audience</span></span>

<span data-ttu-id="1c3b1-478">交易 Microsoft Dynamics 365 的合作夥伴</span><span class="sxs-lookup"><span data-stu-id="1c3b1-478">Partners transacting Microsoft Dynamics 365</span></span>

### <a name="summary"></a><span data-ttu-id="1c3b1-479">摘要</span><span class="sxs-lookup"><span data-stu-id="1c3b1-479">Summary</span></span>

<span data-ttu-id="1c3b1-480">即將為 Microsoft Dynamics 365 客戶推出的供應項目，包括 Microsoft Project Operations 的發行，以及適用於 Business Central 的其他環境。</span><span class="sxs-lookup"><span data-stu-id="1c3b1-480">Upcoming offers for Microsoft Dynamics 365 customers include the release of Microsoft Project Operations, and additional environments for Business Central.</span></span>

### <a name="details"></a><span data-ttu-id="1c3b1-481">詳細資料</span><span class="sxs-lookup"><span data-stu-id="1c3b1-481">Details</span></span>

<span data-ttu-id="1c3b1-482">2020 年 10 月 1 日將推出下列新的供應項目。</span><span class="sxs-lookup"><span data-stu-id="1c3b1-482">The following new offers will be available on October 1, 2020.</span></span>

#### <a name="project-operations"></a><span data-ttu-id="1c3b1-483">專案作業</span><span class="sxs-lookup"><span data-stu-id="1c3b1-483">Project Operations</span></span>

<span data-ttu-id="1c3b1-484">Microsoft 將在 2020 年 10 月 1 日發行 Dynamics 365 Project Operations 供應項目，並移除雲端解決方案提供者 (CSP) 計畫的 Dynamics 365 Project Service Automation (PSA)。</span><span class="sxs-lookup"><span data-stu-id="1c3b1-484">On October 1, 2020, Microsoft will release Dynamics 365 Project Operations offers and remove Dynamics 365 Project Service Automation (PSA) for the Cloud Solution Provider (CSP) program.</span></span> <span data-ttu-id="1c3b1-485">新客戶必須購買 Dynamics 365 Project Operations。</span><span class="sxs-lookup"><span data-stu-id="1c3b1-485">New customers must purchase Dynamics 365 Project Operations.</span></span> 

<span data-ttu-id="1c3b1-486">對於具有 PSA 的現有 Dynamics 365 客戶：</span><span class="sxs-lookup"><span data-stu-id="1c3b1-486">For existing Dynamics 365 customers with PSA:</span></span>

- <span data-ttu-id="1c3b1-487">繼續使用 Dynamics 365 PSA，直到 2020 年 10 月 1 日或其最近的合約或續約到期為止 (以先發生者為準)。</span><span class="sxs-lookup"><span data-stu-id="1c3b1-487">Continue to use Dynamics 365 PSA until October 1, 2020, or until the end of their most recent contract or renewal, whichever occurs first.</span></span>
- <span data-ttu-id="1c3b1-488">在 CSP 中，Dynamics 365 PSA 在 2021 年 10 月 1 日之前將可自動續約一年，讓合約延續到 2022 年 10 月 1 日為止。</span><span class="sxs-lookup"><span data-stu-id="1c3b1-488">Dynamics 365 PSA will autorenew for one year until October 1, 2021 in CSP, allowing contracts to continue until October 1, 2022.</span></span>
- <span data-ttu-id="1c3b1-489">在 2020 年 12 月 31 日之前，Dynamics 365 PSA 授權會將 Project Operations 自動納入為其目前授權的一部分。</span><span class="sxs-lookup"><span data-stu-id="1c3b1-489">Dynamics 365 PSA licenses will automatically receive Project Operations as part of their current licenses by December 31, 2020.</span></span>
- <span data-ttu-id="1c3b1-490">在 Dynamics 365 PSA 合約結束時，客戶必須轉換到 Project Operations，使用者最小 PSA 轉換 SKU 將為零。</span><span class="sxs-lookup"><span data-stu-id="1c3b1-490">At the end of Dynamics 365 PSA contracts, customers need to transition to Project Operations, which will have a zero user minimum PSA transition SKU.</span></span>

<span data-ttu-id="1c3b1-491">如需供應項目識別碼詳細資料，請參閱 [Dynamics CSP Offers-October 2020 Excel 文件](https://partner.microsoft.com/resources/detail/microsoft-dynamics-365-new-ids-offers-csp-october-2020-xls)中的 [Project Operations] 索引標籤。</span><span class="sxs-lookup"><span data-stu-id="1c3b1-491">Review the Project Operations tab in the [Dynamics CSP Offers-October 2020 Excel document](https://partner.microsoft.com/resources/detail/microsoft-dynamics-365-new-ids-offers-csp-october-2020-xls) for the offer ID details.</span></span>

#### <a name="additional-resources"></a><span data-ttu-id="1c3b1-492">其他資源</span><span class="sxs-lookup"><span data-stu-id="1c3b1-492">Additional resources</span></span>

- <span data-ttu-id="1c3b1-493">適用於 PSA 的[轉換資源](https://partner.microsoft.com/asset/collection/psa-transition-resources#/)</span><span class="sxs-lookup"><span data-stu-id="1c3b1-493">[Transition resources](https://partner.microsoft.com/asset/collection/psa-transition-resources#/) for PSA</span></span>
- <span data-ttu-id="1c3b1-494">[介紹 Microsoft Dynamics 365 Project Service Automation](https://cloudblogs.microsoft.com/dynamics365/bdm/2020/02/20/introducing-microsoft-dynamics-365-project-operations/) 部落格</span><span class="sxs-lookup"><span data-stu-id="1c3b1-494">[Introducing Microsoft Dynamics 365 Project Service Automation](https://cloudblogs.microsoft.com/dynamics365/bdm/2020/02/20/introducing-microsoft-dynamics-365-project-operations/) blog</span></span>
- <span data-ttu-id="1c3b1-495">[Microsoft Dynamics 365 Project Service Automation 的展望](https://assetsprod.microsoft.com/mpn/what-is-coming-in-d365-project-service-automation-dyn767pal.pdf)訓練材料</span><span class="sxs-lookup"><span data-stu-id="1c3b1-495">[What is coming in Microsoft Dynamics 365 Project Service Automation](https://assetsprod.microsoft.com/mpn/what-is-coming-in-d365-project-service-automation-dyn767pal.pdf) training material</span></span>

#### <a name="expansion-of-business-central-offers-into-additional-countries"></a><span data-ttu-id="1c3b1-496">將 Business Central 供應項目擴展至其他國家/地區</span><span class="sxs-lookup"><span data-stu-id="1c3b1-496">Expansion of Business Central offers into additional countries</span></span>

<span data-ttu-id="1c3b1-497">Microsoft 將在 2020 年 10 月 1 日起，將 Business Central 雲端供應項目擴充至巴西、愛爾蘭、立陶宛、法羅群島和格陵蘭。</span><span class="sxs-lookup"><span data-stu-id="1c3b1-497">On October 1, 2020, Microsoft is expanding Business Central Cloud offers into Brazil, Ireland, Lithuania, the Faroe Islands, and Greenland.</span></span>

#### <a name="business-central-additional-environments"></a><span data-ttu-id="1c3b1-498">Business Central 的其他環境</span><span class="sxs-lookup"><span data-stu-id="1c3b1-498">Business Central additional environments</span></span>

<span data-ttu-id="1c3b1-499">自 2020 年 10 月 1 日起，我們將提供 Business Central 雲端供應項目的新附加元件，讓客戶能夠新增額外的環境。</span><span class="sxs-lookup"><span data-stu-id="1c3b1-499">On October 1, 2020, new add-on offers for Business Central Cloud offers will be available to enable customers to add extra environments.</span></span> 

<span data-ttu-id="1c3b1-500">請參閱 [Dynamics CSP Offers-October 2020 Excel 文件](https://partner.microsoft.com/resources/detail/microsoft-dynamics-365-new-ids-offers-csp-october-2020-xls)中的 [其他環境] 索引標籤，以取得供應項目識別碼詳細資料。</span><span class="sxs-lookup"><span data-stu-id="1c3b1-500">Review the **Additional Environments** tab in the [Dynamics CSP Offers-October 2020 Excel document](https://partner.microsoft.com/resources/detail/microsoft-dynamics-365-new-ids-offers-csp-october-2020-xls) for the offer ID details.</span></span>

### <a name="next-steps"></a><span data-ttu-id="1c3b1-501">後續步驟</span><span class="sxs-lookup"><span data-stu-id="1c3b1-501">Next steps</span></span>

<span data-ttu-id="1c3b1-502">請向組織中的相關連絡人告知此更新。</span><span class="sxs-lookup"><span data-stu-id="1c3b1-502">Share this update with the relevant contacts in your organization.</span></span>

________________

## <a name="office-365-calling-plan-will-be-available-in-new-markets-on-october-1-2020"></a><a name="2"></a><span data-ttu-id="1c3b1-503">自 2020 年 10 月 1 日起將在新市場開始提供 Microsoft 365 通話方案</span><span class="sxs-lookup"><span data-stu-id="1c3b1-503">Office 365 Calling Plan will be available in new markets on October 1, 2020</span></span>

### <a name="categories"></a><span data-ttu-id="1c3b1-504">類別</span><span class="sxs-lookup"><span data-stu-id="1c3b1-504">Categories</span></span>

- <span data-ttu-id="1c3b1-505">日期：2020-09-01</span><span class="sxs-lookup"><span data-stu-id="1c3b1-505">Date: 2020-09-01</span></span>
- <span data-ttu-id="1c3b1-506">供應項目/市場</span><span class="sxs-lookup"><span data-stu-id="1c3b1-506">Offers/Markets</span></span>

### <a name="impacted-audience"></a><span data-ttu-id="1c3b1-507">影響對象</span><span class="sxs-lookup"><span data-stu-id="1c3b1-507">Impacted audience</span></span>

<span data-ttu-id="1c3b1-508">雲端解決方案提供者 (CSP) 合作夥伴，包括直接提供者、間接提供者與間接轉銷商</span><span class="sxs-lookup"><span data-stu-id="1c3b1-508">Cloud Solution Provider (CSP) partners, including direct providers, indirect providers, and indirect resellers</span></span>

### <a name="summary"></a><span data-ttu-id="1c3b1-509">摘要</span><span class="sxs-lookup"><span data-stu-id="1c3b1-509">Summary</span></span>

<span data-ttu-id="1c3b1-510">Microsoft 很高興地宣佈，下列新市場將在 2020 年 10 月 1 日起開始提供通話方案：奧地利、丹麥、義大利、葡萄牙、瑞典和瑞士。</span><span class="sxs-lookup"><span data-stu-id="1c3b1-510">Microsoft is excited to announce that Calling Plan will be available in the following new markets on October 1, 2020: Austria, Denmark, Italy, Portugal, Sweden, and Switzerland.</span></span> 

### <a name="details"></a><span data-ttu-id="1c3b1-511">詳細資料</span><span class="sxs-lookup"><span data-stu-id="1c3b1-511">Details</span></span>

<span data-ttu-id="1c3b1-512">下列新市場將在 2020 年 10 月 1 日起開始提供 Microsoft 365 通話方案：奧地利、丹麥、義大利、葡萄牙、瑞典和瑞士。</span><span class="sxs-lookup"><span data-stu-id="1c3b1-512">Microsoft 365 Calling Plan will be available in the following new markets on October 1, 2020: Austria, Denmark, Italy, Portugal, Sweden, and Switzerland.</span></span> <span data-ttu-id="1c3b1-513">新的地區可用性將透過 Enterprise 合約 (EA) 或 Enterprise 合約訂用帳戶 (EAS)、教育解決方案註冊 (EES)、Web Direct 和 CSP，在商業、全球公共部門、非營利和政府社群雲端中啟動。</span><span class="sxs-lookup"><span data-stu-id="1c3b1-513">The new geo availability will launch in Commercial, Worldwide Public Sector, Nonprofit, and Government Community Cloud via Enterprise Agreement (EA) or Enterprise Agreement Subscription (EAS), Enrollment for Education Solutions (EES), Web Direct, and CSP.</span></span> 

<span data-ttu-id="1c3b1-514">所有通話方案功能都適用於 Microsoft 的國內和國際通話方案，包括每位使用者每個月 120、240 和 1,200 分鐘 (p/u/m) 的國內方案，以及包含國內 1,200 分鐘 (p/u/m) 和國際 600 分鐘 (p/u/m) 的國際方案。</span><span class="sxs-lookup"><span data-stu-id="1c3b1-514">All Calling Plan features will be available for Microsoft’s Domestic and International Calling Plans, including the 120, 240, and 1,200 minutes per user per month (p/u/m) Domestic plans, and the International Plan with 1,200 domestic minutes p/u/m and 600 international minutes p/u/m.</span></span> 

<span data-ttu-id="1c3b1-515">在[現代工作授權常見問題集](https://partner.microsoft.com/resources/collection/partner-center-edu-validation-enhancements)的「通話方案」一節中，您可以找到關於呼叫方案、使用量過高和通訊點數的其他詳細資料。</span><span class="sxs-lookup"><span data-stu-id="1c3b1-515">Find additional details for Calling Plans, excessive usage, and communications credits in the Calling Plan section of the [Modern Work Licensing FAQ](https://partner.microsoft.com/resources/collection/partner-center-edu-validation-enhancements).</span></span>

<span data-ttu-id="1c3b1-516">通話方案目前適用於比利時、加拿大、法國、德國、愛爾蘭、荷蘭、波多黎各 (通路可用性僅限於 EA 和 EES)、西班牙、英國和美國 (澳大利亞和日本適用第三方通話方案)。</span><span class="sxs-lookup"><span data-stu-id="1c3b1-516">Calling Plan is currently available in Belgium, Canada, France, Germany, Ireland, Netherlands, Puerto Rico (channel availability limited to EA and EES only), Spain, the United Kingdom, and the United States (third-party Calling Plan availability in Australia and Japan).</span></span>

#### <a name="offer-details"></a><span data-ttu-id="1c3b1-517">供應項目詳細資料</span><span class="sxs-lookup"><span data-stu-id="1c3b1-517">Offer details</span></span>

   |<span data-ttu-id="1c3b1-518">**供應項目名稱**</span><span class="sxs-lookup"><span data-stu-id="1c3b1-518">**Offer name**</span></span>|<span data-ttu-id="1c3b1-519">**優惠識別碼**</span><span class="sxs-lookup"><span data-stu-id="1c3b1-519">**Offer ID**</span></span>|<span data-ttu-id="1c3b1-520">**材質識別碼**</span><span class="sxs-lookup"><span data-stu-id="1c3b1-520">**Material ID**</span></span>|
   |-------------------|:------|:------|
   |<span data-ttu-id="1c3b1-521">Microsoft 365 國內通話方案</span><span class="sxs-lookup"><span data-stu-id="1c3b1-521">Microsoft 365 Domestic Calling Plan</span></span>|<span data-ttu-id="1c3b1-522">52b01454-aa44-4e03-8049-c4d57496a430</span><span class="sxs-lookup"><span data-stu-id="1c3b1-522">52b01454-aa44-4e03-8049-c4d57496a430</span></span>|<span data-ttu-id="1c3b1-523">4ID-00002</span><span class="sxs-lookup"><span data-stu-id="1c3b1-523">4ID-00002</span></span>|
   |<span data-ttu-id="1c3b1-524">Microsoft 365 國內通話方案</span><span class="sxs-lookup"><span data-stu-id="1c3b1-524">Microsoft 365 Domestic Calling Plan</span></span>|<span data-ttu-id="1c3b1-525">0f598efe-f330-4d79-b79f-c9480bb7ce3e</span><span class="sxs-lookup"><span data-stu-id="1c3b1-525">0f598efe-f330-4d79-b79f-c9480bb7ce3e</span></span>|<span data-ttu-id="1c3b1-526">AAA-13706</span><span class="sxs-lookup"><span data-stu-id="1c3b1-526">AAA-13706</span></span>|
   |<span data-ttu-id="1c3b1-527">Microsoft 365 國內通話方案 (政府機構定價)</span><span class="sxs-lookup"><span data-stu-id="1c3b1-527">Microsoft 365 Domestic Calling Plan (Government Pricing)</span></span>|<span data-ttu-id="1c3b1-528">96b96fd8-b77d-41a4-ae5d-0a6652f454b7</span><span class="sxs-lookup"><span data-stu-id="1c3b1-528">96b96fd8-b77d-41a4-ae5d-0a6652f454b7</span></span>|<span data-ttu-id="1c3b1-529">AAA-13707</span><span class="sxs-lookup"><span data-stu-id="1c3b1-529">AAA-13707</span></span>|
   |<span data-ttu-id="1c3b1-530">Microsoft 365 學生用國內通話方案</span><span class="sxs-lookup"><span data-stu-id="1c3b1-530">Microsoft 365 Domestic Calling Plan for students</span></span>|<span data-ttu-id="1c3b1-531">da2034e1-c147-4aae-afab-9c15acf16ea5</span><span class="sxs-lookup"><span data-stu-id="1c3b1-531">da2034e1-c147-4aae-afab-9c15acf16ea5</span></span>|<span data-ttu-id="1c3b1-532">AAA-22335</span><span class="sxs-lookup"><span data-stu-id="1c3b1-532">AAA-22335</span></span>|
   |<span data-ttu-id="1c3b1-533">Microsoft 365 教職員用國內通話方案</span><span class="sxs-lookup"><span data-stu-id="1c3b1-533">Microsoft 365 Domestic Calling Plan for faculty</span></span>|<span data-ttu-id="1c3b1-534">5e8853ed-611c-4f9c-af21-540ba351a636</span><span class="sxs-lookup"><span data-stu-id="1c3b1-534">5e8853ed-611c-4f9c-af21-540ba351a636</span></span>|<span data-ttu-id="1c3b1-535">AAA-22334</span><span class="sxs-lookup"><span data-stu-id="1c3b1-535">AAA-22334</span></span>|
   |<span data-ttu-id="1c3b1-536">Microsoft 365 GCC 國內通話方案</span><span class="sxs-lookup"><span data-stu-id="1c3b1-536">Microsoft 365 Domestic Calling Plan for GCC</span></span>|<span data-ttu-id="1c3b1-537">7099743e-f474-48be-97bc-d4fb22f059bf</span><span class="sxs-lookup"><span data-stu-id="1c3b1-537">7099743e-f474-48be-97bc-d4fb22f059bf</span></span>|<span data-ttu-id="1c3b1-538">AAD-25690</span><span class="sxs-lookup"><span data-stu-id="1c3b1-538">AAD-25690</span></span>|
   |<span data-ttu-id="1c3b1-539">Microsoft 365 國內及國際通話方案</span><span class="sxs-lookup"><span data-stu-id="1c3b1-539">Microsoft 365 Domestic and International Calling Plan</span></span>|<span data-ttu-id="1c3b1-540">ded34535-507f-4246-8370-f9180318c537</span><span class="sxs-lookup"><span data-stu-id="1c3b1-540">ded34535-507f-4246-8370-f9180318c537</span></span>|<span data-ttu-id="1c3b1-541">AAA-13708</span><span class="sxs-lookup"><span data-stu-id="1c3b1-541">AAA-13708</span></span>|
   |<span data-ttu-id="1c3b1-542">Microsoft 365 國內及國際通話方案 (政府機構定價)</span><span class="sxs-lookup"><span data-stu-id="1c3b1-542">Microsoft 365 Domestic and International Calling Plan (Government Pricing)</span></span>|<span data-ttu-id="1c3b1-543">d97b23b4-627c-41db-8f55-ce342b0db656</span><span class="sxs-lookup"><span data-stu-id="1c3b1-543">d97b23b4-627c-41db-8f55-ce342b0db656</span></span>|<span data-ttu-id="1c3b1-544">AAA-13709</span><span class="sxs-lookup"><span data-stu-id="1c3b1-544">AAA-13709</span></span>|
   |<span data-ttu-id="1c3b1-545">Microsoft 365 學生用國內及國際通話方案</span><span class="sxs-lookup"><span data-stu-id="1c3b1-545">Microsoft 365 Domestic and International Calling Plan for students</span></span>|<span data-ttu-id="1c3b1-546">64ed3fb4-9f46-4e8a-b287-7a3662245c37</span><span class="sxs-lookup"><span data-stu-id="1c3b1-546">64ed3fb4-9f46-4e8a-b287-7a3662245c37</span></span>|<span data-ttu-id="1c3b1-547">AAA-22337</span><span class="sxs-lookup"><span data-stu-id="1c3b1-547">AAA-22337</span></span>|
   |<span data-ttu-id="1c3b1-548">Microsoft 365 教職員用國內及國際通話方案</span><span class="sxs-lookup"><span data-stu-id="1c3b1-548">Microsoft 365 Domestic and International Calling Plan for faculty</span></span>|<span data-ttu-id="1c3b1-549">492b8a14-381c-4536-bf63-bd5785c14734</span><span class="sxs-lookup"><span data-stu-id="1c3b1-549">492b8a14-381c-4536-bf63-bd5785c14734</span></span>|<span data-ttu-id="1c3b1-550">AAA-22336</span><span class="sxs-lookup"><span data-stu-id="1c3b1-550">AAA-22336</span></span>|
   |<span data-ttu-id="1c3b1-551">Microsoft 365 GCC 國內及國際通話方案</span><span class="sxs-lookup"><span data-stu-id="1c3b1-551">Microsoft 365 Domestic and International Calling Plan for GCC</span></span>|<span data-ttu-id="1c3b1-552">0cf5df85-ecf5-43f5-93b0-04a950e906a3</span><span class="sxs-lookup"><span data-stu-id="1c3b1-552">0cf5df85-ecf5-43f5-93b0-04a950e906a3</span></span>|<span data-ttu-id="1c3b1-553">AAD-25680</span><span class="sxs-lookup"><span data-stu-id="1c3b1-553">AAD-25680</span></span>|
   |<span data-ttu-id="1c3b1-554">Microsoft 365 國內通話方案 (120 分鐘)</span><span class="sxs-lookup"><span data-stu-id="1c3b1-554">Microsoft 365 Domestic Calling Plan (120 min)</span></span>|<span data-ttu-id="1c3b1-555">40d28d55-0006-4bb0-8f41-37ac05df5dc7</span><span class="sxs-lookup"><span data-stu-id="1c3b1-555">40d28d55-0006-4bb0-8f41-37ac05df5dc7</span></span>|<span data-ttu-id="1c3b1-556">AAD-11639</span><span class="sxs-lookup"><span data-stu-id="1c3b1-556">AAD-11639</span></span>|
   |<span data-ttu-id="1c3b1-557">Microsoft 365 學生用國內通話方案 (120 分鐘)</span><span class="sxs-lookup"><span data-stu-id="1c3b1-557">Microsoft 365 Domestic Calling Plan (120 min) for students</span></span>|<span data-ttu-id="1c3b1-558">353d7f89-2e6f-4deb-9145-80f281a782ab</span><span class="sxs-lookup"><span data-stu-id="1c3b1-558">353d7f89-2e6f-4deb-9145-80f281a782ab</span></span>|<span data-ttu-id="1c3b1-559">AAD-11641</span><span class="sxs-lookup"><span data-stu-id="1c3b1-559">AAD-11641</span></span>|
   |<span data-ttu-id="1c3b1-560">Microsoft 365 教職員用國內通話方案 (120 分鐘)</span><span class="sxs-lookup"><span data-stu-id="1c3b1-560">Microsoft 365 Domestic Calling Plan (120 min) for faculty</span></span>|<span data-ttu-id="1c3b1-561">80fc6c74-cc94-478d-97b0-8455593a5987</span><span class="sxs-lookup"><span data-stu-id="1c3b1-561">80fc6c74-cc94-478d-97b0-8455593a5987</span></span>|<span data-ttu-id="1c3b1-562">AAD-11640</span><span class="sxs-lookup"><span data-stu-id="1c3b1-562">AAD-11640</span></span>|

### <a name="next-steps"></a><span data-ttu-id="1c3b1-563">後續步驟</span><span class="sxs-lookup"><span data-stu-id="1c3b1-563">Next steps</span></span>

<span data-ttu-id="1c3b1-564">檢閱本主題的相關資源，並與您的組織中適當的利害關係人分享這項資訊。</span><span class="sxs-lookup"><span data-stu-id="1c3b1-564">Review the resources about this topic, and share this information with the appropriate stakeholders in your organization.</span></span>

________________

## <a name="microsoft-defender-advanced-threat-protection-atp-for-servers-for-education-is-now-available"></a><a name="1"></a><span data-ttu-id="1c3b1-565">現已推出適用於教育用伺服器的 Microsoft Defender 進階威脅防護 (ATP)</span><span class="sxs-lookup"><span data-stu-id="1c3b1-565">Microsoft Defender Advanced Threat Protection (ATP) for Servers for Education is now available</span></span>

### <a name="categories"></a><span data-ttu-id="1c3b1-566">類別</span><span class="sxs-lookup"><span data-stu-id="1c3b1-566">Categories</span></span>

- <span data-ttu-id="1c3b1-567">日期：2020-09-01</span><span class="sxs-lookup"><span data-stu-id="1c3b1-567">Date: 2020-09-01</span></span>
- <span data-ttu-id="1c3b1-568">供應項目/市場</span><span class="sxs-lookup"><span data-stu-id="1c3b1-568">Offers/Markets</span></span>

### <a name="impacted-audience"></a><span data-ttu-id="1c3b1-569">影響對象</span><span class="sxs-lookup"><span data-stu-id="1c3b1-569">Impacted audience</span></span>

<span data-ttu-id="1c3b1-570">參與 CSP 計畫的所有合作夥伴</span><span class="sxs-lookup"><span data-stu-id="1c3b1-570">All partners participating in the CSP program</span></span> 

### <a name="details"></a><span data-ttu-id="1c3b1-571">詳細資料</span><span class="sxs-lookup"><span data-stu-id="1c3b1-571">Details</span></span>

<span data-ttu-id="1c3b1-572">自 2020 年 9 月 1 日起，雲端解決方案提供者 (CSP) 計畫已開始提供適用於教育用伺服器的 Microsoft Defender 進階威脅防護 (ATP)。</span><span class="sxs-lookup"><span data-stu-id="1c3b1-572">Microsoft Defender Advanced Threat Protection (ATP) for Servers for Education is now available, as of September 1, 2020 in the Cloud Solution Provider (CSP) program.</span></span>  
<span data-ttu-id="1c3b1-573">產品供應項目詳細資料：</span><span class="sxs-lookup"><span data-stu-id="1c3b1-573">Product Offer Details:</span></span>

- <span data-ttu-id="1c3b1-574">供應項目名稱：適用於教育用伺服器的 Microsoft Defender ATP</span><span class="sxs-lookup"><span data-stu-id="1c3b1-574">Offer name: Microsoft Defender ATP for Servers for Education</span></span>
- <span data-ttu-id="1c3b1-575">供應項目識別碼：c7b9ab7e-8f80-4b4b-8aed-dcad61f2899</span><span class="sxs-lookup"><span data-stu-id="1c3b1-575">Offer ID: c7b9ab7e-8f80-4b4b-8aed-dcad61f2899</span></span>

### <a name="next-steps"></a><span data-ttu-id="1c3b1-576">後續步驟</span><span class="sxs-lookup"><span data-stu-id="1c3b1-576">Next steps</span></span>

- <span data-ttu-id="1c3b1-577">請與貴組織內適當的連絡人分享這項資訊。</span><span class="sxs-lookup"><span data-stu-id="1c3b1-577">Share this information with the appropriate contacts in your organization.</span></span>
- <span data-ttu-id="1c3b1-578">如需產品的詳細資訊，請參閱 [Microsoft Defender ATP 文件](/windows/security/threat-protection/microsoft-defender-atp/microsoft-defender-advanced-threat-protection)。</span><span class="sxs-lookup"><span data-stu-id="1c3b1-578">Read the [Microsoft Defender ATP documentation](/windows/security/threat-protection/microsoft-defender-atp/microsoft-defender-advanced-threat-protection) for more information about the product.</span></span>
