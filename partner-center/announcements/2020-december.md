...
- <span data-ttu-id="f0a20-108">日期：2020-12-22</span><span class="sxs-lookup"><span data-stu-id="f0a20-108">Date: 2020-12-22</span></span>
...
### <a name="next-steps"></a><span data-ttu-id="f0a20-122">後續步驟</span><span class="sxs-lookup"><span data-stu-id="f0a20-122">Next steps</span></span>
...
### <a name="impacted-audience"></a><span data-ttu-id="f0a20-135">影響對象</span><span class="sxs-lookup"><span data-stu-id="f0a20-135">Impacted audience</span></span>
...
<span data-ttu-id="f0a20-166">請注意，所有其他的價目表檔案已安排為可依一般排程提供，只是上述兩個交付項目會稍微延遲。</span><span class="sxs-lookup"><span data-stu-id="f0a20-166">Realize that all other price list files are on scheduled to be available on the usual schedule, simply the above two deliverables will be slightly delayed.</span></span>
...
- <span data-ttu-id="f0a20-182">日期：2020-12-21</span><span class="sxs-lookup"><span data-stu-id="f0a20-182">Date: 2020-12-21</span></span>
...
### <a name="next-steps"></a><span data-ttu-id="f0a20-196">後續步驟</span><span class="sxs-lookup"><span data-stu-id="f0a20-196">Next steps</span></span>
...
### <a name="details"></a><span data-ttu-id="f0a20-208">詳細資料</span><span class="sxs-lookup"><span data-stu-id="f0a20-208">Details</span></span>
...
### <a name="impacted-audience"></a><span data-ttu-id="f0a20-219">影響對象</span><span class="sxs-lookup"><span data-stu-id="f0a20-219">Impacted audience</span></span>
...
### <a name="questions"></a><span data-ttu-id="f0a20-261">有問題嗎？</span><span class="sxs-lookup"><span data-stu-id="f0a20-261">Questions?</span></span>
...
### <a name="details"></a><span data-ttu-id="f0a20-274">詳細資料</span><span class="sxs-lookup"><span data-stu-id="f0a20-274">Details</span></span>
...
### <a name="next-steps"></a><span data-ttu-id="f0a20-290">後續步驟</span><span class="sxs-lookup"><span data-stu-id="f0a20-290">Next steps</span></span>
...
### <a name="categories"></a><span data-ttu-id="f0a20-300">類別</span><span class="sxs-lookup"><span data-stu-id="f0a20-300">Categories</span></span>
...
### <a name="categories"></a><span data-ttu-id="f0a20-313">類別</span><span class="sxs-lookup"><span data-stu-id="f0a20-313">Categories</span></span>
...
- <span data-ttu-id="f0a20-330">供應項目顯示名稱：每個應用程式方案促銷的 Power Apps (下限為 200 個基座)</span><span class="sxs-lookup"><span data-stu-id="f0a20-330">Offer Display Name: Power Apps per app plan promotion (200 seat min)</span></span>
...
<span data-ttu-id="f0a20-367">**客戶公司設定檔**</span><span class="sxs-lookup"><span data-stu-id="f0a20-367">**Customers Company Profile**</span></span>
...
<span data-ttu-id="f0a20-381">透過雲端解決方案提供者 (CSP) 方案交易的所有合作夥伴</span><span class="sxs-lookup"><span data-stu-id="f0a20-381">All partners transacting through the Cloud Solution Provider (CSP) program</span></span>
...
<span data-ttu-id="f0a20-386">12 月授權型價目表包含下列不應在價目表中的供應項目。</span><span class="sxs-lookup"><span data-stu-id="f0a20-386">The December license-based price lists contain the below offers that should not be in the price lists.</span></span> <span data-ttu-id="f0a20-387">這些供應項目先前已錯誤地包含在價目表中，且不應發佈。</span><span class="sxs-lookup"><span data-stu-id="f0a20-387">These offers were previously included in the price lists in error and should not have been published.</span></span> <span data-ttu-id="f0a20-388">沒有這些供應項目可供使用的排程。</span><span class="sxs-lookup"><span data-stu-id="f0a20-388">There is no schedule as to when these offers may be available.</span></span> <span data-ttu-id="f0a20-389">未來如果將其新增回去，則會在未來的預覽價目表中列為「新增」。</span><span class="sxs-lookup"><span data-stu-id="f0a20-389">In the future, if they are added back they will be listed as ADDs in future preview price lists.</span></span>
   ...
   |<span data-ttu-id="f0a20-402">Dynamics 365 作業 - 訂單行 (非營利組織定價)</span><span class="sxs-lookup"><span data-stu-id="f0a20-402">Dynamics 365 Operations – Order Lines (Nonprofits Pricing)</span></span>|<span data-ttu-id="f0a20-403">7dd6b78a-3d53-47f8-8a64-bd84609a9a70</span><span class="sxs-lookup"><span data-stu-id="f0a20-403">7dd6b78a-3d53-47f8-8a64-bd84609a9a70</span></span>|
   
#### <a name="incorrect-offers-in-the-offer-list-matrix"></a><span data-ttu-id="f0a20-404">供應項目清單矩陣中的供應項目不正確</span><span class="sxs-lookup"><span data-stu-id="f0a20-404">Incorrect offers in the offer list matrix</span></span>
   
<span data-ttu-id="f0a20-405">下列供應項目錯誤地在供應項目清單矩陣中。</span><span class="sxs-lookup"><span data-stu-id="f0a20-405">Below offers were in the offer list matrix in error.</span></span> <span data-ttu-id="f0a20-406">這些供應項目無法使用，尚未提供可供使用的目標日期。</span><span class="sxs-lookup"><span data-stu-id="f0a20-406">They are not available, there is not target date yet for availability.</span></span> <span data-ttu-id="f0a20-407">合作夥伴應該忽略這些明細項目。</span><span class="sxs-lookup"><span data-stu-id="f0a20-407">Partners should ignore these line items.</span></span>

   |<span data-ttu-id="f0a20-408">**供應項目名稱**</span><span class="sxs-lookup"><span data-stu-id="f0a20-408">**Offer name**</span></span>|<span data-ttu-id="f0a20-409">**優惠識別碼**</span><span class="sxs-lookup"><span data-stu-id="f0a20-409">**Offer ID**</span></span>|
   |-------------------|:------|
   |<span data-ttu-id="f0a20-410">Dynamics 365 作業 - 資料庫容量 (非營利組織定價)</span><span class="sxs-lookup"><span data-stu-id="f0a20-410">Dynamics 365 Operations - Database Capacity (Nonprofits Pricing)</span></span>|<span data-ttu-id="f0a20-411">1d3f4d81-89b9-419e-a880-31b2c50b8d66</span><span class="sxs-lookup"><span data-stu-id="f0a20-411">1d3f4d81-89b9-419e-a880-31b2c50b8d66</span></span>|
   |<span data-ttu-id="f0a20-412">Dynamics 365 作業 - 檔案容量 (非營利組織定價)</span><span class="sxs-lookup"><span data-stu-id="f0a20-412">Dynamics 365 Operations - File Capacity (Nonprofits Pricing)</span></span>|<span data-ttu-id="f0a20-413">dc173a86-285b-444c-881e-3ece531f67da</span><span class="sxs-lookup"><span data-stu-id="f0a20-413">dc173a86-285b-444c-881e-3ece531f67da</span></span>|

#### <a name="powerapps-offer"></a><span data-ttu-id="f0a20-414">Powerapps 供應項目</span><span class="sxs-lookup"><span data-stu-id="f0a20-414">Powerapps offer</span></span>

<span data-ttu-id="f0a20-415">此供應項目已包含在供應項目清單矩陣中，但是未包含在 12 月價目表中。</span><span class="sxs-lookup"><span data-stu-id="f0a20-415">This offer was included in the offer list matrix but not the December price list.</span></span> <span data-ttu-id="f0a20-416">供應項目可供使用，您可以在上個月的價目表 11 月檔案中找到定價。</span><span class="sxs-lookup"><span data-stu-id="f0a20-416">The offer is available and pricing can be found in the previous month's price list November file.</span></span> <span data-ttu-id="f0a20-417">此供應項目應新增回到 1 月價目表。</span><span class="sxs-lookup"><span data-stu-id="f0a20-417">This offer should be added back to the January price list.</span></span>

   |<span data-ttu-id="f0a20-418">**供應項目名稱**</span><span class="sxs-lookup"><span data-stu-id="f0a20-418">**Offer name**</span></span>|<span data-ttu-id="f0a20-419">**優惠識別碼**</span><span class="sxs-lookup"><span data-stu-id="f0a20-419">**Offer ID**</span></span>|
   |-------------------|:------|
   |<span data-ttu-id="f0a20-420">每個應用程式的 Power Apps 方案</span><span class="sxs-lookup"><span data-stu-id="f0a20-420">Power Apps per app plan</span></span>|<span data-ttu-id="f0a20-421">5e1087b6-246b-4503-b88a-b60bdf0b3840</span><span class="sxs-lookup"><span data-stu-id="f0a20-421">5e1087b6-246b-4503-b88a-b60bdf0b3840</span></span>|

### <a name="next-steps"></a><span data-ttu-id="f0a20-422">後續步驟</span><span class="sxs-lookup"><span data-stu-id="f0a20-422">Next steps</span></span>

<span data-ttu-id="f0a20-423">請經常檢查版本資訊，因為發現到的其他問題將會附加至此公告。</span><span class="sxs-lookup"><span data-stu-id="f0a20-423">Check release notes often as other issues are uncovered they will be appended to this announcement.</span></span>

### <a name="last-updated"></a><span data-ttu-id="f0a20-424">上次更新</span><span class="sxs-lookup"><span data-stu-id="f0a20-424">Last updated</span></span>

<span data-ttu-id="f0a20-425">2020 年 12 月 8 日</span><span class="sxs-lookup"><span data-stu-id="f0a20-425">December 8, 2020</span></span>

______________

## <a name="an-update-of-the-us-microsoft-365-business-voice-with-calling-plan-offer-is-coming-soon"></a><a name="2"></a><span data-ttu-id="f0a20-426">美國 Microsoft 365 商務語音與通話方案供應專案即將更新</span><span class="sxs-lookup"><span data-stu-id="f0a20-426">An update of the US Microsoft 365 Business Voice with Calling Plan offer is coming soon</span></span>

### <a name="categories"></a><span data-ttu-id="f0a20-427">類別</span><span class="sxs-lookup"><span data-stu-id="f0a20-427">Categories</span></span>

- <span data-ttu-id="f0a20-428">日期：2020-12-3</span><span class="sxs-lookup"><span data-stu-id="f0a20-428">Date: 2020-12-3</span></span>
- <span data-ttu-id="f0a20-429">供應項目/市場</span><span class="sxs-lookup"><span data-stu-id="f0a20-429">Offers/Markets</span></span>

### <a name="summary"></a><span data-ttu-id="f0a20-430">摘要</span><span class="sxs-lookup"><span data-stu-id="f0a20-430">Summary</span></span> 

<span data-ttu-id="f0a20-431">在 2021 年 1 月 1 日，Microsoft 會開始將美國合作夥伴和客戶轉換到新的 Microsoft 365 商務語音與通話方案供應項目。</span><span class="sxs-lookup"><span data-stu-id="f0a20-431">On January 1, 2021, Microsoft will begin transitioning US partners and customers to a new Microsoft 365 Business Voice with Calling Plan offer.</span></span> <span data-ttu-id="f0a20-432">不需要合作夥伴執行任何動作。</span><span class="sxs-lookup"><span data-stu-id="f0a20-432">No partner action is required.</span></span>

### <a name="impacted-audience"></a><span data-ttu-id="f0a20-433">影響對象</span><span class="sxs-lookup"><span data-stu-id="f0a20-433">Impacted Audience</span></span> 

<span data-ttu-id="f0a20-434">透過雲端解決方案提供者 (CSP) 方案交易的所有合作夥伴</span><span class="sxs-lookup"><span data-stu-id="f0a20-434">All partners transacting through the Cloud Solution Provider (CSP) program</span></span>

### <a name="details"></a><span data-ttu-id="f0a20-435">詳細資料</span><span class="sxs-lookup"><span data-stu-id="f0a20-435">Details</span></span>

<span data-ttu-id="f0a20-436">Microsoft 將以新的供應項目來取代現有的美國商務語音與通話方案供應項目，以支援電信產品的內部需求。</span><span class="sxs-lookup"><span data-stu-id="f0a20-436">Microsoft will replace the existing Business Voice with Calling plan offer in the US with a new offer to support internal requirements for telco products.</span></span> <span data-ttu-id="f0a20-437">新的供應項目會有相同的功能集和定價。</span><span class="sxs-lookup"><span data-stu-id="f0a20-437">The new offer will have the same feature set and pricing.</span></span> <span data-ttu-id="f0a20-438">供應項目變更為 Microsoft 內部，且不應該影響 CSP 合作夥伴行銷、銷售或支援商務語音與通話方案供應項目的方式。</span><span class="sxs-lookup"><span data-stu-id="f0a20-438">The offer changes are internal to Microsoft and should not affect the way that CSP partners market, sell, or support the Business Voice with Calling Plan offer.</span></span> <span data-ttu-id="f0a20-439">此變更只會套用到此供應項目。</span><span class="sxs-lookup"><span data-stu-id="f0a20-439">The change will only apply to this offer.</span></span>

<span data-ttu-id="f0a20-440">針對新銷售，您將會在 2021 年 1 月 1 日開始使用新的供應項目。</span><span class="sxs-lookup"><span data-stu-id="f0a20-440">For new sales, you will use the new offer starting on January 1, 2021.</span></span> <span data-ttu-id="f0a20-441">舊的供應項目將會取代為價目表上的新供應項目。</span><span class="sxs-lookup"><span data-stu-id="f0a20-441">The old offer will be replaced by the new offer on the price list.</span></span>

<span data-ttu-id="f0a20-442">現有的客戶會在其更新日期自動轉換為新的供應項目。</span><span class="sxs-lookup"><span data-stu-id="f0a20-442">Existing customers will be automatically transitioned to the new offer upon their renewal date.</span></span> <span data-ttu-id="f0a20-443">合作夥伴和更新的客戶不需要採取任何動作。</span><span class="sxs-lookup"><span data-stu-id="f0a20-443">No action is required from partners and renewing customers.</span></span>


<span data-ttu-id="f0a20-444">\*\*新供應項目詳細資料</span><span class="sxs-lookup"><span data-stu-id="f0a20-444">\*\*New offer details</span></span>
 
   |<span data-ttu-id="f0a20-445">**供應項目名稱**</span><span class="sxs-lookup"><span data-stu-id="f0a20-445">**Offer name**</span></span>|<span data-ttu-id="f0a20-446">**優惠識別碼**</span><span class="sxs-lookup"><span data-stu-id="f0a20-446">**Offer ID**</span></span>|<span data-ttu-id="f0a20-447">**材質識別碼**</span><span class="sxs-lookup"><span data-stu-id="f0a20-447">**Material ID**</span></span>|
   |-------------------|:------|:------|
   |<span data-ttu-id="f0a20-448">Microsoft 365 商務語音 (美國)</span><span class="sxs-lookup"><span data-stu-id="f0a20-448">Microsoft 365 Business Voice (US)</span></span>|<span data-ttu-id="f0a20-449">86713ec1-ad33-42cf-a1ce-8397d4d875fe</span><span class="sxs-lookup"><span data-stu-id="f0a20-449">86713ec1-ad33-42cf-a1ce-8397d4d875fe</span></span>|<span data-ttu-id="f0a20-450">PZW-00023</span><span class="sxs-lookup"><span data-stu-id="f0a20-450">PZW-00023</span></span>|
   
<span data-ttu-id="f0a20-451">\*\*舊供應項目詳細資料</span><span class="sxs-lookup"><span data-stu-id="f0a20-451">\*\*Old offer details</span></span>

   |<span data-ttu-id="f0a20-452">**供應項目名稱**</span><span class="sxs-lookup"><span data-stu-id="f0a20-452">**Offer name**</span></span>|<span data-ttu-id="f0a20-453">**優惠識別碼**</span><span class="sxs-lookup"><span data-stu-id="f0a20-453">**Offer ID**</span></span>|<span data-ttu-id="f0a20-454">**材質識別碼**</span><span class="sxs-lookup"><span data-stu-id="f0a20-454">**Material ID**</span></span>|
   |-------------------|:------|:------|
   |<span data-ttu-id="f0a20-455">Microsoft 365 商務語音 (美國)</span><span class="sxs-lookup"><span data-stu-id="f0a20-455">Microsoft 365 Business Voice (US)</span></span>|<span data-ttu-id="f0a20-456">9f9f2c7b-c961-402b-9421-8e3c9207eeb3</span><span class="sxs-lookup"><span data-stu-id="f0a20-456">9f9f2c7b-c961-402b-9421-8e3c9207eeb3</span></span>|<span data-ttu-id="f0a20-457">PZW-00009</span><span class="sxs-lookup"><span data-stu-id="f0a20-457">PZW-00009</span></span>|

### <a name="next-steps"></a><span data-ttu-id="f0a20-458">後續步驟</span><span class="sxs-lookup"><span data-stu-id="f0a20-458">Next steps</span></span>

<span data-ttu-id="f0a20-459">請參閱價目表，並與貴組織中所有相關連絡人分享這項資訊。</span><span class="sxs-lookup"><span data-stu-id="f0a20-459">Familiarize yourself with the price list and share this information with all appropriate contacts in your organization.</span></span>

______________

## <a name="now-live-partner-center-api-updates-and-user-interface-enhancements-for-the-education-customer-validation-process"></a><a name="1"></a><span data-ttu-id="f0a20-460">即時實況：教育版客戶驗證程序的合作夥伴中心 API 更新和使用者介面增強功能</span><span class="sxs-lookup"><span data-stu-id="f0a20-460">Now live: Partner Center API updates and user interface enhancements for the Education customer validation process</span></span>

### <a name="categories"></a><span data-ttu-id="f0a20-461">類別</span><span class="sxs-lookup"><span data-stu-id="f0a20-461">Categories</span></span>

- <span data-ttu-id="f0a20-462">日期：2020-12-3</span><span class="sxs-lookup"><span data-stu-id="f0a20-462">Date: 2020-12-3</span></span>
- <span data-ttu-id="f0a20-463">功能</span><span class="sxs-lookup"><span data-stu-id="f0a20-463">Capabilities</span></span>

### <a name="impacted-audience"></a><span data-ttu-id="f0a20-464">影響對象</span><span class="sxs-lookup"><span data-stu-id="f0a20-464">Impacted Audience</span></span> 

<span data-ttu-id="f0a20-465">透過雲端解決方案提供者計畫銷售學術供應項目的合作夥伴</span><span class="sxs-lookup"><span data-stu-id="f0a20-465">Partners selling Academic offers through the Cloud Solution Provider program</span></span>

### <a name="summary"></a><span data-ttu-id="f0a20-466">摘要</span><span class="sxs-lookup"><span data-stu-id="f0a20-466">Summary</span></span> 

<span data-ttu-id="f0a20-467">Microsoft 的營運以信任為原則。</span><span class="sxs-lookup"><span data-stu-id="f0a20-467">Microsoft runs on trust.</span></span> <span data-ttu-id="f0a20-468">針對在雲端解決方案提供者計畫中從事學術供應項目交易時所需的客戶驗證，提供符合規範且安全的方法，是我們一貫努力的目標。</span><span class="sxs-lookup"><span data-stu-id="f0a20-468">We are committed to providing a compliant, safe, and secure method of customer validation for transacting Academic offers in the Cloud Solution Provider program.</span></span> <span data-ttu-id="f0a20-469">為履行此承諾，我們將會導入合作夥伴中心 API 和使用者介面增強功能，讓客戶審查程序更加清楚明瞭，且能夠輸入更精確的資料，以提升客戶審查的成功率。</span><span class="sxs-lookup"><span data-stu-id="f0a20-469">As part of this commitment, we are introducing Partner Center API and user interface enhancements that will add clarity and visibility into the customer vetting process as well as the ability to input more accurate data, which will drive improved customer vetting success.</span></span> 

<span data-ttu-id="f0a20-470">**合作夥伴中心的增強功能**</span><span class="sxs-lookup"><span data-stu-id="f0a20-470">**Partner Center enhancements**</span></span> 

- <span data-ttu-id="f0a20-471">新的 GET 和 POST 資格 API 可支援精確的資料輸入，並改善 Microsoft 的教育客戶驗證程序。</span><span class="sxs-lookup"><span data-stu-id="f0a20-471">New GET and POST Qualifications APIs to support accurate data entry and improve the Education customer validation process by Microsoft.</span></span> 

- <span data-ttu-id="f0a20-472">使用者介面增強功能可支援精確的資料輸入，並改善 Microsoft 的教育客戶驗證程序。</span><span class="sxs-lookup"><span data-stu-id="f0a20-472">User interface enhancements to support accurate data entry and improve the Education customer validation process by Microsoft.</span></span> 

<span data-ttu-id="f0a20-473">**取代現有的 GET 和 PUT 限定性條件 API**</span><span class="sxs-lookup"><span data-stu-id="f0a20-473">**Deprecation of existing GET and PUT Qualification APIs**</span></span> 

<span data-ttu-id="f0a20-474">現有的 GET 和 PUT 限定性條件 API 將會在 **2021 年 2 月底前** 淘汰。</span><span class="sxs-lookup"><span data-stu-id="f0a20-474">The existing GET and PUT Qualification APIs will retire **before the end of February 2021**.</span></span> <span data-ttu-id="f0a20-475">屆時，您必須轉換成新的 GET 和 POST 合作夥伴中心 API，才能夠購買教育版供應項目。</span><span class="sxs-lookup"><span data-stu-id="f0a20-475">At that time, you will need to have transitioned to the new GET and POST Partner Center APIs in order to be able to purchase Education offers.</span></span>  

<span data-ttu-id="f0a20-476">**測試**</span><span class="sxs-lookup"><span data-stu-id="f0a20-476">**Testing**</span></span> 

<span data-ttu-id="f0a20-477">若要深入了解想要成功進行客戶驗證所需的 API 和資料輸入，合作夥伴可以開始測試這些增強功能。</span><span class="sxs-lookup"><span data-stu-id="f0a20-477">To gain a better understanding of the APIs and data entry required for successful customer validation, partners can test these enhancements.</span></span> <span data-ttu-id="f0a20-478">想要參與測試的合作夥伴應下載[合作夥伴中心教育客戶測試指南](https://partner.microsoft.com/resources/detail/partner-center-edu-testing-guide-pdf)，以了解整備、註冊方式的方向，以及測試階段中預期情況的相關資訊。</span><span class="sxs-lookup"><span data-stu-id="f0a20-478">Partners who want to participate in the testing should download the [Partner Center Education customer testing guide](https://partner.microsoft.com/resources/detail/partner-center-edu-testing-guide-pdf) for directions on how to prepare, sign up, and for information on what to expect during the testing phase.</span></span>

<span data-ttu-id="f0a20-479">**圖書館和博物館客戶**</span><span class="sxs-lookup"><span data-stu-id="f0a20-479">**Library and Museum customers**</span></span> 

<span data-ttu-id="f0a20-480">除了上述增強功能以外，我們也迫不及待地宣佈，我們將為圖書館和博物館客戶啟用學術定價供應項目，以擴展您可以銷售 CSP 供應項目的教育客戶。</span><span class="sxs-lookup"><span data-stu-id="f0a20-480">In addition to the above enhancements, we are excited to announce that we will enable Academic-priced offers for Library and Museum customers, expanding the Education customers with whom you can transact CSP offers.</span></span> 

<span data-ttu-id="f0a20-481">Microsoft 保留對任何客戶或建議客戶審查其教育使用者資格的權利。</span><span class="sxs-lookup"><span data-stu-id="f0a20-481">Microsoft reserves the right to review the status of any customer or proposed customer as a qualified educational user.</span></span> <span data-ttu-id="f0a20-482">如需完整詳細資料，請參閱[學術合格教育使用者需求](https://www.microsoftvolumelicensing.com/DocumentSearch.aspx?Mode=3&DocumentTypeId=7)。</span><span class="sxs-lookup"><span data-stu-id="f0a20-482">See the [Academic Qualified Education User Requirements](https://www.microsoftvolumelicensing.com/DocumentSearch.aspx?Mode=3&DocumentTypeId=7) for full details.</span></span> 

### <a name="next-stepsadditional-resources"></a><span data-ttu-id="f0a20-483">後續步驟/其他資源</span><span class="sxs-lookup"><span data-stu-id="f0a20-483">Next steps/additional resources</span></span>

- <span data-ttu-id="f0a20-484">在作業整備資源中檢閱新的合作夥伴中心使用者介面、API 變更和指南：[合作夥伴中心教育客戶驗證](https://partner.microsoft.com/resources/collection/partner-center-edu-validation-enhancements#/)程序增強功能</span><span class="sxs-lookup"><span data-stu-id="f0a20-484">Review the new Partner Center User Interface, API changes, and Guide in the Operations Readiness resources:  [Partner Center Education customer validation](https://partner.microsoft.com/resources/collection/partner-center-edu-validation-enhancements#/) process enhancements</span></span> 

- <span data-ttu-id="f0a20-485">請確定您的組織已熟悉[學術合格教育使用者需求](https://www.microsoftvolumelicensing.com/DocumentSearch.aspx?Mode=3&DocumentTypeId=7)。</span><span class="sxs-lookup"><span data-stu-id="f0a20-485">Ensure your organization is familiar with the [Academic Qualified Education User requirements](https://www.microsoftvolumelicensing.com/DocumentSearch.aspx?Mode=3&DocumentTypeId=7).</span></span> 

- <span data-ttu-id="f0a20-486">請與組織中的適當小組以及轉銷商分享這項資訊，協助他們為這些變更做好準備。</span><span class="sxs-lookup"><span data-stu-id="f0a20-486">Share this information with the appropriate teams within your organization, and with your resellers, to help them prepare for these changes.</span></span> 

### <a name="change-log"></a><span data-ttu-id="f0a20-487">變更記錄</span><span class="sxs-lookup"><span data-stu-id="f0a20-487">Change Log</span></span> 

<span data-ttu-id="f0a20-488">_ 2020 年 8 月 31 日：原始發行</span><span class="sxs-lookup"><span data-stu-id="f0a20-488">_ August 31, 2020:  Original publication</span></span> 

- <span data-ttu-id="f0a20-489">2020 年 9 月 25 日：已新增測試視窗更新</span><span class="sxs-lookup"><span data-stu-id="f0a20-489">September 25, 2020:  Test window update added</span></span> 

- <span data-ttu-id="f0a20-490">2020 年 10 月 4 日：註冊以進行測試的提醒</span><span class="sxs-lookup"><span data-stu-id="f0a20-490">October 4, 2020: Reminder to sign up for testing</span></span> 

- <span data-ttu-id="f0a20-491">2020 年 11 月 10 日：註冊以進行測試的提醒</span><span class="sxs-lookup"><span data-stu-id="f0a20-491">November 10, 2020: Reminder to sign up for testing</span></span> 

- <span data-ttu-id="f0a20-492">2020 年 12 月 3 日：API 即時更新</span><span class="sxs-lookup"><span data-stu-id="f0a20-492">December 3, 2020: API updates live</span></span> 
