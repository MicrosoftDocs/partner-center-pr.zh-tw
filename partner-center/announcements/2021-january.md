...
- <span data-ttu-id="8f6c9-109">日期：2021-01-28</span><span class="sxs-lookup"><span data-stu-id="8f6c9-109">Date: 2021-01-28</span></span>
...
- <span data-ttu-id="8f6c9-124">在階段 1 之前，已在 CSP 中購買新商業供應項目的現有客戶</span><span class="sxs-lookup"><span data-stu-id="8f6c9-124">Existing customers who have already purchased a new commerce offer in CSP prior to Phase 1</span></span>
...
### <a name="next-steps"></a><span data-ttu-id="8f6c9-137">後續步驟</span><span class="sxs-lookup"><span data-stu-id="8f6c9-137">Next steps</span></span>
...
- <span data-ttu-id="8f6c9-149">日期：2021-01-28</span><span class="sxs-lookup"><span data-stu-id="8f6c9-149">Date: 2021-01-28</span></span>
...
2. <span data-ttu-id="8f6c9-160">合作夥伴會在下列國家/地區與新的或現有客戶進行業務：</span><span class="sxs-lookup"><span data-stu-id="8f6c9-160">The partner does business with new or existing customers in the following countries:</span></span>
    ...
    - <span data-ttu-id="8f6c9-172">阿拉伯聯合大公國</span><span class="sxs-lookup"><span data-stu-id="8f6c9-172">United Arab Emirates</span></span>
...
### <a name="questions"></a><span data-ttu-id="8f6c9-195">有問題嗎？</span><span class="sxs-lookup"><span data-stu-id="8f6c9-195">Questions?</span></span>
...
### <a name="next-steps"></a><span data-ttu-id="8f6c9-208">下一步</span><span class="sxs-lookup"><span data-stu-id="8f6c9-208">Next steps</span></span>
...
### <a name="details"></a><span data-ttu-id="8f6c9-219">詳細資料</span><span class="sxs-lookup"><span data-stu-id="8f6c9-219">Details</span></span>
...
### <a name="categories"></a><span data-ttu-id="8f6c9-231">類別</span><span class="sxs-lookup"><span data-stu-id="8f6c9-231">Categories</span></span>
...
<span data-ttu-id="8f6c9-261">**第1階段–從2021年7月21日起**</span><span class="sxs-lookup"><span data-stu-id="8f6c9-261">**Phase 1 – Beginning July 21, 2021**</span></span>
...
<span data-ttu-id="8f6c9-314">Microsoft 將會實作 API 節流，讓呼叫合作夥伴中心 API 的合作夥伴在一段時間範圍內能獲得更一致的效能。</span><span class="sxs-lookup"><span data-stu-id="8f6c9-314">Microsoft will be implementing API throttling to allow a more consistent performance within a time span for partners calling the Partner Center APIs.</span></span>
...
|<span data-ttu-id="8f6c9-339">{baseURL}/v1/customers/{customer_id}/subscriptions/{subscription_id}/addons</span><span class="sxs-lookup"><span data-stu-id="8f6c9-339">{baseURL}/v1/customers/{customer_id}/subscriptions/{subscription_id}/addons</span></span>  | [<span data-ttu-id="8f6c9-340">取得訂用帳戶的附加元件清單</span><span class="sxs-lookup"><span data-stu-id="8f6c9-340">Get a list of add-ons for a subscription</span></span>](/partner-center/develop/get-a-list-of-add-ons-for-a-subscription) |
...
### <a name="impacted-audience"></a><span data-ttu-id="8f6c9-361">影響對象</span><span class="sxs-lookup"><span data-stu-id="8f6c9-361">Impacted audience</span></span>
...
### <a name="impacted-audience"></a><span data-ttu-id="8f6c9-420">影響對象</span><span class="sxs-lookup"><span data-stu-id="8f6c9-420">Impacted audience</span></span>

<span data-ttu-id="8f6c9-421">在 MPA 下的現有直接與間接雲端解決方案提供者 (CSP) 合作夥伴。</span><span class="sxs-lookup"><span data-stu-id="8f6c9-421">Existing direct and indirect Cloud Solution Provider (CSP) partners under MPA.</span></span> <span data-ttu-id="8f6c9-422">位於烏克蘭、俄羅斯和哈薩克的合作夥伴必須每年以實體或電子方式重新簽署附加條款。</span><span class="sxs-lookup"><span data-stu-id="8f6c9-422">Partners in Ukraine, Russia, and Kazakhstan will be required to physically or electronically re-sign the Rider annually.</span></span>

### <a name="details"></a><span data-ttu-id="8f6c9-423">詳細資料</span><span class="sxs-lookup"><span data-stu-id="8f6c9-423">Details</span></span>

<span data-ttu-id="8f6c9-424">從 2021 年 2 月起，Microsoft 會開始將 CSP 合作夥伴的所有電子簽章處理從 DocuSign 轉換為 Adobe Sign。</span><span class="sxs-lookup"><span data-stu-id="8f6c9-424">In February 2021, Microsoft will begin transitioning all electronic signature processing from DocuSign to Adobe Sign for CSP partners.</span></span> 

<span data-ttu-id="8f6c9-425">轉換的過程應該會很順暢。</span><span class="sxs-lookup"><span data-stu-id="8f6c9-425">You should expect a smooth transition.</span></span> <span data-ttu-id="8f6c9-426">在移轉時，每當需要您的電子簽章時，您就會收到來自 adobesign@adobesign.com (而不是 DocuSign) 的電子郵件。</span><span class="sxs-lookup"><span data-stu-id="8f6c9-426">Upon migration, you will receive an email from adobesign@adobesign.com, instead of DocuSign, whenever your electronic signature is required.</span></span> <span data-ttu-id="8f6c9-427">這封電子郵件會提供您需要在其中簽署的 Adobe Sign 網頁連結。</span><span class="sxs-lookup"><span data-stu-id="8f6c9-427">This email will provide you with a link to the Adobe Sign web page where you will need to sign.</span></span> <span data-ttu-id="8f6c9-428">Microsoft 合作夥伴不需要重新簽署現有的合約，只需簽署未來的通路合約。</span><span class="sxs-lookup"><span data-stu-id="8f6c9-428">Microsoft partners will not have to re-sign existing agreements, only future Channel Agreements.</span></span> 

<span data-ttu-id="8f6c9-429">您可以在[資源庫](https://partner.microsoft.com/resources/detail/adobe-sign-signature-request-email-pdf)中找到 Adobe Sign 簽章要求電子郵件的範例。</span><span class="sxs-lookup"><span data-stu-id="8f6c9-429">You can find an example of an Adobe Sign signature request email in [the resource gallery](https://partner.microsoft.com/resources/detail/adobe-sign-signature-request-email-pdf).</span></span> 

<span data-ttu-id="8f6c9-430">**若要獲得最佳體驗，請務必執行下列動作：**</span><span class="sxs-lookup"><span data-stu-id="8f6c9-430">**For the best experience, make sure to do the following:**</span></span>

1. <span data-ttu-id="8f6c9-431">將 adobesign@adobesign.com 新增至您的安全寄件者清單，以避免來自此帳戶的電子郵件直接進入您的垃圾郵件資料夾。</span><span class="sxs-lookup"><span data-stu-id="8f6c9-431">Add adobesign@adobesign.com to your safe senders list to avoid emails from this account going directly into your junk email folder.</span></span>
2. <span data-ttu-id="8f6c9-432">請與您的 IT 部門合作，以：</span><span class="sxs-lookup"><span data-stu-id="8f6c9-432">Work with your IT department to:</span></span>
   - <span data-ttu-id="8f6c9-433">將 adobesign@adobesign.com 電子郵件地址新增至其安全寄件者清單，以確保其不會包含在任何預先建立的網路釣魚規則中。</span><span class="sxs-lookup"><span data-stu-id="8f6c9-433">Add the adobesign@adobesign.com email address to their safe senders list to ensure that it’s not included in any pre-established phishing rule.</span></span>
   - <span data-ttu-id="8f6c9-434">更新現有的安全性原則，以確保所有必要收件者都能在您的 Adobe Sign 企業授權下簽署文件。</span><span class="sxs-lookup"><span data-stu-id="8f6c9-434">Update existing security policies to ensure that all required recipients can sign documentation under your Adobe Sign enterprise license.</span></span>

<span data-ttu-id="8f6c9-435">Adobe Sign 是 Microsoft 慣用的電子簽章解決方案 (ESS)。</span><span class="sxs-lookup"><span data-stu-id="8f6c9-435">Adobe Sign is Microsoft’s preferred Electronic Signature Solution (ESS).</span></span> <span data-ttu-id="8f6c9-436">轉換成 Adobe Sign 可以確保電子簽章體驗是安全且有效率的，從而為我們的客戶和合作夥伴提供更高的價值。</span><span class="sxs-lookup"><span data-stu-id="8f6c9-436">The transition to Adobe Sign will ensure a secure and efficient electronic signature experience that will deliver greater value to our customers and partners.</span></span>

<span data-ttu-id="8f6c9-437">如需有關如何以電子方式簽署文件和電子簽名委派的詳細資訊，請參閱下列 **教學課程**：</span><span class="sxs-lookup"><span data-stu-id="8f6c9-437">For additional information on how to electronically sign documents and electronic signature delegation, refer to the following **tutorials**:</span></span> 
- [<span data-ttu-id="8f6c9-438">以電子方式簽署文件 | Adobe Sign 教學課程</span><span class="sxs-lookup"><span data-stu-id="8f6c9-438">Electronically sign a document | Adobe Sign tutorials</span></span>](https://helpx.adobe.com/sign/how-to/adobe-for-signers.html?playlist=/ccx/v1/collection/product/sign/segment/designer/explevel/beginner/applaunch/continuinged/collection.ccx.js&ref=helpx.adobe.com)
- [<span data-ttu-id="8f6c9-439">委派其他人簽署文件 | Adobe Sign 教學課程</span><span class="sxs-lookup"><span data-stu-id="8f6c9-439">Delegate someone else to sign a document | Adobe Sign tutorials</span></span>](https://helpx.adobe.com/sign/how-to/use-the-delegator-role.html?playlist=/ccx/v1/collection/product/sign/segment/designer/explevel/beginner/applaunch/orientation/collection.ccx.js&ref=helpx.adobe.com)

### <a name="next-steps"></a><span data-ttu-id="8f6c9-440">後續步驟</span><span class="sxs-lookup"><span data-stu-id="8f6c9-440">Next steps</span></span>

<span data-ttu-id="8f6c9-441">請與貴組織內適當的專案關係人分享這項資訊。</span><span class="sxs-lookup"><span data-stu-id="8f6c9-441">Share this information with the appropriate stakeholders in your organization.</span></span>

### <a name="questions"></a><span data-ttu-id="8f6c9-442">有問題嗎？</span><span class="sxs-lookup"><span data-stu-id="8f6c9-442">Questions?</span></span>

<span data-ttu-id="8f6c9-443">如有任何問題，請使用[通話記錄工具 (CLT)](https://clt.partners.extranet.microsoft.com/CLT) 或透過 [Explore MS](https://www.explore.ms/) 連絡您的區域營運中心。</span><span class="sxs-lookup"><span data-stu-id="8f6c9-443">If you have any questions, contact your Regional Operations Center using the [Call Logging Tool (CLT)](https://clt.partners.extranet.microsoft.com/CLT) or at [Explore MS](https://www.explore.ms/).</span></span> <span data-ttu-id="8f6c9-444">請仔細遵循標準 CLT 程序，以便我們儘快解決您的查詢。</span><span class="sxs-lookup"><span data-stu-id="8f6c9-444">Follow the standard CLT process closely so that we can resolve your query as quickly as possible.</span></span>

_____________ 

## <a name="commercial-pricing-update-for-norwegian-krone"></a><a name="6"></a><span data-ttu-id="8f6c9-445">挪威克朗的商業定價更新</span><span class="sxs-lookup"><span data-stu-id="8f6c9-445">Commercial pricing update for Norwegian krone</span></span> 

### <a name="categories"></a><span data-ttu-id="8f6c9-446">類別</span><span class="sxs-lookup"><span data-stu-id="8f6c9-446">Categories</span></span>

- <span data-ttu-id="8f6c9-447">日期：2021-01-14</span><span class="sxs-lookup"><span data-stu-id="8f6c9-447">Date: 2021-01-14</span></span>
- <span data-ttu-id="8f6c9-448">供應項目/市場</span><span class="sxs-lookup"><span data-stu-id="8f6c9-448">Offers/Markets</span></span>

### <a name="impacted-audience"></a><span data-ttu-id="8f6c9-449">影響對象</span><span class="sxs-lookup"><span data-stu-id="8f6c9-449">Impacted audience</span></span>

<span data-ttu-id="8f6c9-450">使用挪威克朗的雲端解決方案提供者合作夥伴。</span><span class="sxs-lookup"><span data-stu-id="8f6c9-450">Cloud Solution Provider partners using the Norwegian krone.</span></span>

### <a name="details"></a><span data-ttu-id="8f6c9-451">詳細資料</span><span class="sxs-lookup"><span data-stu-id="8f6c9-451">Details</span></span>

<span data-ttu-id="8f6c9-452">從 2021 年 3 月 1 日起，商業內部部署軟體和線上服務的挪威克朗價格將會變更，以便重新與區域中的主要定價層級一起調整。</span><span class="sxs-lookup"><span data-stu-id="8f6c9-452">From March 1, 2021, Norwegian krone prices for commercial on-premises software and online services will change to realign with prevailing pricing levels in the region.</span></span>
<span data-ttu-id="8f6c9-453">完整的公告僅適用於 Microsoft 合作夥伴。</span><span class="sxs-lookup"><span data-stu-id="8f6c9-453">The full announcement is available only to Microsoft partners.</span></span> <span data-ttu-id="8f6c9-454">[登入以閱讀完整的公告](https://partner.microsoft.com/resources/detail/pricing-update-norway-partners-pdf)。</span><span class="sxs-lookup"><span data-stu-id="8f6c9-454">[Sign in to access the full announcement](https://partner.microsoft.com/resources/detail/pricing-update-norway-partners-pdf).</span></span>

_____________ 

## <a name="commercial-pricing-update-for-the-indian-rupee"></a><a name="5"></a><span data-ttu-id="8f6c9-455">印度幣的商業定價更新</span><span class="sxs-lookup"><span data-stu-id="8f6c9-455">Commercial pricing update for the Indian rupee</span></span> 

### <a name="categories"></a><span data-ttu-id="8f6c9-456">類別</span><span class="sxs-lookup"><span data-stu-id="8f6c9-456">Categories</span></span>

- <span data-ttu-id="8f6c9-457">日期：2021-01-08</span><span class="sxs-lookup"><span data-stu-id="8f6c9-457">Date: 2021-01-08</span></span>
- <span data-ttu-id="8f6c9-458">供應項目/市場</span><span class="sxs-lookup"><span data-stu-id="8f6c9-458">Offers/Markets</span></span>

### <a name="impacted-audience"></a><span data-ttu-id="8f6c9-459">影響對象</span><span class="sxs-lookup"><span data-stu-id="8f6c9-459">Impacted audience</span></span>

<span data-ttu-id="8f6c9-460">在印度進行交易的「雲端解決方案提供者」合作夥伴。</span><span class="sxs-lookup"><span data-stu-id="8f6c9-460">CSP partners transacting in India.</span></span>

### <a name="details"></a><span data-ttu-id="8f6c9-461">詳細資料</span><span class="sxs-lookup"><span data-stu-id="8f6c9-461">Details</span></span> 

<span data-ttu-id="8f6c9-462">為配合印度和亞洲地區的商務軟體和線上服務定價，Microsoft 即將對印度幣的價目表進行變更。</span><span class="sxs-lookup"><span data-stu-id="8f6c9-462">Microsoft is making changes to the Indian rupee price list to align prices for commercial software and online services within India and the Asian region.</span></span>

<span data-ttu-id="8f6c9-463">完整的公告僅適用於 Microsoft 合作夥伴。</span><span class="sxs-lookup"><span data-stu-id="8f6c9-463">The full announcement is only available to Microsoft Partners.</span></span> <span data-ttu-id="8f6c9-464">[登入以閱讀完整的公告](https://partner.microsoft.com/resources/detail/price-update-indian-rupee.pdf)。</span><span class="sxs-lookup"><span data-stu-id="8f6c9-464">[Login to access the full announcement](https://partner.microsoft.com/resources/detail/price-update-indian-rupee.pdf).</span></span>

________________

## <a name="calling-plan-and-phone-system-updates-for-february-1-2021"></a><a name="4"></a><span data-ttu-id="8f6c9-465">在2021年2月1日呼叫方案和電話系統更新</span><span class="sxs-lookup"><span data-stu-id="8f6c9-465">Calling Plan and Phone System updates for February 1, 2021</span></span>

### <a name="categories"></a><span data-ttu-id="8f6c9-466">類別</span><span class="sxs-lookup"><span data-stu-id="8f6c9-466">Categories</span></span>

- <span data-ttu-id="8f6c9-467">日期：2021-01-08</span><span class="sxs-lookup"><span data-stu-id="8f6c9-467">Date: 2021-01-08</span></span>
- <span data-ttu-id="8f6c9-468">供應項目/市場</span><span class="sxs-lookup"><span data-stu-id="8f6c9-468">Offers/Markets</span></span>

### <a name="summary"></a><span data-ttu-id="8f6c9-469">摘要</span><span class="sxs-lookup"><span data-stu-id="8f6c9-469">Summary</span></span>

<span data-ttu-id="8f6c9-470">我們將在特定國家/地區推出 Microsoft 365 的附加元件供應項目，其中包括電話系統和國內通話方案，以及獨立的國內通話方案。</span><span class="sxs-lookup"><span data-stu-id="8f6c9-470">An add-on offer to Microsoft 365, which will include Phone System and Domestic Calling Plan and a standalone Domestic Calling Plan, is coming soon to select countries.</span></span>

### <a name="impacted-audience"></a><span data-ttu-id="8f6c9-471">影響對象</span><span class="sxs-lookup"><span data-stu-id="8f6c9-471">Impacted audience</span></span>

<span data-ttu-id="8f6c9-472">透過雲端解決方案提供者 (CSP) 方案交易的所有合作夥伴。</span><span class="sxs-lookup"><span data-stu-id="8f6c9-472">All partners transacting through the Cloud Solution Provider (CSP) program.</span></span>

### <a name="details"></a><span data-ttu-id="8f6c9-473">詳細資料</span><span class="sxs-lookup"><span data-stu-id="8f6c9-473">Details</span></span> 

<span data-ttu-id="8f6c9-474">Microsoft 365 E1、E3 和 E5 中搭配此附加元件的供應項目將包含電話系統和國內通話方案。</span><span class="sxs-lookup"><span data-stu-id="8f6c9-474">The add-on bundled offer to Microsoft 365 E1, E3, and E5 offers will include Phone System and Domestic Calling Plan.</span></span> <span data-ttu-id="8f6c9-475">此外，新的獨立國內通話方案供應項目將僅適用於 E5。</span><span class="sxs-lookup"><span data-stu-id="8f6c9-475">In addition, a new standalone Domestic Calling Plan offer will be available for E5 only.</span></span> <span data-ttu-id="8f6c9-476">新的供應項目僅適用於美國、波多黎各和加拿大的客戶；對於所有其他國家和地區，現有的全球獨立 SKU 和定價會維持不變。</span><span class="sxs-lookup"><span data-stu-id="8f6c9-476">The new offers will be available to customers in the US, Puerto Rico, and Canada only; for all other countries and territories, the existing global standalone SKUs and pricing remain the same.</span></span> 

<span data-ttu-id="8f6c9-477">這些供應項目將提供給美國、波多黎各和加拿大的商業客戶、學生、教職員、政府社群雲端 (GCC) 和非營利客戶使用。</span><span class="sxs-lookup"><span data-stu-id="8f6c9-477">These offers will be available to Commercial, Student, Faculty, Government Community Cloud (GCC), and Nonprofit customers in the US, Puerto Rico, and Canada.</span></span> <span data-ttu-id="8f6c9-478">通話方案無法在美國其他所有領地使用。</span><span class="sxs-lookup"><span data-stu-id="8f6c9-478">Calling plans are not available in any of the other US territories.</span></span>

   |<span data-ttu-id="8f6c9-479">**供應項目名稱**</span><span class="sxs-lookup"><span data-stu-id="8f6c9-479">**Offer name**</span></span>|<span data-ttu-id="8f6c9-480">**優惠識別碼**</span><span class="sxs-lookup"><span data-stu-id="8f6c9-480">**Offer ID**</span></span>|<span data-ttu-id="8f6c9-481">**材質識別碼**</span><span class="sxs-lookup"><span data-stu-id="8f6c9-481">**Material ID**</span></span>|
   |-------------------|:------|:------|
   |<span data-ttu-id="8f6c9-482">適用於美國和加拿大的 Microsoft Teams 通話基礎</span><span class="sxs-lookup"><span data-stu-id="8f6c9-482">Microsoft Teams Calling Essentials for US and Canada</span></span>|<span data-ttu-id="8f6c9-483">1ee81de6-4d8b-4cf1-b926-2fd2a774a4ca</span><span class="sxs-lookup"><span data-stu-id="8f6c9-483">1ee81de6-4d8b-4cf1-b926-2fd2a774a4ca</span></span>|<span data-ttu-id="8f6c9-484">8N2-00010</span><span class="sxs-lookup"><span data-stu-id="8f6c9-484">8N2-00010</span></span>|
   |<span data-ttu-id="8f6c9-485">適用於美國和加拿大的 Microsoft Teams 通話基礎 (非營利員工定價)</span><span class="sxs-lookup"><span data-stu-id="8f6c9-485">Microsoft Teams Calling Essentials for US and Canada (Nonprofit Staff Pricing)</span></span>|<span data-ttu-id="8f6c9-486">0c2ece0d-39b7-40ec-8c08-87c2b6c75d62</span><span class="sxs-lookup"><span data-stu-id="8f6c9-486">0c2ece0d-39b7-40ec-8c08-87c2b6c75d62</span></span>|<span data-ttu-id="8f6c9-487">8N2-00011</span><span class="sxs-lookup"><span data-stu-id="8f6c9-487">8N2-00011</span></span>|
   |<span data-ttu-id="8f6c9-488">適用於美國和加拿大教職員的 Microsoft Teams 通話基礎</span><span class="sxs-lookup"><span data-stu-id="8f6c9-488">Microsoft Teams Calling Essentials for US and Canada for faculty</span></span>|<span data-ttu-id="8f6c9-489">b8baa3b8-8cc2-4f26-a212-7fbeb28e7895</span><span class="sxs-lookup"><span data-stu-id="8f6c9-489">b8baa3b8-8cc2-4f26-a212-7fbeb28e7895</span></span>|<span data-ttu-id="8f6c9-490">8N3-00003</span><span class="sxs-lookup"><span data-stu-id="8f6c9-490">8N3-00003</span></span>|
   |<span data-ttu-id="8f6c9-491">適用於美國和加拿大學生的 Microsoft Teams 通話基礎</span><span class="sxs-lookup"><span data-stu-id="8f6c9-491">Microsoft Teams Calling Essentials for US and Canada for students</span></span>|<span data-ttu-id="8f6c9-492">26956da8-eeb5-44e3-aa79-d36e0e42b930</span><span class="sxs-lookup"><span data-stu-id="8f6c9-492">26956da8-eeb5-44e3-aa79-d36e0e42b930</span></span>|<span data-ttu-id="8f6c9-493">8N3-00004</span><span class="sxs-lookup"><span data-stu-id="8f6c9-493">8N3-00004</span></span>|
   |<span data-ttu-id="8f6c9-494">適用於美國和加拿大政府社群雲端 (GCC) 的 Microsoft Teams 通話基礎</span><span class="sxs-lookup"><span data-stu-id="8f6c9-494">Microsoft Teams Calling Essentials for US and Canada for GCC</span></span>|<span data-ttu-id="8f6c9-495">7a2e2d5a-41b5-4b20-a0d1-0d06d34b5fe1</span><span class="sxs-lookup"><span data-stu-id="8f6c9-495">7a2e2d5a-41b5-4b20-a0d1-0d06d34b5fe1</span></span>|<span data-ttu-id="8f6c9-496">8N4-00002</span><span class="sxs-lookup"><span data-stu-id="8f6c9-496">8N4-00002</span></span>|
   |<span data-ttu-id="8f6c9-497">適用於美國和加拿大的 Microsoft 365 國內通話方案</span><span class="sxs-lookup"><span data-stu-id="8f6c9-497">Microsoft 365 Domestic Calling Plan for US and Canada</span></span>|<span data-ttu-id="8f6c9-498">60d2919e-427a-46c9-bd03-89cbad27d53f</span><span class="sxs-lookup"><span data-stu-id="8f6c9-498">60d2919e-427a-46c9-bd03-89cbad27d53f</span></span>|<span data-ttu-id="8f6c9-499">TK2-00050</span><span class="sxs-lookup"><span data-stu-id="8f6c9-499">TK2-00050</span></span>|
   |<span data-ttu-id="8f6c9-500">適用於美國和加拿大教職員的 Microsoft 365 國內通話方案</span><span class="sxs-lookup"><span data-stu-id="8f6c9-500">Microsoft 365 Domestic Calling Plan for faculty for US and Canada</span></span>|<span data-ttu-id="8f6c9-501">602e7548-375b-4e01-bf79-a9a8b8ff16d4</span><span class="sxs-lookup"><span data-stu-id="8f6c9-501">602e7548-375b-4e01-bf79-a9a8b8ff16d4</span></span>|<span data-ttu-id="8f6c9-502">LM7-00006</span><span class="sxs-lookup"><span data-stu-id="8f6c9-502">LM7-00006</span></span>|
   |<span data-ttu-id="8f6c9-503">適用於美國和加拿大學生的 Microsoft 365 國內通話方案</span><span class="sxs-lookup"><span data-stu-id="8f6c9-503">Microsoft 365 Domestic Calling Plan for students for US and Canada</span></span>|<span data-ttu-id="8f6c9-504">1f4b4375-3185-40cf-b044-117fe3b102c6</span><span class="sxs-lookup"><span data-stu-id="8f6c9-504">1f4b4375-3185-40cf-b044-117fe3b102c6</span></span>|<span data-ttu-id="8f6c9-505">LM7-00007</span><span class="sxs-lookup"><span data-stu-id="8f6c9-505">LM7-00007</span></span>|
   |<span data-ttu-id="8f6c9-506">適用於美國和加拿大政府社群雲端 (GCC) 的 Microsoft 365 國內通話方案</span><span class="sxs-lookup"><span data-stu-id="8f6c9-506">Microsoft 365 Domestic Calling Plan for GCC for US and Canada</span></span>|<span data-ttu-id="8f6c9-507">594ed84e-ddf8-4e40-9726-76c04bd29e3b</span><span class="sxs-lookup"><span data-stu-id="8f6c9-507">594ed84e-ddf8-4e40-9726-76c04bd29e3b</span></span>|<span data-ttu-id="8f6c9-508">LM9-00023</span><span class="sxs-lookup"><span data-stu-id="8f6c9-508">LM9-00023</span></span>|

### <a name="next-steps"></a><span data-ttu-id="8f6c9-509">後續步驟</span><span class="sxs-lookup"><span data-stu-id="8f6c9-509">Next steps</span></span>

- <span data-ttu-id="8f6c9-510">請與您組織中相關連絡人分享這項資訊，以了解追加銷售和交叉銷售商機。</span><span class="sxs-lookup"><span data-stu-id="8f6c9-510">Share this information with the relevant contacts in your organization and understand the upsell and cross-sell opportunities.</span></span> 
- <span data-ttu-id="8f6c9-511">請參閱 [Teams 合作夥伴指南](https://aka.ms/teamscallingmeetingsguide)的資源區段。</span><span class="sxs-lookup"><span data-stu-id="8f6c9-511">Review the resources section of the [Teams Partner Guide](https://aka.ms/teamscallingmeetingsguide).</span></span>

_____________ 

## <a name="license-base-price-list-updates-for-january-2021"></a><a name="3"></a><span data-ttu-id="8f6c9-512">2021 年 1 月的授權型價目表更新</span><span class="sxs-lookup"><span data-stu-id="8f6c9-512">License-base price list updates for January 2021</span></span> 

### <a name="categories"></a><span data-ttu-id="8f6c9-513">類別</span><span class="sxs-lookup"><span data-stu-id="8f6c9-513">Categories</span></span>

- <span data-ttu-id="8f6c9-514">日期：2021-01-08</span><span class="sxs-lookup"><span data-stu-id="8f6c9-514">Date: 2021-01-08</span></span>
- <span data-ttu-id="8f6c9-515">供應項目/市場</span><span class="sxs-lookup"><span data-stu-id="8f6c9-515">Offers/Markets</span></span>

### <a name="summary"></a><span data-ttu-id="8f6c9-516">摘要</span><span class="sxs-lookup"><span data-stu-id="8f6c9-516">Summary</span></span>

<span data-ttu-id="8f6c9-517">授權型供應項目的 1 月和 2 月價目表已更新，已修正某些不正確的定價。</span><span class="sxs-lookup"><span data-stu-id="8f6c9-517">January and February price lists for license-based offers have been updated to correct certain incorrect list prices.</span></span>

### <a name="impacted-audience"></a><span data-ttu-id="8f6c9-518">影響對象</span><span class="sxs-lookup"><span data-stu-id="8f6c9-518">Impacted audience</span></span>

<span data-ttu-id="8f6c9-519">透過雲端解決方案提供者 (CSP) 方案交易的所有合作夥伴。</span><span class="sxs-lookup"><span data-stu-id="8f6c9-519">All partners transacting through the Cloud Solution Provider (CSP) program.</span></span>

### <a name="details"></a><span data-ttu-id="8f6c9-520">詳細資料</span><span class="sxs-lookup"><span data-stu-id="8f6c9-520">Details</span></span> 

<span data-ttu-id="8f6c9-521">2021 年 1 月和 2 月的授權型價目表中有幾個不正確的定價。</span><span class="sxs-lookup"><span data-stu-id="8f6c9-521">The license-based price lists for January 2021 and February 2021 included a few incorrect list prices.</span></span> <span data-ttu-id="8f6c9-522">受影響的供應項目和貨幣如下。</span><span class="sxs-lookup"><span data-stu-id="8f6c9-522">The impacted offers and currencies are below.</span></span> <span data-ttu-id="8f6c9-523">正確的定價已於 2021 年 1 月 7 日下午 2 點 (太平洋標準時間) 更新且可供使用。</span><span class="sxs-lookup"><span data-stu-id="8f6c9-523">The correct pricing was updated and available as of January 7, 2021 2PM PST (Pacific Standard Time).</span></span> 

   |<span data-ttu-id="8f6c9-524">**供應項目名稱**</span><span class="sxs-lookup"><span data-stu-id="8f6c9-524">**Offer name**</span></span>|<span data-ttu-id="8f6c9-525">**優惠識別碼**</span><span class="sxs-lookup"><span data-stu-id="8f6c9-525">**Offer ID**</span></span>|<span data-ttu-id="8f6c9-526">**材質識別碼**</span><span class="sxs-lookup"><span data-stu-id="8f6c9-526">**Material ID**</span></span>|
   |-------------------|:------|:------|
   |<span data-ttu-id="8f6c9-527">Microsoft 365 E3</span><span class="sxs-lookup"><span data-stu-id="8f6c9-527">Microsoft 365 E3</span></span>|<span data-ttu-id="8f6c9-528">2b3b8d2d-10aa-4be4-b5fd-7f2feb0c3091</span><span class="sxs-lookup"><span data-stu-id="8f6c9-528">2b3b8d2d-10aa-4be4-b5fd-7f2feb0c3091</span></span>|<span data-ttu-id="8f6c9-529">AAA-35638</span><span class="sxs-lookup"><span data-stu-id="8f6c9-529">AAA-35638</span></span>| 
   |<span data-ttu-id="8f6c9-530">Microsoft 365 商務基本版</span><span class="sxs-lookup"><span data-stu-id="8f6c9-530">Microsoft 365 Business Basic</span></span>|<span data-ttu-id="8f6c9-531">bd938f12-058f-4927-bba3-ae36b1d2501c</span><span class="sxs-lookup"><span data-stu-id="8f6c9-531">bd938f12-058f-4927-bba3-ae36b1d2501c</span></span>|<span data-ttu-id="8f6c9-532">AAA-10624</span><span class="sxs-lookup"><span data-stu-id="8f6c9-532">AAA-10624</span></span>|

<span data-ttu-id="8f6c9-533">受影響的貨幣：</span><span class="sxs-lookup"><span data-stu-id="8f6c9-533">Currencies impacted:</span></span> 

- <span data-ttu-id="8f6c9-534">Microsoft 365 E3 定價問題僅限於下列貨幣：JPY (日元)、GBP (英鎊)、歐元 (歐盟)、AUD (澳幣)。</span><span class="sxs-lookup"><span data-stu-id="8f6c9-534">Microsoft 365 E3 price issues were limited to only these currencies: JPY (Japanese Yen), GBP (Great British Pound), EUR (European Union), AUD (Australian Dollar).</span></span> 
- <span data-ttu-id="8f6c9-535">Microsoft 365 商務版基本問題僅限於 USD (美元)。</span><span class="sxs-lookup"><span data-stu-id="8f6c9-535">Microsoft 365 Business Basic issues were limited to only USD (United States Dollars).</span></span> 

<span data-ttu-id="8f6c9-536">合作夥伴應參考目前可用的 1 月和 2 月預覽價目表，以取得正確的定價。</span><span class="sxs-lookup"><span data-stu-id="8f6c9-536">Partners should reference the currently available January and February preview price lists for the correct prices.</span></span> 

### <a name="next-steps"></a><span data-ttu-id="8f6c9-537">後續步驟</span><span class="sxs-lookup"><span data-stu-id="8f6c9-537">Next steps</span></span>

- <span data-ttu-id="8f6c9-538">合作夥伴應從合作夥伴中心下載最新的價目表檔案，以取得已更正的 1 月和 2 月定價。</span><span class="sxs-lookup"><span data-stu-id="8f6c9-538">Partners should download the latest price list files from the Partner Center to get the corrected January and February prices.</span></span> 
- <span data-ttu-id="8f6c9-539">如果受影響租用戶的全域管理員在 1 月 1 日到 1 月 6 日之間購買了訂用帳戶，他們將會在 1 月底前收到合作夥伴中心的電子郵件通知，其中會提供更多詳細資料。</span><span class="sxs-lookup"><span data-stu-id="8f6c9-539">Global administrators for impacted tenants who have purchased subscriptions between January 1 and January 6 will be notified via a Partner Center email before the end of January with more details.</span></span> 

________________
## <a name="deprecation-and-retirement-of-existing-get-and-put-qualification-apis-for-the-education-customer-validation-process-by-the-end-of-february-2021"></a><a name="2"></a><span data-ttu-id="8f6c9-540">2021 年 2 月底時，教育客戶驗證程序的現有 GET 和 PUT 限定性條件 API 將會過時並遭到淘汰</span><span class="sxs-lookup"><span data-stu-id="8f6c9-540">Deprecation and retirement of existing GET and PUT Qualification APIs for the Education customer validation process by the end of February 2021</span></span>

### <a name="impacted-audience"></a><span data-ttu-id="8f6c9-541">影響對象</span><span class="sxs-lookup"><span data-stu-id="8f6c9-541">Impacted audience</span></span>

<span data-ttu-id="8f6c9-542">使用合作夥伴中心 API 透過雲端解決方案提供者計畫銷售學術供應項目的合作夥伴</span><span class="sxs-lookup"><span data-stu-id="8f6c9-542">Partners selling Academic offers through the Cloud Solution Provider program using the Partner Center API</span></span>

### <a name="details"></a><span data-ttu-id="8f6c9-543">詳細資料</span><span class="sxs-lookup"><span data-stu-id="8f6c9-543">Details</span></span> 

<span data-ttu-id="8f6c9-544">這是 2020 年 12 月所發行 API 增強功能的後續事宜。</span><span class="sxs-lookup"><span data-stu-id="8f6c9-544">This is a follow-up to the API enhancements released in December 2020.</span></span> <span data-ttu-id="8f6c9-545">2020 年 12 月時發行了新的 GET 和 POST 限定性條件 API，因此舊的 GET 和 PUT 限定性條件 API 將於 2021 年 2 月底時遭到淘汰。</span><span class="sxs-lookup"><span data-stu-id="8f6c9-545">In December 2020 new GET and POST Qualifications APIs were released, and as a result the old GET and PUT Qualification APIs will be retired by the end of February 2021.</span></span> <span data-ttu-id="8f6c9-546">屆時，您必須使用新的 GET 和 POST 合作夥伴中心 API，才能夠購買教育版供應項目。</span><span class="sxs-lookup"><span data-stu-id="8f6c9-546">At that time, you will need to use the new GET and POST Partner Center APIs in order to be able to purchase Education offers.</span></span> 

### <a name="next-steps"></a><span data-ttu-id="8f6c9-547">後續步驟</span><span class="sxs-lookup"><span data-stu-id="8f6c9-547">Next steps</span></span>

- <span data-ttu-id="8f6c9-548">如果您還沒有這麼做，請更新為新的 API，以便成功且即時地完成轉換。</span><span class="sxs-lookup"><span data-stu-id="8f6c9-548">If you haven't already done so, update to the new APIs for a successful and timely transition.</span></span>
- <span data-ttu-id="8f6c9-549">檢閱新的合作夥伴中心 API 變更，以及[作業整備資源中的指南：合作夥伴中心教育客戶驗證程序增強功能](https://partner.microsoft.com/resources/collection/partner-center-edu-validation-enhancements#/)。</span><span class="sxs-lookup"><span data-stu-id="8f6c9-549">Review the new Partner Center API changes, and [Guide in the Operations Readiness resources:  Partner Center Education customer validation process enhancements](https://partner.microsoft.com/resources/collection/partner-center-edu-validation-enhancements#/).</span></span>
- <span data-ttu-id="8f6c9-550">請與組織中的適當小組以及轉銷商分享這項資訊，協助他們為這些變更做好準備。</span><span class="sxs-lookup"><span data-stu-id="8f6c9-550">Share this information with the appropriate teams in your organization, and with your resellers, to help them prepare for these changes.</span></span>

_____________

## <a name="dynamics-365-offers-for-february-2021"></a><a name="1"></a><span data-ttu-id="8f6c9-551">2021 年 2 月的 Dynamics 365 供應項目</span><span class="sxs-lookup"><span data-stu-id="8f6c9-551">Dynamics 365 offers for February 2021</span></span>

### <a name="categories"></a><span data-ttu-id="8f6c9-552">類別</span><span class="sxs-lookup"><span data-stu-id="8f6c9-552">Categories</span></span>

- <span data-ttu-id="8f6c9-553">日期：2021-01-04</span><span class="sxs-lookup"><span data-stu-id="8f6c9-553">Date: 2021-01-04</span></span>
- <span data-ttu-id="8f6c9-554">供應項目</span><span class="sxs-lookup"><span data-stu-id="8f6c9-554">Offers</span></span>

### <a name="summary"></a><span data-ttu-id="8f6c9-555">[摘要]</span><span class="sxs-lookup"><span data-stu-id="8f6c9-555">Summary</span></span>

<span data-ttu-id="8f6c9-556">新的 Dynamics 365 供應項目變更將於 2021 年 2 月啟動。</span><span class="sxs-lookup"><span data-stu-id="8f6c9-556">New Dynamics 365 offer changes will be launched in February 2021.</span></span>

### <a name="impacted-audience"></a><span data-ttu-id="8f6c9-557">影響對象</span><span class="sxs-lookup"><span data-stu-id="8f6c9-557">Impacted audience</span></span>

<span data-ttu-id="8f6c9-558">參與雲端解決方案提供者 (CSP) 直接計費合作夥伴、間接提供者和間接轉售商獎勵計畫的合作夥伴</span><span class="sxs-lookup"><span data-stu-id="8f6c9-558">Partners participating in the Cloud Solution Provider (CSP) direct bill partner, indirect provider, and indirect reseller incentive programs</span></span>

### <a name="details"></a><span data-ttu-id="8f6c9-559">詳細資料</span><span class="sxs-lookup"><span data-stu-id="8f6c9-559">Details</span></span>

<span data-ttu-id="8f6c9-560">Microsoft 宣佈即將推出新的 Dynamics 365 供應項目變更，且將於 2021 年 2 月啟動：</span><span class="sxs-lookup"><span data-stu-id="8f6c9-560">Microsoft is announcing upcoming new Dynamics 365 offer changes that will be launched in February 2021 for:</span></span>

- <span data-ttu-id="8f6c9-561">Dynamics 365 Customer Voice 額外回應</span><span class="sxs-lookup"><span data-stu-id="8f6c9-561">Dynamics 365 Customer Voice Additional Response</span></span>
- <span data-ttu-id="8f6c9-562">Dynamics 365 Customer Service Insights 停止提供服務</span><span class="sxs-lookup"><span data-stu-id="8f6c9-562">Dynamics 365 Customer Service Insights End of Life</span></span>
- <span data-ttu-id="8f6c9-563">Dynamics 365 Cloud AX Migration 供應項目識別碼變更</span><span class="sxs-lookup"><span data-stu-id="8f6c9-563">Dynamics 365 Cloud AX Migration Offer IDs change</span></span>

<span data-ttu-id="8f6c9-564">**Dynamics 365 Customer Voice 額外回應**</span><span class="sxs-lookup"><span data-stu-id="8f6c9-564">**Dynamics 365 Customer Voice Additional Response**</span></span>

<span data-ttu-id="8f6c9-565">在 2021 年 2 月 1 日，Microsoft 將會建立新的「額外回應」供應項目 (具有 1000 個回應權利)，以取代現有供應項目 (具有 2000 個調查回應)，後者的銷售截止日為 2021 年 2 月 1 日。</span><span class="sxs-lookup"><span data-stu-id="8f6c9-565">On February 1, 2021, Microsoft will create a new "Additional Response" offer with 1-K response entitlement to replace the existing offer with 2-K Survey Responses, the end of sale of which will be on February 1, 2021.</span></span>

<span data-ttu-id="8f6c9-566">如需 SKU 詳細資料，請參閱 [Dynamics CSP Offers-February 2021 Excel 文件](https://partner.microsoft.com/resources/detail/dynamics-csp-offers-february-2021-xls)中的 [Customer Voice Addl Resp] 索引標籤。</span><span class="sxs-lookup"><span data-stu-id="8f6c9-566">See the "Customer Voice Addl Resp" tab in the [Dynamics CSP Offers-February 2021 Excel document](https://partner.microsoft.com/resources/detail/dynamics-csp-offers-february-2021-xls) for the SKU details.</span></span> <span data-ttu-id="8f6c9-567">如需詳細資訊，請檢視 [Microsoft Dynamics 365 Customer Voice 首頁](https://dynamics.microsoft.com/customer-voice/overview/)。</span><span class="sxs-lookup"><span data-stu-id="8f6c9-567">View the [Microsoft Dynamics 365 Customer Voice Home Page](https://dynamics.microsoft.com/customer-voice/overview/) for more information.</span></span>

<span data-ttu-id="8f6c9-568">**Dynamics 365 Customer Service Insights 停止提供服務**</span><span class="sxs-lookup"><span data-stu-id="8f6c9-568">**Dynamics 365 Customer Service Insights End of Life**</span></span>

<span data-ttu-id="8f6c9-569">在 2021 年 2 月 1 日，下列產品將會變更為停止提供服務：</span><span class="sxs-lookup"><span data-stu-id="8f6c9-569">On February 1, 2021, the following products will be changed to end-of-life:</span></span>

- <span data-ttu-id="8f6c9-570">Dynamics 365 Customer Service Insights (包括「其他案例」)</span><span class="sxs-lookup"><span data-stu-id="8f6c9-570">Dynamics 365 Customer Service Insights (including "Additional Cases")</span></span>
- <span data-ttu-id="8f6c9-571">Dynamics 365 Virtual Agent for Customer Service</span><span class="sxs-lookup"><span data-stu-id="8f6c9-571">Dynamics 365 Virtual Agent for Customer Service</span></span>

<span data-ttu-id="8f6c9-572">「Customer Service Insights」獨立體驗將會移至「Dynamics 365 Customer Service」，客戶可以在其中找到深藏在客戶服務體驗內的相同功能。</span><span class="sxs-lookup"><span data-stu-id="8f6c9-572">The "Customer Service Insights" standalone experience is moving into "Dynamics 365 Customer Service", where customers can find the same capabilities deeply embedded in the customer service experiences.</span></span>  

<span data-ttu-id="8f6c9-573">如需 SKU 詳細資料，請參閱 [Dynamics CSP Offers-February 2021 Excel 文件](https://partner.microsoft.com/resources/detail/dynamics-csp-offers-february-2021-xls)中的 [Customer Service Insights] 索引標籤。</span><span class="sxs-lookup"><span data-stu-id="8f6c9-573">See the "Customer Service Insights" tab in the [Dynamics CSP Offers-February 2021 Excel document](https://partner.microsoft.com/resources/detail/dynamics-csp-offers-february-2021-xls) for the SKU details.</span></span> <span data-ttu-id="8f6c9-574">如需詳細資訊，請造訪 [Microsoft Dynamics Customer Service 首頁](https://dynamics.microsoft.com/customer-service/overview/)。</span><span class="sxs-lookup"><span data-stu-id="8f6c9-574">Visit the [Microsoft Dynamics Customer Service Home Page](https://dynamics.microsoft.com/customer-service/overview/) for more information.</span></span>

<span data-ttu-id="8f6c9-575">**Dynamics 365 Cloud AX Migration 供應項目識別碼**</span><span class="sxs-lookup"><span data-stu-id="8f6c9-575">**Dynamics 365 Cloud AX migration offer IDs**</span></span>

<span data-ttu-id="8f6c9-576">這些 SKU 已從 2021 年 1 月 1 日的最終價目表中移除，目前無法訂購。</span><span class="sxs-lookup"><span data-stu-id="8f6c9-576">These SKUs have been removed from the January 1, 2021 final price list and will not be available to order at this time.</span></span> 

   |<span data-ttu-id="8f6c9-577">**供應項目名稱**</span><span class="sxs-lookup"><span data-stu-id="8f6c9-577">**Offer name**</span></span>|<span data-ttu-id="8f6c9-578">**優惠識別碼**</span><span class="sxs-lookup"><span data-stu-id="8f6c9-578">**Offer ID**</span></span>|
   |-------------------|:------|
   |<span data-ttu-id="8f6c9-579">Dynamics 365 Finance for AX Migration Program</span><span class="sxs-lookup"><span data-stu-id="8f6c9-579">Dynamics 365 Finance for AX Migration Program</span></span>|<span data-ttu-id="8f6c9-580">7fbd1115-a4c1-4cf9-b881-40c4187ca581</span><span class="sxs-lookup"><span data-stu-id="8f6c9-580">7fbd1115-a4c1-4cf9-b881-40c4187ca581</span></span>|
   |<span data-ttu-id="8f6c9-581">Dynamics 365 Supply Chain Management for AX Migration Program</span><span class="sxs-lookup"><span data-stu-id="8f6c9-581">Dynamics 365 Supply Chain Management for AX Migration Program</span></span>|<span data-ttu-id="8f6c9-582">a3c62c0e-4f8a-4fc9-a47e-dec3310529d0</span><span class="sxs-lookup"><span data-stu-id="8f6c9-582">a3c62c0e-4f8a-4fc9-a47e-dec3310529d0</span></span>|
   |<span data-ttu-id="8f6c9-583">Dynamics 365 Commerce for AX Migration Program</span><span class="sxs-lookup"><span data-stu-id="8f6c9-583">Dynamics 365 Commerce for AX Migration Program</span></span>|<span data-ttu-id="8f6c9-584">97e98de6-24a8-4282-bad6-9d1a874e90a4</span><span class="sxs-lookup"><span data-stu-id="8f6c9-584">97e98de6-24a8-4282-bad6-9d1a874e90a4</span></span>|
   |<span data-ttu-id="8f6c9-585">Dynamics 365 Finance Attach to Qualifying Dynamics 365 Base Offer for AX Migration Program</span><span class="sxs-lookup"><span data-stu-id="8f6c9-585">Dynamics 365 Finance Attach to Qualifying Dynamics 365 Base Offer for AX Migration Program</span></span>|<span data-ttu-id="8f6c9-586">69d789e8-1e93-4dee-86b2-3ddfb03c08b9</span><span class="sxs-lookup"><span data-stu-id="8f6c9-586">69d789e8-1e93-4dee-86b2-3ddfb03c08b9</span></span>|
   |<span data-ttu-id="8f6c9-587">Dynamics 365 Supply Chain Management Attach to Qualifying Dynamics 365 Base Offer for AX Migration Program</span><span class="sxs-lookup"><span data-stu-id="8f6c9-587">Dynamics 365 Supply Chain Management Attach to Qualifying Dynamics 365 Base Offer for AX Migration Program</span></span>|<span data-ttu-id="8f6c9-588">c897adce-2964-4d24-abc3-7f7ad4b6a80d</span><span class="sxs-lookup"><span data-stu-id="8f6c9-588">c897adce-2964-4d24-abc3-7f7ad4b6a80d</span></span>|
   |<span data-ttu-id="8f6c9-589">Dynamics 365 Commerce Attach to Qualifying Dynamics 365 Base Offer for AX Migration Program</span><span class="sxs-lookup"><span data-stu-id="8f6c9-589">Dynamics 365 Commerce Attach to Qualifying Dynamics 365 Base Offer for AX Migration Program</span></span>|<span data-ttu-id="8f6c9-590">ba1fe561-cfda-405a-a25d-ecda3bd3cba7</span><span class="sxs-lookup"><span data-stu-id="8f6c9-590">ba1fe561-cfda-405a-a25d-ecda3bd3cba7</span></span>|
   |<span data-ttu-id="8f6c9-591">Dynamics 365 Operations – Activity for AX Migration Program</span><span class="sxs-lookup"><span data-stu-id="8f6c9-591">Dynamics 365 Operations – Activity for AX Migration Program</span></span>|<span data-ttu-id="8f6c9-592">177e954e-1fff-4941-8967-55a47e36e1ce</span><span class="sxs-lookup"><span data-stu-id="8f6c9-592">177e954e-1fff-4941-8967-55a47e36e1ce</span></span>|
   |<span data-ttu-id="8f6c9-593">Dynamics 365 Operations – Device for AX Migration Program</span><span class="sxs-lookup"><span data-stu-id="8f6c9-593">Dynamics 365 Operations – Device for AX Migration Program</span></span>|<span data-ttu-id="8f6c9-594">8c8b7c8f-cb3a-4737-8319-1752938c7be3</span><span class="sxs-lookup"><span data-stu-id="8f6c9-594">8c8b7c8f-cb3a-4737-8319-1752938c7be3</span></span>|
   |<span data-ttu-id="8f6c9-595">Dynamics 365 Team Members for AX Migration Program</span><span class="sxs-lookup"><span data-stu-id="8f6c9-595">Dynamics 365 Team Members for AX Migration Program</span></span>|<span data-ttu-id="8f6c9-596">1eb3ad0b-9de3-419d-8bfe-0d61bdd945b2</span><span class="sxs-lookup"><span data-stu-id="8f6c9-596">1eb3ad0b-9de3-419d-8bfe-0d61bdd945b2</span></span>|

### <a name="next-steps"></a><span data-ttu-id="8f6c9-597">後續步驟</span><span class="sxs-lookup"><span data-stu-id="8f6c9-597">Next steps</span></span>

<span data-ttu-id="8f6c9-598">檢閱關於本主題的資源，並與您組織中適當的利害關係人分享。</span><span class="sxs-lookup"><span data-stu-id="8f6c9-598">Review the resources about this topic and share them with the appropriate stakeholders in your organization.</span></span> 

### <a name="questions"></a><span data-ttu-id="8f6c9-599">有問題嗎？</span><span class="sxs-lookup"><span data-stu-id="8f6c9-599">Questions?</span></span>

<span data-ttu-id="8f6c9-600">如有關於這些供應項目的進一步問題，請洽詢相關的 Yammer 社群。</span><span class="sxs-lookup"><span data-stu-id="8f6c9-600">For any further questions about these offers, check your relevant Yammer communities.</span></span>
