...
## <a name="introducing-microsoft-viva-topics"></a><a name="7"></a>介紹 Microsoft Viva 主題
...
Microsoft Viva 主題將人工智慧 (AI) 來識別整個組織的知識與專業知識，並將其策展到像是產品、客戶或專案等共用主題中。 透過沉浸式主題卡片和主題頁面，知識可以在您的小組、專案和檔的內容中找到您。 AI 和人類共同合作以改善知識，並在您每天使用的應用程式中加以呈現。 
...
這些供應專案會在2月1日的供應專案名稱中提供「主題體驗」。 當您在3月1日更新價格清單時，這些供應專案名稱將會以「Viva 主題」更新。

|**供應項目名稱**|**優惠識別碼**|**材質識別碼**|
|------------------|:--------------------|:------------------|
|Viva 主題|b9ef0c81-9ca6-45fd-a6c1-627745ba8b8a|1JV-00005|
|教職員的 Viva 主題|8c930d38-db61-4afa-83f9-77c595c5cdfc|1TK-00006|
|學生的 Viva 主題|5de461d5-8ccc-4a8e-98ae-58a3ad400a57|1TK-00007|

### <a name="next-steps"></a>下一步

- 請參閱本主題的資源，並與您組織中適當的專案關係人分享這項資訊。  
- 您可以在 [Viva 主題資源中心](https://resources.techcommunity.microsoft.com/viva-topics)找到詳細資訊。
