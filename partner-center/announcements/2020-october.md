...
### <a name="impacted-audience"></a><span data-ttu-id="f5e35-110">影響對象</span><span class="sxs-lookup"><span data-stu-id="f5e35-110">Impacted audience</span></span>
...
### <a name="impacted-audience"></a><span data-ttu-id="f5e35-136">影響對象</span><span class="sxs-lookup"><span data-stu-id="f5e35-136">Impacted audience</span></span>
...
- <span data-ttu-id="f5e35-148">通知符合資格的客戶，並透過逐步程序引導他們。</span><span class="sxs-lookup"><span data-stu-id="f5e35-148">Notify your eligible customers and guide them through the step-by-step process.</span></span>
...
### <a name="categories"></a><span data-ttu-id="f5e35-176">類別</span><span class="sxs-lookup"><span data-stu-id="f5e35-176">Categories</span></span>
...
### <a name="additional-resources"></a><span data-ttu-id="f5e35-193">其他資源</span><span class="sxs-lookup"><span data-stu-id="f5e35-193">Additional resources</span></span>
...
<span data-ttu-id="f5e35-219">1. **新的營收效能需求**</span><span class="sxs-lookup"><span data-stu-id="f5e35-219">1.**New revenue performance requirement**</span></span>
...
### <a name="categories"></a><span data-ttu-id="f5e35-246">類別</span><span class="sxs-lookup"><span data-stu-id="f5e35-246">Categories</span></span>
...
<span data-ttu-id="f5e35-268">請忽略下列 11 月價目表預覽供應項目識別碼資訊。</span><span class="sxs-lookup"><span data-stu-id="f5e35-268">The following November price list preview Offer ID information should be disregarded.</span></span> 
...
### <a name="details"></a><span data-ttu-id="f5e35-286">詳細資料</span><span class="sxs-lookup"><span data-stu-id="f5e35-286">Details</span></span>
...
<span data-ttu-id="f5e35-299">直接提供者、間接提供者和間接經銷商</span><span class="sxs-lookup"><span data-stu-id="f5e35-299">Direct providers, indirect providers, and indirect resellers</span></span>
...
<span data-ttu-id="f5e35-333">從 2020 年 11 月 1 日到 2021 年 4 月 30 日止，新用戶和續約用戶訂閱包含通話方案的 Microsoft 365 商務語音及不含通話方案的 Microsoft 365 商務語音，均須享有折扣定價。</span><span class="sxs-lookup"><span data-stu-id="f5e35-333">From November 1, 2020 through April 30, 2021, new and renewal subscriptions of Microsoft 365 Business Voice with Calling Plan and Microsoft 365 Business Voice without Calling Plan will be subject to discount pricing.</span></span> <span data-ttu-id="f5e35-334">包含通話方案的 Microsoft 365 商務語音享有 12 個月 25% 的折扣，而不含通話方案的 Microsoft 365 商務語音則享有 12個月 33% 的折扣。</span><span class="sxs-lookup"><span data-stu-id="f5e35-334">Microsoft 365 Business Voice with Calling Plan will be subject to a 25 percent discount for 12 months, and Microsoft 365 Business Voice without Calling Plan will be subject to a 33 percent discount for 12 months.</span></span>
...
- <span data-ttu-id="f5e35-363">請瀏覽 [Microsoft 365 商務語音合作夥伴頁面](https://www.microsoft.com/microsoft-365/partners/businessvoice)，以深入了解商務語音。</span><span class="sxs-lookup"><span data-stu-id="f5e35-363">Visit the [Microsoft 365 Business Voice Partner Page](https://www.microsoft.com/microsoft-365/partners/businessvoice) to learn more about Business Voice.</span></span> 
...
### <a name="summary"></a><span data-ttu-id="f5e35-376">摘要</span><span class="sxs-lookup"><span data-stu-id="f5e35-376">Summary</span></span> 
...
### <a name="next-steps"></a><span data-ttu-id="f5e35-392">後續步驟</span><span class="sxs-lookup"><span data-stu-id="f5e35-392">Next steps</span></span>
...
- <span data-ttu-id="f5e35-439">見解與建議：針對會議室健全狀況、使用情形、線上會議和事件趨勢的客戶和報告彙總見解。</span><span class="sxs-lookup"><span data-stu-id="f5e35-439">Insights and recommendations: Aggregated insights across customers and reports on room health, usage, online meetings, and incident trends.</span></span>

#### <a name="offer-details"></a><span data-ttu-id="f5e35-440">供應項目詳細資料</span><span class="sxs-lookup"><span data-stu-id="f5e35-440">Offer details</span></span>

   |<span data-ttu-id="f5e35-441">**供應項目名稱**</span><span class="sxs-lookup"><span data-stu-id="f5e35-441">**Offer name**</span></span>|<span data-ttu-id="f5e35-442">**優惠識別碼**</span><span class="sxs-lookup"><span data-stu-id="f5e35-442">**Offer ID**</span></span>|<span data-ttu-id="f5e35-443">**材質識別碼**</span><span class="sxs-lookup"><span data-stu-id="f5e35-443">**Material ID**</span></span>|
   |-------------------|:------|:------|
   |<span data-ttu-id="f5e35-444">Teams 會議室進階版</span><span class="sxs-lookup"><span data-stu-id="f5e35-444">Teams Rooms Premium</span></span> |<span data-ttu-id="f5e35-445">5db9aa31-f039-4740-b122-a33514e4c492</span><span class="sxs-lookup"><span data-stu-id="f5e35-445">5db9aa31-f039-4740-b122-a33514e4c492</span></span>|<span data-ttu-id="f5e35-446">6XB-00007</span><span class="sxs-lookup"><span data-stu-id="f5e35-446">6XB-00007</span></span>|
   |<span data-ttu-id="f5e35-447">Teams 會議室進階版 (USA 和 CAN)</span><span class="sxs-lookup"><span data-stu-id="f5e35-447">Teams Rooms Premium (USA and CAN)</span></span>|<span data-ttu-id="f5e35-448">03070f91-cc77-4c2e-b269-4a214b3698ab</span><span class="sxs-lookup"><span data-stu-id="f5e35-448">03070f91-cc77-4c2e-b269-4a214b3698ab</span></span>|<span data-ttu-id="f5e35-449">6XB-00008</span><span class="sxs-lookup"><span data-stu-id="f5e35-449">6XB-00008</span></span>|
   |<span data-ttu-id="f5e35-450">Teams 會議室進階版 (教職員用)</span><span class="sxs-lookup"><span data-stu-id="f5e35-450">Teams Rooms Premium for faculty</span></span>|<span data-ttu-id="f5e35-451">d0c9a9a9-c9b6-41d7-9148-b60115c36c95</span><span class="sxs-lookup"><span data-stu-id="f5e35-451">d0c9a9a9-c9b6-41d7-9148-b60115c36c95</span></span>|<span data-ttu-id="f5e35-452">6Y5-00005</span><span class="sxs-lookup"><span data-stu-id="f5e35-452">6Y5-00005</span></span>|

<span data-ttu-id="f5e35-453">為了協助您熟悉新的供應項目和地理可用性，請造訪[常見問題集 (FAQ)](https://partner.microsoft.com/resources/detail/faq-microsoft-teams-rooms-premium-sku-for-microsoft-teams-pdf)。</span><span class="sxs-lookup"><span data-stu-id="f5e35-453">To help you become familiar with the new offer and the geographical availability, visit the [frequently asked questions (FAQ)](https://partner.microsoft.com/resources/detail/faq-microsoft-teams-rooms-premium-sku-for-microsoft-teams-pdf).</span></span>

### <a name="next-steps"></a><span data-ttu-id="f5e35-454">後續步驟</span><span class="sxs-lookup"><span data-stu-id="f5e35-454">Next steps</span></span>

- <span data-ttu-id="f5e35-455">在 [rooms.microsoft.com](https://rooms.microsoft.com/) 深入了解 Microsoft 會議室和相關供應項目。</span><span class="sxs-lookup"><span data-stu-id="f5e35-455">Learn more about Microsoft Rooms and related offers at [rooms.microsoft.com](https://rooms.microsoft.com/).</span></span> 
- <span data-ttu-id="f5e35-456">使用 [Teams 合作夥伴指南](https://aka.ms/teamscallingmeetingsguide)來發展 Teams 會議室實務，並建立共同銷售就緒的供應項目。</span><span class="sxs-lookup"><span data-stu-id="f5e35-456">Use the [Teams Partner Guide](https://aka.ms/teamscallingmeetingsguide) to develop your practice with Teams Meeting Rooms, and create a Co-sell Ready offer.</span></span> 
- <span data-ttu-id="f5e35-457">如需產品解決方案和服務的詳細資訊，請檢閱 [Microsoft Teams 會議室常見問題集](https://aka.ms/PartnerMTRFAQ)。</span><span class="sxs-lookup"><span data-stu-id="f5e35-457">Review the [Microsoft Teams Rooms FAQ](https://aka.ms/PartnerMTRFAQ) for more information about the product solution and services.</span></span> 
- <span data-ttu-id="f5e35-458">請與您組織中所有的適當連絡人分享這項資訊，以了解追加銷售和交叉銷售商機。</span><span class="sxs-lookup"><span data-stu-id="f5e35-458">Share this information with all appropriate contacts in your organization and understand the upsell and cross-sell opportunities.</span></span>

### <a name="questions"></a><span data-ttu-id="f5e35-459">有問題嗎？</span><span class="sxs-lookup"><span data-stu-id="f5e35-459">Questions?</span></span>

<span data-ttu-id="f5e35-460">如有關於這些供應項目的進一步問題，請洽詢相關的 Yammer 社群。</span><span class="sxs-lookup"><span data-stu-id="f5e35-460">For further questions about these offers, check your relevant Yammer communities.</span></span>

________________


## <a name="microsoft-calling-plans-are-now-available-in-new-markets"></a><a name="6"></a><span data-ttu-id="f5e35-461">Microsoft 通話方案現已在新市場中推出</span><span class="sxs-lookup"><span data-stu-id="f5e35-461">Microsoft Calling Plans are now available in new markets</span></span>

### <a name="categories"></a><span data-ttu-id="f5e35-462">類別</span><span class="sxs-lookup"><span data-stu-id="f5e35-462">Categories</span></span>

- <span data-ttu-id="f5e35-463">日期：2020-10-02</span><span class="sxs-lookup"><span data-stu-id="f5e35-463">Date: 2020-10-02</span></span>
- <span data-ttu-id="f5e35-464">供應項目/市場</span><span class="sxs-lookup"><span data-stu-id="f5e35-464">Offers/Markets</span></span>

### <a name="summary"></a><span data-ttu-id="f5e35-465">摘要</span><span class="sxs-lookup"><span data-stu-id="f5e35-465">Summary</span></span>

<span data-ttu-id="f5e35-466">Microsoft 很高興地宣佈，下列新市場現已開始提供 Microsoft 通話方案：奧地利、丹麥、義大利、葡萄牙、瑞典和瑞士。</span><span class="sxs-lookup"><span data-stu-id="f5e35-466">Microsoft is excited to announce that Microsoft Calling Plans are now available in the following new markets: Austria, Denmark, Italy, Portugal, Sweden, and Switzerland.</span></span>
 
### <a name="impacted-audience"></a><span data-ttu-id="f5e35-467">影響對象</span><span class="sxs-lookup"><span data-stu-id="f5e35-467">Impacted audience</span></span>

<span data-ttu-id="f5e35-468">雲端解決方案提供者 (CSP) 直接提供者、間接提供者與間接轉銷商</span><span class="sxs-lookup"><span data-stu-id="f5e35-468">Cloud Solution Provider (CSP) direct providers, indirect providers, and indirect resellers</span></span>

### <a name="details"></a><span data-ttu-id="f5e35-469">詳細資料</span><span class="sxs-lookup"><span data-stu-id="f5e35-469">Details</span></span>

<span data-ttu-id="f5e35-470">Microsoft 很高興地宣佈，從 2020 年 10 月 1 日起，下列新市場現已開始提供 Microsoft 通話方案：奧地利、丹麥、義大利、葡萄牙、瑞典和瑞士。</span><span class="sxs-lookup"><span data-stu-id="f5e35-470">Microsoft is excited to announce that, as of October 1, 2020, Microsoft Calling Plans are now available in the following new markets: Austria, Denmark, Italy, Portugal, Sweden, and Switzerland.</span></span> <span data-ttu-id="f5e35-471">新的地區可用性已透過 Enterprise 合約 (EA) 或 Enterprise 合約訂用帳戶 (EAS)、教育解決方案註冊 (EES)、Web Direct 和 CSP，在商業、全球公共部門、非營利和政府社群雲端中啟動。</span><span class="sxs-lookup"><span data-stu-id="f5e35-471">The new geo availability was launched in Commercial, Worldwide Public Sector, Non-profit, and Government Community Cloud via Enterprise Agreement (EA) or Enterprise Agreement Subscription (EAS), Enrollment for Education Solutions (EES), Web Direct, and CSP.</span></span>

<span data-ttu-id="f5e35-472">所有 Microsoft 通話方案功能都適用於 Microsoft 的國內和國際通話方案，包括每位使用者每個月 120、240 和 1,200 分鐘 (p/u/m) 的國內方案，以及包含國內 1,200 分鐘 (p/u/m) 和國際 600 分鐘 (p/u/m) 的國際方案。</span><span class="sxs-lookup"><span data-stu-id="f5e35-472">All Microsoft Calling Plans features are available for Microsoft's Domestic and International Calling Plans, including the 120, 240, and 1,200 minutes per user per month (p/u/m) Domestic plans, and the International Plan with 1,200 domestic minutes p/u/m and 600 international minutes p/u/m.</span></span>

<span data-ttu-id="f5e35-473">Microsoft 通話方案先前已於下列市場中提供：比利時、加拿大、法國、德國、愛爾蘭、荷蘭、波多黎各 (其通路可用性僅限於 EA 和 EES)、西班牙、英國和美國 (澳大利亞和日本適用第三方通話方案)。</span><span class="sxs-lookup"><span data-stu-id="f5e35-473">Microsoft Calling Plans were previously made available in the following markets: Belgium, Canada, France, Germany, Ireland, Netherlands, Puerto Rico (with channel availability limited to EA and EES only), Spain, United Kingdom, and United States (with third-party Calling Plan availability in Australia and Japan).</span></span>

#### <a name="offer-details"></a><span data-ttu-id="f5e35-474">供應項目詳細資料</span><span class="sxs-lookup"><span data-stu-id="f5e35-474">Offer details</span></span>

   |<span data-ttu-id="f5e35-475">**供應項目名稱**</span><span class="sxs-lookup"><span data-stu-id="f5e35-475">**Offer name**</span></span>|<span data-ttu-id="f5e35-476">**優惠識別碼**</span><span class="sxs-lookup"><span data-stu-id="f5e35-476">**Offer ID**</span></span>|<span data-ttu-id="f5e35-477">**材質識別碼**</span><span class="sxs-lookup"><span data-stu-id="f5e35-477">**Material ID**</span></span>|
   |-------------------|:------|:------|
   |<span data-ttu-id="f5e35-478">Microsoft 365 國內通話方案</span><span class="sxs-lookup"><span data-stu-id="f5e35-478">Microsoft 365 Domestic Calling Plan</span></span>|<span data-ttu-id="f5e35-479">52b01454-aa44-4e03-8049-c4d57496a430</span><span class="sxs-lookup"><span data-stu-id="f5e35-479">52b01454-aa44-4e03-8049-c4d57496a430</span></span>|<span data-ttu-id="f5e35-480">4ID-00002</span><span class="sxs-lookup"><span data-stu-id="f5e35-480">4ID-00002</span></span>|
   |<span data-ttu-id="f5e35-481">Microsoft 365 國內通話方案</span><span class="sxs-lookup"><span data-stu-id="f5e35-481">Microsoft 365 Domestic Calling Plan</span></span>|<span data-ttu-id="f5e35-482">0f598efe-f330-4d79-b79f-c9480bb7ce3e</span><span class="sxs-lookup"><span data-stu-id="f5e35-482">0f598efe-f330-4d79-b79f-c9480bb7ce3e</span></span>|<span data-ttu-id="f5e35-483">AAA-13706</span><span class="sxs-lookup"><span data-stu-id="f5e35-483">AAA-13706</span></span>|
   |<span data-ttu-id="f5e35-484">Microsoft 365 國內通話方案 (政府機構定價)</span><span class="sxs-lookup"><span data-stu-id="f5e35-484">Microsoft 365 Domestic Calling Plan (Government Pricing)</span></span>|<span data-ttu-id="f5e35-485">96b96fd8-b77d-41a4-ae5d-0a6652f454b7</span><span class="sxs-lookup"><span data-stu-id="f5e35-485">96b96fd8-b77d-41a4-ae5d-0a6652f454b7</span></span>|<span data-ttu-id="f5e35-486">AAA-13707</span><span class="sxs-lookup"><span data-stu-id="f5e35-486">AAA-13707</span></span>|
   |<span data-ttu-id="f5e35-487">Microsoft 365 學生用國內通話方案</span><span class="sxs-lookup"><span data-stu-id="f5e35-487">Microsoft 365 Domestic Calling Plan for students</span></span>|<span data-ttu-id="f5e35-488">da2034e1-c147-4aae-afab-9c15acf16ea5</span><span class="sxs-lookup"><span data-stu-id="f5e35-488">da2034e1-c147-4aae-afab-9c15acf16ea5</span></span>|<span data-ttu-id="f5e35-489">AAA-22335</span><span class="sxs-lookup"><span data-stu-id="f5e35-489">AAA-22335</span></span>|
   |<span data-ttu-id="f5e35-490">Microsoft 365 教職員用國內通話方案</span><span class="sxs-lookup"><span data-stu-id="f5e35-490">Microsoft 365 Domestic Calling Plan for faculty</span></span>|<span data-ttu-id="f5e35-491">5e8853ed-611c-4f9c-af21-540ba351a636</span><span class="sxs-lookup"><span data-stu-id="f5e35-491">5e8853ed-611c-4f9c-af21-540ba351a636</span></span>|<span data-ttu-id="f5e35-492">AAA-22334</span><span class="sxs-lookup"><span data-stu-id="f5e35-492">AAA-22334</span></span>|
   |<span data-ttu-id="f5e35-493">Microsoft 365 GCC 國內通話方案</span><span class="sxs-lookup"><span data-stu-id="f5e35-493">Microsoft 365 Domestic Calling Plan for GCC</span></span>|<span data-ttu-id="f5e35-494">7099743e-f474-48be-97bc-d4fb22f059bf</span><span class="sxs-lookup"><span data-stu-id="f5e35-494">7099743e-f474-48be-97bc-d4fb22f059bf</span></span>|<span data-ttu-id="f5e35-495">AAD-25690</span><span class="sxs-lookup"><span data-stu-id="f5e35-495">AAD-25690</span></span>|
   |<span data-ttu-id="f5e35-496">Microsoft 365 國內及國際通話方案</span><span class="sxs-lookup"><span data-stu-id="f5e35-496">Microsoft 365 Domestic and International Calling Plan</span></span>|<span data-ttu-id="f5e35-497">ded34535-507f-4246-8370-f9180318c537</span><span class="sxs-lookup"><span data-stu-id="f5e35-497">ded34535-507f-4246-8370-f9180318c537</span></span>|<span data-ttu-id="f5e35-498">AAA-13708</span><span class="sxs-lookup"><span data-stu-id="f5e35-498">AAA-13708</span></span>|
   |<span data-ttu-id="f5e35-499">Microsoft 365 國內及國際通話方案 (政府機構定價)</span><span class="sxs-lookup"><span data-stu-id="f5e35-499">Microsoft 365 Domestic and International Calling Plan (Government Pricing)</span></span>|<span data-ttu-id="f5e35-500">d97b23b4-627c-41db-8f55-ce342b0db656</span><span class="sxs-lookup"><span data-stu-id="f5e35-500">d97b23b4-627c-41db-8f55-ce342b0db656</span></span>|<span data-ttu-id="f5e35-501">AAA-13709</span><span class="sxs-lookup"><span data-stu-id="f5e35-501">AAA-13709</span></span>|
   |<span data-ttu-id="f5e35-502">Microsoft 365 學生用國內及國際通話方案</span><span class="sxs-lookup"><span data-stu-id="f5e35-502">Microsoft 365 Domestic and International Calling Plan for students</span></span>|<span data-ttu-id="f5e35-503">64ed3fb4-9f46-4e8a-b287-7a3662245c37</span><span class="sxs-lookup"><span data-stu-id="f5e35-503">64ed3fb4-9f46-4e8a-b287-7a3662245c37</span></span>|<span data-ttu-id="f5e35-504">AAA-22337</span><span class="sxs-lookup"><span data-stu-id="f5e35-504">AAA-22337</span></span>|
   |<span data-ttu-id="f5e35-505">Microsoft 365 教職員用國內及國際通話方案</span><span class="sxs-lookup"><span data-stu-id="f5e35-505">Microsoft 365 Domestic and International Calling Plan for faculty</span></span>|<span data-ttu-id="f5e35-506">492b8a14-381c-4536-bf63-bd5785c14734</span><span class="sxs-lookup"><span data-stu-id="f5e35-506">492b8a14-381c-4536-bf63-bd5785c14734</span></span>|<span data-ttu-id="f5e35-507">AAA-22336</span><span class="sxs-lookup"><span data-stu-id="f5e35-507">AAA-22336</span></span>|
   |<span data-ttu-id="f5e35-508">Microsoft 365 GCC 國內及國際通話方案</span><span class="sxs-lookup"><span data-stu-id="f5e35-508">Microsoft 365 Domestic and International Calling Plan for GCC</span></span>|<span data-ttu-id="f5e35-509">0cf5df85-ecf5-43f5-93b0-04a950e906a3</span><span class="sxs-lookup"><span data-stu-id="f5e35-509">0cf5df85-ecf5-43f5-93b0-04a950e906a3</span></span>|<span data-ttu-id="f5e35-510">AAD-25680</span><span class="sxs-lookup"><span data-stu-id="f5e35-510">AAD-25680</span></span>|
   |<span data-ttu-id="f5e35-511">Microsoft 365 國內通話方案 (120 分鐘)</span><span class="sxs-lookup"><span data-stu-id="f5e35-511">Microsoft 365 Domestic Calling Plan (120 min)</span></span>|<span data-ttu-id="f5e35-512">40d28d55-0006-4bb0-8f41-37ac05df5dc7</span><span class="sxs-lookup"><span data-stu-id="f5e35-512">40d28d55-0006-4bb0-8f41-37ac05df5dc7</span></span>|<span data-ttu-id="f5e35-513">AAD-11639</span><span class="sxs-lookup"><span data-stu-id="f5e35-513">AAD-11639</span></span>|
   |<span data-ttu-id="f5e35-514">Microsoft 365 學生用國內通話方案 (120 分鐘)</span><span class="sxs-lookup"><span data-stu-id="f5e35-514">Microsoft 365 Domestic Calling Plan (120 min) for students</span></span>|<span data-ttu-id="f5e35-515">353d7f89-2e6f-4deb-9145-80f281a782ab</span><span class="sxs-lookup"><span data-stu-id="f5e35-515">353d7f89-2e6f-4deb-9145-80f281a782ab</span></span>|<span data-ttu-id="f5e35-516">AAD-11641</span><span class="sxs-lookup"><span data-stu-id="f5e35-516">AAD-11641</span></span>|
   |<span data-ttu-id="f5e35-517">Microsoft 365 教職員用國內通話方案 (120 分鐘)</span><span class="sxs-lookup"><span data-stu-id="f5e35-517">Microsoft 365 Domestic Calling Plan (120 min) for faculty</span></span>|<span data-ttu-id="f5e35-518">80fc6c74-cc94-478d-97b0-8455593a5987</span><span class="sxs-lookup"><span data-stu-id="f5e35-518">80fc6c74-cc94-478d-97b0-8455593a5987</span></span>|<span data-ttu-id="f5e35-519">AAD-11640</span><span class="sxs-lookup"><span data-stu-id="f5e35-519">AAD-11640</span></span>|

### <a name="next-steps"></a><span data-ttu-id="f5e35-520">後續步驟</span><span class="sxs-lookup"><span data-stu-id="f5e35-520">Next Steps</span></span>

- <span data-ttu-id="f5e35-521">如果您所在的市場是在 2020 年 10 月 1 日開始提供通話方案，請與您的利害關係人分享這項資訊</span><span class="sxs-lookup"><span data-stu-id="f5e35-521">If you are in a market where the calling plans are made available on October 1, 2020, share this with your stakeholders</span></span> 
- <span data-ttu-id="f5e35-522">請與這些地區的客戶聯繫，以討論 Microsoft 通話方案。</span><span class="sxs-lookup"><span data-stu-id="f5e35-522">Reach out to your customers in these geos to discuss Microsoft Calling Plans.</span></span> 
- <span data-ttu-id="f5e35-523">推薦客戶參加 Microsoft Teams 通話研討會</span><span class="sxs-lookup"><span data-stu-id="f5e35-523">Nominate your customer for a Microsoft Teams Calling Workshop</span></span> 
- <span data-ttu-id="f5e35-524">利用 Microsoft Teams 合作夥伴指南來發展您的通話實務</span><span class="sxs-lookup"><span data-stu-id="f5e35-524">Leverage the Microsoft Teams Partner Guide to develop your Calling practice</span></span> 
- <span data-ttu-id="f5e35-525">取得 Microsoft Teams 通話進階專長</span><span class="sxs-lookup"><span data-stu-id="f5e35-525">Attain a Calling for Microsoft Teams Advanced Specialization</span></span> 

### <a name="questions"></a><span data-ttu-id="f5e35-526">有問題嗎？</span><span class="sxs-lookup"><span data-stu-id="f5e35-526">Questions?</span></span>

<span data-ttu-id="f5e35-527">如有關於這些供應項目的進一步問題，請洽詢相關的 Yammer 社群。</span><span class="sxs-lookup"><span data-stu-id="f5e35-527">For any further questions about these offers, check your relevant Yammer communities.</span></span>

________________

## <a name="promotions-for-microsoft-teams-advanced-communications-are-coming-soon"></a><a name="5"></a><span data-ttu-id="f5e35-528">Microsoft Teams 進階通訊的促銷即將推出</span><span class="sxs-lookup"><span data-stu-id="f5e35-528">Promotions for Microsoft Teams Advanced Communications are coming soon</span></span>

### <a name="categories"></a><span data-ttu-id="f5e35-529">類別</span><span class="sxs-lookup"><span data-stu-id="f5e35-529">Categories</span></span>

- <span data-ttu-id="f5e35-530">日期：2020-10-02</span><span class="sxs-lookup"><span data-stu-id="f5e35-530">Date: 2020-10-02</span></span>
- <span data-ttu-id="f5e35-531">供應項目/市場</span><span class="sxs-lookup"><span data-stu-id="f5e35-531">Offers/Markets</span></span>
 
### <a name="summary"></a><span data-ttu-id="f5e35-532">摘要</span><span class="sxs-lookup"><span data-stu-id="f5e35-532">Summary</span></span>

<span data-ttu-id="f5e35-533">2020 年 11 月 1 日時，Microsoft Teams 進階通訊將有新的促銷價格。</span><span class="sxs-lookup"><span data-stu-id="f5e35-533">On November 1, 2020, new promotional pricing for Microsoft Teams Advanced Communications will be available.</span></span> 

### <a name="impacted-audience"></a><span data-ttu-id="f5e35-534">影響對象</span><span class="sxs-lookup"><span data-stu-id="f5e35-534">Impacted audience</span></span>

<span data-ttu-id="f5e35-535">透過雲端解決方案提供者 (CSP) 方案交易的所有合作夥伴。</span><span class="sxs-lookup"><span data-stu-id="f5e35-535">All partners transacting through the Cloud Solution Provider (CSP) program.</span></span>

### <a name="details"></a><span data-ttu-id="f5e35-536">詳細資料</span><span class="sxs-lookup"><span data-stu-id="f5e35-536">Details</span></span>

<span data-ttu-id="f5e35-537">Microsoft Teams 進階通訊促銷 SKU 將從 2020 年 11 月 1 日起以 35% 的折扣推出。</span><span class="sxs-lookup"><span data-stu-id="f5e35-537">The Advanced Communications Promo SKU for Microsoft Teams will be available from November 1, 2020 at a 35 percent discount.</span></span> <span data-ttu-id="f5e35-538">此 SKU 可於 2020 年 11 月 1 日到 2021 年 1 月 31 日期間購買。</span><span class="sxs-lookup"><span data-stu-id="f5e35-538">The SKU can be purchased from November 1, 2020 through January 31, 2021.</span></span> 

 
#### <a name="offer-details"></a><span data-ttu-id="f5e35-539">供應項目詳細資料</span><span class="sxs-lookup"><span data-stu-id="f5e35-539">Offer details</span></span>

   |<span data-ttu-id="f5e35-540">**供應項目名稱**</span><span class="sxs-lookup"><span data-stu-id="f5e35-540">**Offer name**</span></span>|<span data-ttu-id="f5e35-541">**優惠識別碼**</span><span class="sxs-lookup"><span data-stu-id="f5e35-541">**Offer ID**</span></span>|<span data-ttu-id="f5e35-542">**材質識別碼**</span><span class="sxs-lookup"><span data-stu-id="f5e35-542">**Material ID**</span></span>|
   |-------------------|:------|:------|
   |<span data-ttu-id="f5e35-543">進階通訊促銷</span><span class="sxs-lookup"><span data-stu-id="f5e35-543">Advanced Communications Promo</span></span>|<span data-ttu-id="f5e35-544">0e89eea4-5cb1-4417-9f5d-886d1ff87940</span><span class="sxs-lookup"><span data-stu-id="f5e35-544">0e89eea4-5cb1-4417-9f5d-886d1ff87940</span></span>|<span data-ttu-id="f5e35-545">1UC-00013</span><span class="sxs-lookup"><span data-stu-id="f5e35-545">1UC-00013</span></span>|

#### <a name="frequently-asked-questions"></a><span data-ttu-id="f5e35-546">常見問題集</span><span class="sxs-lookup"><span data-stu-id="f5e35-546">Frequently asked questions</span></span>

<span data-ttu-id="f5e35-547">**什麼是進階通訊？**</span><span class="sxs-lookup"><span data-stu-id="f5e35-547">**What is Advanced Communication?**</span></span>
<span data-ttu-id="f5e35-548">這是新的 Microsoft Teams 附加元件 SKU，可讓客戶在其訂閱的任何 Microsoft 365 或 Office 365 套件之上進一步增強其通訊體驗。</span><span class="sxs-lookup"><span data-stu-id="f5e35-548">This is a new Microsoft Teams add-on SKU, enabling customers to further enhance their communication experience on top of any Microsoft 365 or Office 365 suite they are subscribed to.</span></span>

<span data-ttu-id="f5e35-549">**沒有促銷時需要多少費用？**</span><span class="sxs-lookup"><span data-stu-id="f5e35-549">**How much does it cost without the promotion?**</span></span>
<span data-ttu-id="f5e35-550">每位使用者每月的商用估計零售價格為 12 美元。</span><span class="sxs-lookup"><span data-stu-id="f5e35-550">The commercial estimated retail price is $12 per user per month.</span></span>

<span data-ttu-id="f5e35-551">**哪些客戶可以購買進階通訊？**</span><span class="sxs-lookup"><span data-stu-id="f5e35-551">**Which customers can purchase Advanced Communications?**</span></span>
<span data-ttu-id="f5e35-552">商業、全球商業公共事業部門、教育和非營利組織。</span><span class="sxs-lookup"><span data-stu-id="f5e35-552">Commercial, Worldwide Commercial Public Sector, Education, and Nonprofit.</span></span>

<span data-ttu-id="f5e35-553">**可透過哪些管道購買進階通訊？**</span><span class="sxs-lookup"><span data-stu-id="f5e35-553">**Through which channels can Advanced Communications be purchased?**</span></span>
<span data-ttu-id="f5e35-554">Enterprise 合約 (EA)/Enterprise 訂用帳戶 (EAS)、教育解決方案註冊 (EES)、CSP 或 Web Direct。</span><span class="sxs-lookup"><span data-stu-id="f5e35-554">Enterprise Agreement (EA)/Enterprise Subscription (EAS), Enrollment for Education Solutions (EES), CSP, or Web Direct.</span></span>

<span data-ttu-id="f5e35-555">**哪些客戶可以購買進階通訊促銷 SKU？**</span><span class="sxs-lookup"><span data-stu-id="f5e35-555">**Which customers can purchase the Advanced Communications promo SKU?**</span></span>
<span data-ttu-id="f5e35-556">僅限商業客戶。</span><span class="sxs-lookup"><span data-stu-id="f5e35-556">Commercial customers only.</span></span>

<span data-ttu-id="f5e35-557">**如何購買進階通訊促銷 SKU？**</span><span class="sxs-lookup"><span data-stu-id="f5e35-557">**How can the Advanced Communications promo SKU be purchased?**</span></span>
<span data-ttu-id="f5e35-558">促銷 SKU 可透過 EA/EAS 或 CSP 購買。</span><span class="sxs-lookup"><span data-stu-id="f5e35-558">The promo SKU can be purchased through EA/EAS or CSP.</span></span> 

<span data-ttu-id="f5e35-559">**可以在何處銷售？**</span><span class="sxs-lookup"><span data-stu-id="f5e35-559">**Where can it be sold?**</span></span>
<span data-ttu-id="f5e35-560">該元件可以在目前所有市場中銷售。</span><span class="sxs-lookup"><span data-stu-id="f5e35-560">It can be sold in all current markets.</span></span>

<span data-ttu-id="f5e35-561">**進階通訊的必要條件為何？**</span><span class="sxs-lookup"><span data-stu-id="f5e35-561">**What are the pre-requisites for Advanced Communications?**</span></span>
<span data-ttu-id="f5e35-562">Microsoft Teams 和任何 Microsoft 365/Office 365 套件。</span><span class="sxs-lookup"><span data-stu-id="f5e35-562">Microsoft Teams and any Microsoft 365/Office 365 suite.</span></span>

### <a name="next-steps"></a><span data-ttu-id="f5e35-563">後續步驟</span><span class="sxs-lookup"><span data-stu-id="f5e35-563">Next steps</span></span>

- <span data-ttu-id="f5e35-564">請與您組織中相關連絡人分享這項資訊，以了解追加銷售和交叉銷售商機。</span><span class="sxs-lookup"><span data-stu-id="f5e35-564">Share this information with the relevant contacts in your organization and understand the upsell and cross-sell opportunities.</span></span>
- <span data-ttu-id="f5e35-565">請參閱 [Teams 合作夥伴指南](https://aka.ms/teamscallingmeetingsguide)的資源區段。</span><span class="sxs-lookup"><span data-stu-id="f5e35-565">Review the resources section of the [Teams Partner Guide](https://aka.ms/teamscallingmeetingsguide).</span></span>
- <span data-ttu-id="f5e35-566">您可以在[部落格](https://www.microsoft.com/microsoft-365/blog/2020/09/08/3-deals-meeting-calling-experiences-microsoft-teams/)或 [Office 365 合作夥伴 Yammer 群組](https://www.yammer.com/office365partners/)上找到 Microsoft Teams 促銷供應項目的其他資訊。</span><span class="sxs-lookup"><span data-stu-id="f5e35-566">You can find additional information on Microsoft Teams promotional offers on [the blog](https://www.microsoft.com/microsoft-365/blog/2020/09/08/3-deals-meeting-calling-experiences-microsoft-teams/) or at the [Office 365 partner yammer group](https://www.yammer.com/office365partners/).</span></span>

### <a name="questions"></a><span data-ttu-id="f5e35-567">有問題嗎？</span><span class="sxs-lookup"><span data-stu-id="f5e35-567">Questions?</span></span>

<span data-ttu-id="f5e35-568">如有關於這些供應項目的任何問題，請連絡 Microsoft 客戶小組或支援部門的代表。</span><span class="sxs-lookup"><span data-stu-id="f5e35-568">For any questions about these offers, contact your representative in the Microsoft account team or support.</span></span>

________________

## <a name="upcoming-new-offers-and-products-for-dynamics-365"></a><a name="4"></a><span data-ttu-id="f5e35-569">Dynamics 365 的新供應項目和產品即將推出</span><span class="sxs-lookup"><span data-stu-id="f5e35-569">Upcoming new offers and products for Dynamics 365</span></span>

### <a name="categories"></a><span data-ttu-id="f5e35-570">類別</span><span class="sxs-lookup"><span data-stu-id="f5e35-570">Categories</span></span>

- <span data-ttu-id="f5e35-571">日期：2020-10-02</span><span class="sxs-lookup"><span data-stu-id="f5e35-571">Date: 2020-10-02</span></span>
- <span data-ttu-id="f5e35-572">供應項目/市場</span><span class="sxs-lookup"><span data-stu-id="f5e35-572">Offers/Markets</span></span>
 
### <a name="impacted-audience"></a><span data-ttu-id="f5e35-573">影響對象</span><span class="sxs-lookup"><span data-stu-id="f5e35-573">Impacted audience</span></span>

<span data-ttu-id="f5e35-574">雲端解決方案提供者 (CSP) 合作夥伴</span><span class="sxs-lookup"><span data-stu-id="f5e35-574">Cloud Solution Provider (CSP) partners</span></span>

### <a name="details"></a><span data-ttu-id="f5e35-575">詳細資料</span><span class="sxs-lookup"><span data-stu-id="f5e35-575">Details</span></span>

<span data-ttu-id="f5e35-576">Microsoft 將於 2020 年 11 月 1 日發行下列全新和更新的 Dynamics 365 和 Power Platform 供應項目，以及適用於 CSP 計畫的產品：</span><span class="sxs-lookup"><span data-stu-id="f5e35-576">On November 1, 2020, Microsoft will release the following new and updated Dynamics 365 and Power Platform offers and products for the CSP program:</span></span> 

- <span data-ttu-id="f5e35-577">Dynamics 365 客戶語音使用者訂用帳戶授權 (USL)</span><span class="sxs-lookup"><span data-stu-id="f5e35-577">Dynamics 365 Customer Voice User Subscription License (USL)</span></span> 
- <span data-ttu-id="f5e35-578">將供應項目擴充至 CSP</span><span class="sxs-lookup"><span data-stu-id="f5e35-578">Expand offers into CSP</span></span>

### <a name="additional-resources"></a><span data-ttu-id="f5e35-579">其他資源</span><span class="sxs-lookup"><span data-stu-id="f5e35-579">Additional resources</span></span>

- <span data-ttu-id="f5e35-580">如需供應項目識別碼詳細資料，請參閱 [Dynamics CSP Offers-November 2020 Excel 文件](https://partner.microsoft.com/resources/detail/dynamics-csp-offers-november-2020-xls)中的 [Project Operations] 索引標籤。</span><span class="sxs-lookup"><span data-stu-id="f5e35-580">Review the Project Operations tab in the [Dynamics CSP Offers-November 2020](https://partner.microsoft.com/resources/detail/dynamics-csp-offers-november-2020-xls) Excel document for offer ID details.</span></span>
- <span data-ttu-id="f5e35-581">如需詳細資訊，請參閱 [Microsoft Dynamics 365 客戶語音首頁](https://dynamics.microsoft.com/customer-voice/overview/)。</span><span class="sxs-lookup"><span data-stu-id="f5e35-581">Find more information on the [Microsoft Dynamics 365 Customer Voice Home Page](https://dynamics.microsoft.com/customer-voice/overview/).</span></span>
- <span data-ttu-id="f5e35-582">檢視 9 月的 [Dynamics 全新供應項目公告](2020-september.md#3)。</span><span class="sxs-lookup"><span data-stu-id="f5e35-582">View the September [Dynamics new offers announcement](2020-september.md#3).</span></span>

________________

## <a name="windows-7-year-2-extended-security-updates-esu-now-available-for-cloud-solution-provider-csp-partners"></a><a name="3"></a><span data-ttu-id="f5e35-583">Windows 7 Year 2 擴充安全性更新 (ESU) 現已在雲端解決方案提供者 (CSP) 合作夥伴中推出</span><span class="sxs-lookup"><span data-stu-id="f5e35-583">Windows 7 Year 2 Extended Security Updates (ESU) now available for Cloud Solution Provider (CSP) partners</span></span> 

### <a name="categories"></a><span data-ttu-id="f5e35-584">類別</span><span class="sxs-lookup"><span data-stu-id="f5e35-584">Categories</span></span>

- <span data-ttu-id="f5e35-585">日期：2020-10-01</span><span class="sxs-lookup"><span data-stu-id="f5e35-585">Date: 2020-10-01</span></span>
- <span data-ttu-id="f5e35-586">供應項目/市場</span><span class="sxs-lookup"><span data-stu-id="f5e35-586">Offers/Markets</span></span>
 
### <a name="impacted-audience"></a><span data-ttu-id="f5e35-587">影響對象</span><span class="sxs-lookup"><span data-stu-id="f5e35-587">Impacted audience</span></span>

<span data-ttu-id="f5e35-588">參與 CSP 計畫的所有合作夥伴</span><span class="sxs-lookup"><span data-stu-id="f5e35-588">All partners participating in the CSP program</span></span>

### <a name="details"></a><span data-ttu-id="f5e35-589">詳細資料</span><span class="sxs-lookup"><span data-stu-id="f5e35-589">Details</span></span>

<span data-ttu-id="f5e35-590">支援在 2020 年 1 月 14 日結束的 Windows 7。</span><span class="sxs-lookup"><span data-stu-id="f5e35-590">Support for Windows 7 ended on January 14, 2020.</span></span> <span data-ttu-id="f5e35-591">雖然許多客戶都有辦法部署 Windows 10，但 Microsoft 了解每個人都在其升級過程中的不同點。</span><span class="sxs-lookup"><span data-stu-id="f5e35-591">While many customers are well on their way to deploying Windows 10, Microsoft understands that everyone is at a different point in their upgrade process.</span></span> <span data-ttu-id="f5e35-592">隨著 Windows 7 Year 1 ESU 有效期間將於 2021 年 1 月 12 日結束，我們知道客戶正開始規劃下一年。</span><span class="sxs-lookup"><span data-stu-id="f5e35-592">With the effective period of Windows 7 Year 1 ESU ending on January 12, 2021, we know customers are starting to plan for next year.</span></span>  

<span data-ttu-id="f5e35-593">對於預計在 2021 年繼續使用 Windows 7 裝置的客戶，我們現已推出 Windows 7 Year 2 ESU (結束日期為 2022 年 1 月 12 日) 給 CSP 合作夥伴，以便其協助客戶進行 Windows 10 決策。</span><span class="sxs-lookup"><span data-stu-id="f5e35-593">For customers who expect to continue using Windows 7 devices in 2021, Windows 7 Year 2 ESU (end date January 12, 2022) is available to CSP partners now to help customers with their Windows 10 decision.</span></span> <span data-ttu-id="f5e35-594">如需詳細資訊，請造訪[資源庫](https://partner.microsoft.com/resources/collection/windows-esu-csp#/)。</span><span class="sxs-lookup"><span data-stu-id="f5e35-594">Visit the [Resource Gallery](https://partner.microsoft.com/resources/collection/windows-esu-csp#/) for more information.</span></span> 

#### <a name="additional-resources"></a><span data-ttu-id="f5e35-595">其他資源</span><span class="sxs-lookup"><span data-stu-id="f5e35-595">Additional Resources</span></span>

- [<span data-ttu-id="f5e35-596">Windows 7 支援常見問題集頁面</span><span class="sxs-lookup"><span data-stu-id="f5e35-596">Windows 7 Support FAQ page</span></span>](/troubleshoot/windows-client/windows-7-eos-faq/windows-7-end-support-faq)
- [<span data-ttu-id="f5e35-597">Windows 7 支援和 Microsoft 365 應用程式</span><span class="sxs-lookup"><span data-stu-id="f5e35-597">Windows 7 support and Microsoft 365 Apps</span></span>](/deployoffice/endofsupport/windows-7-support)
- [<span data-ttu-id="f5e35-598">資源庫</span><span class="sxs-lookup"><span data-stu-id="f5e35-598">Resource Gallery</span></span>](https://partner.microsoft.com/resources/collection/windows-esu-csp#/)

### <a name="next-steps"></a><span data-ttu-id="f5e35-599">後續步驟</span><span class="sxs-lookup"><span data-stu-id="f5e35-599">Next steps</span></span>

<span data-ttu-id="f5e35-600">檢閱本主題的相關資源，並與您的組織中適當的利害關係人分享這項資訊。</span><span class="sxs-lookup"><span data-stu-id="f5e35-600">Review the resources about this topic, and share this information with the appropriate stakeholders in your organization.</span></span>  

### <a name="questions"></a><span data-ttu-id="f5e35-601">有問題嗎？</span><span class="sxs-lookup"><span data-stu-id="f5e35-601">Questions?</span></span>

<span data-ttu-id="f5e35-602">如有關於這些供應項目的進一步問題，請洽詢相關的 Yammer 社群。</span><span class="sxs-lookup"><span data-stu-id="f5e35-602">For any further questions about these offers, check your relevant Yammer communities.</span></span> 
________________

## <a name="new-skus-bring-the-power-of-project-cortex-and-more-to-customers"></a><a name="2"></a><span data-ttu-id="f5e35-603">新的 SKU 將 Project Cortex 等技術的威力帶給客戶</span><span class="sxs-lookup"><span data-stu-id="f5e35-603">New SKUs bring the power of Project Cortex and more to customers</span></span>

### <a name="categories"></a><span data-ttu-id="f5e35-604">類別</span><span class="sxs-lookup"><span data-stu-id="f5e35-604">Categories</span></span>

- <span data-ttu-id="f5e35-605">日期：2020-10-01</span><span class="sxs-lookup"><span data-stu-id="f5e35-605">Date: 2020-10-01</span></span>
- <span data-ttu-id="f5e35-606">供應項目/市場</span><span class="sxs-lookup"><span data-stu-id="f5e35-606">Offers/Markets</span></span>

### <a name="summary"></a><span data-ttu-id="f5e35-607">摘要</span><span class="sxs-lookup"><span data-stu-id="f5e35-607">Summary</span></span>

<span data-ttu-id="f5e35-608">我們很高興地宣佈，新 SKU 已於 2020 年 10 月 1 日上市，以協助客戶充分利用 [Project Cortex](https://resources.techcommunity.microsoft.com/project-cortex-microsoft-365/) 和 Microsoft Search 的威力。</span><span class="sxs-lookup"><span data-stu-id="f5e35-608">We're excited to announce the October 1, 2020 availability of new SKUs to help customers harness the power of [Project Cortex](https://resources.techcommunity.microsoft.com/project-cortex-microsoft-365/) and Microsoft Search.</span></span>
 
### <a name="impacted-audience"></a><span data-ttu-id="f5e35-609">影響對象</span><span class="sxs-lookup"><span data-stu-id="f5e35-609">Impacted audience</span></span>

<span data-ttu-id="f5e35-610">透過雲端解決方案提供者計畫進行交易的合作夥伴</span><span class="sxs-lookup"><span data-stu-id="f5e35-610">Partners transacting through the Cloud Solution Provider program</span></span>

### <a name="details"></a><span data-ttu-id="f5e35-611">詳細資料</span><span class="sxs-lookup"><span data-stu-id="f5e35-611">Details</span></span>

<span data-ttu-id="f5e35-612">我們很高興地宣佈，新的 SKU 和價值已於 2020 年 10 月 1 日上市，以協助客戶充分利用 [Project Cortex](https://resources.techcommunity.microsoft.com/project-cortex-microsoft-365/) 和 Microsoft Search 的威力，讓其使用者能夠更有效率地尋找及管理資訊。</span><span class="sxs-lookup"><span data-stu-id="f5e35-612">We're excited to announce the October 1, 2020 availability of new SKUs and value to help customers harness the power of [Project Cortex](https://resources.techcommunity.microsoft.com/project-cortex-microsoft-365/) and Microsoft Search to enable their users to find and manage information more efficiently.</span></span>  

<span data-ttu-id="f5e35-613">**SharePoint Syntex (先前為智慧型內容服務)**</span><span class="sxs-lookup"><span data-stu-id="f5e35-613">**SharePoint Syntex (previously Intelligent Content Services)**</span></span>  
<span data-ttu-id="f5e35-614">SharePoint Syntex 使用進階 AI 來自動擷取、標記和管理內容。</span><span class="sxs-lookup"><span data-stu-id="f5e35-614">SharePoint Syntex uses advanced AI to automate the capture, tagging, and management of content.</span></span> <span data-ttu-id="f5e35-615">其建置於 SharePoint 之上，以便能夠處理大量內容、擷取中繼資料以進行程序自動化，以及實現更細微的安全性和合規性。</span><span class="sxs-lookup"><span data-stu-id="f5e35-615">It builds on SharePoint for high-volume content processing, extracting metadata for process automation, and fine-grained security and compliance.</span></span> <span data-ttu-id="f5e35-616">其藉由提供更多智慧型內容給您的知識網路，讓知識鑒藏和探索體驗變得更好。</span><span class="sxs-lookup"><span data-stu-id="f5e35-616">It makes knowledge curation and discovery experiences better by providing more intelligent content to your knowledge network.</span></span> 

<span data-ttu-id="f5e35-617">SharePoint Syntex SKU 將於 10 月 1 日的價目表 (9 月 1 日的價目表預覽已反映智慧型內容服務) 中提供。</span><span class="sxs-lookup"><span data-stu-id="f5e35-617">SharePoint Syntex SKUs will be available on the October 1 price lists (the September 1 price list preview reflected Intelligent Content Services).</span></span> <span data-ttu-id="f5e35-618">在 2020 年 11 月 1 日前，Microsoft 授權條款可能仍會以舊名稱 (智慧型內容服務) 來指稱此 SKU。</span><span class="sxs-lookup"><span data-stu-id="f5e35-618">Microsoft licensing terms may still refer to this SKU under its old name, Intelligent Content Services, until November 1, 2020.</span></span>

<span data-ttu-id="f5e35-619">**適用於 Microsoft Search 的 Microsoft Graph 連接器**</span><span class="sxs-lookup"><span data-stu-id="f5e35-619">**Microsoft Graph connectors for Microsoft Search**</span></span>  

<span data-ttu-id="f5e35-620">透過 Microsoft Graph 連接器，客戶可以針對外部存放庫中的項目編制索引，以將其納入 Microsoft Search 結果中。</span><span class="sxs-lookup"><span data-stu-id="f5e35-620">With Microsoft Graph connectors, customers can index items in external repositories for inclusion in Microsoft Search results.</span></span> <span data-ttu-id="f5e35-621">自 2020 年 10 月 1 日起：</span><span class="sxs-lookup"><span data-stu-id="f5e35-621">Beginning October 1, 2020:</span></span>

- <span data-ttu-id="f5e35-622">Microsoft 365 E5 和 Office 365 E5 將能夠使用適用於 Microsoft Search 的 Microsoft Graph 連接器 (A5 中未包含)，為多達 500 個項目編制索引。</span><span class="sxs-lookup"><span data-stu-id="f5e35-622">Microsoft 365 E5 and Office 365 E5 will include the ability to index up to 500 items using Microsoft Graph connectors for Microsoft Search (not included with A5).</span></span>  
- <span data-ttu-id="f5e35-623">任何具有套件或獨立授權 (包含 SharePoint 或 OneDrive 方案) 的使用者，都可以從適用於 Microsoft Search 的 Microsoft Graph 連接器查看搜尋結果。</span><span class="sxs-lookup"><span data-stu-id="f5e35-623">Any user with a suite or standalone license that includes a SharePoint or OneDrive plan will be able to see search results from Microsoft Graph connectors for Microsoft Search.</span></span> 
- <span data-ttu-id="f5e35-624">將有新的 **額外 Graph 連接器容量 SKU** 可供您另外編制多達 100 萬個項目的索引。</span><span class="sxs-lookup"><span data-stu-id="f5e35-624">A new **Extra Graph Connector Capacity SKU** will be available for indexing up to 1 million additional items.</span></span>

#### <a name="offer-details"></a><span data-ttu-id="f5e35-625">供應項目詳細資料</span><span class="sxs-lookup"><span data-stu-id="f5e35-625">Offer details</span></span>

   |<span data-ttu-id="f5e35-626">**供應項目名稱**</span><span class="sxs-lookup"><span data-stu-id="f5e35-626">**Offer name**</span></span>|<span data-ttu-id="f5e35-627">**優惠識別碼**</span><span class="sxs-lookup"><span data-stu-id="f5e35-627">**Offer ID**</span></span>|<span data-ttu-id="f5e35-628">**材質識別碼**</span><span class="sxs-lookup"><span data-stu-id="f5e35-628">**Material ID**</span></span>|
   |-------------------|:------|:------|
   |<span data-ttu-id="f5e35-629">SharePoint Syntex</span><span class="sxs-lookup"><span data-stu-id="f5e35-629">SharePoint Syntex</span></span>|<span data-ttu-id="f5e35-630">2e969027-6eca-44a3-88fb-e7923e2c147f</span><span class="sxs-lookup"><span data-stu-id="f5e35-630">2e969027-6eca-44a3-88fb-e7923e2c147f</span></span>|<span data-ttu-id="f5e35-631">5YI-00004</span><span class="sxs-lookup"><span data-stu-id="f5e35-631">5YI-00004</span></span>|
   |<span data-ttu-id="f5e35-632">SharePoint Syntex (非營利事業員工定價)</span><span class="sxs-lookup"><span data-stu-id="f5e35-632">SharePoint Syntex (Nonprofit Staff Pricing)</span></span>|<span data-ttu-id="f5e35-633">48db24e2-0aac-47bd-bd74-40bde9ff7748</span><span class="sxs-lookup"><span data-stu-id="f5e35-633">48db24e2-0aac-47bd-bd74-40bde9ff7748</span></span>|<span data-ttu-id="f5e35-634">5YI-00005</span><span class="sxs-lookup"><span data-stu-id="f5e35-634">5YI-00005</span></span>|
   |<span data-ttu-id="f5e35-635">SharePoint Syntex (教職員用)</span><span class="sxs-lookup"><span data-stu-id="f5e35-635">SharePoint Syntex for faculty</span></span>|<span data-ttu-id="f5e35-636">4a8f9036-791e-4ce4-a788-6c5af859fd82</span><span class="sxs-lookup"><span data-stu-id="f5e35-636">4a8f9036-791e-4ce4-a788-6c5af859fd82</span></span>|<span data-ttu-id="f5e35-637">5Z1-00005</span><span class="sxs-lookup"><span data-stu-id="f5e35-637">5Z1-00005</span></span>|
   |<span data-ttu-id="f5e35-638">額外的 Graph 連接器容量</span><span class="sxs-lookup"><span data-stu-id="f5e35-638">Extra Graph Connector Capacity</span></span>|<span data-ttu-id="f5e35-639">9c8b008f-d84f-46cd-a588-fea84947161d</span><span class="sxs-lookup"><span data-stu-id="f5e35-639">9c8b008f-d84f-46cd-a588-fea84947161d</span></span>|<span data-ttu-id="f5e35-640">1LA-00002</span><span class="sxs-lookup"><span data-stu-id="f5e35-640">1LA-00002</span></span>|
   |<span data-ttu-id="f5e35-641">適用於教職員的額外 Graph 連接器容量</span><span class="sxs-lookup"><span data-stu-id="f5e35-641">Extra Graph Connector Capacity for faculty</span></span>|<span data-ttu-id="f5e35-642">0e0eb210-86e7-4038-9905-4fd5bf71c4bd</span><span class="sxs-lookup"><span data-stu-id="f5e35-642">0e0eb210-86e7-4038-9905-4fd5bf71c4bd</span></span>|<span data-ttu-id="f5e35-643">1TL-00003</span><span class="sxs-lookup"><span data-stu-id="f5e35-643">1TL-00003</span></span>|

### <a name="next-steps"></a><span data-ttu-id="f5e35-644">後續步驟</span><span class="sxs-lookup"><span data-stu-id="f5e35-644">Next steps</span></span>

<span data-ttu-id="f5e35-645">檢閱關於本主題的資源，並與您組織中適當的利害關係人分享。</span><span class="sxs-lookup"><span data-stu-id="f5e35-645">Review the resources about this topic, and share with the appropriate stakeholders in your organization.</span></span>

### <a name="questions"></a><span data-ttu-id="f5e35-646">問題</span><span class="sxs-lookup"><span data-stu-id="f5e35-646">Questions</span></span>

<span data-ttu-id="f5e35-647">如有關於這些供應項目的進一步問題，請洽詢相關的 Yammer 社群。</span><span class="sxs-lookup"><span data-stu-id="f5e35-647">For further questions about these offers, check your relevant Yammer communities.</span></span> 
________________

## <a name="fiscal-year-2021-fy21-cloud-solution-provider-csp-incentive-program-announcement"></a><a name="1"></a><span data-ttu-id="f5e35-648">會計年度 2021 (FY21) 雲端解決方案提供者 (CSP) 獎勵計畫公告</span><span class="sxs-lookup"><span data-stu-id="f5e35-648">Fiscal year 2021 (FY21) Cloud Solution Provider (CSP) incentive program announcement</span></span>

### <a name="categories"></a><span data-ttu-id="f5e35-649">類別</span><span class="sxs-lookup"><span data-stu-id="f5e35-649">Categories</span></span>

- <span data-ttu-id="f5e35-650">日期：2020-10-01</span><span class="sxs-lookup"><span data-stu-id="f5e35-650">Date: 2020-10-01</span></span>
- <span data-ttu-id="f5e35-651">功能</span><span class="sxs-lookup"><span data-stu-id="f5e35-651">Capabilities</span></span>

### <a name="summary"></a><span data-ttu-id="f5e35-652">摘要</span><span class="sxs-lookup"><span data-stu-id="f5e35-652">Summary</span></span>

<span data-ttu-id="f5e35-653">FY21 CSP 獎勵計畫期間將於 2020 年 10 月 1 日開始。</span><span class="sxs-lookup"><span data-stu-id="f5e35-653">The FY21 CSP incentive program term begins October 1, 2020.</span></span> <span data-ttu-id="f5e35-654">您現在可以在合作夥伴中心上取得 FY21 獎勵指南和導覽集。</span><span class="sxs-lookup"><span data-stu-id="f5e35-654">The FY21 incentive guides and walking decks are now available on Partner Center.</span></span>
 
### <a name="impacted-audience"></a><span data-ttu-id="f5e35-655">影響對象</span><span class="sxs-lookup"><span data-stu-id="f5e35-655">Impacted audience</span></span>

<span data-ttu-id="f5e35-656">雲端解決方案提供者直接帳單合作夥伴、間接提供者和間接經銷商</span><span class="sxs-lookup"><span data-stu-id="f5e35-656">CSP direct bill partners, indirect providers, and indirect resellers</span></span>

### <a name="details"></a><span data-ttu-id="f5e35-657">詳細資料</span><span class="sxs-lookup"><span data-stu-id="f5e35-657">Details</span></span>

<span data-ttu-id="f5e35-658">FY20 CSP 獎勵計畫期間已於 2020 年 9 月 30 日結束。</span><span class="sxs-lookup"><span data-stu-id="f5e35-658">The FY20 CSP incentive program term ended September 30, 2020.</span></span> <span data-ttu-id="f5e35-659">FY21 CSP 獎勵計畫期間於 2020 年 10 月 1 日開始，並一直運行到 2021 年 9 月 30 日。</span><span class="sxs-lookup"><span data-stu-id="f5e35-659">The FY21 CSP incentive program term begins October 1, 2020, and runs through September 30, 2021.</span></span> <span data-ttu-id="f5e35-660">FY21 獎勵計畫指南、概觀投影片和導覽集現已公佈於[合作夥伴網站](https://aka.ms/partnerincentives/)上的相關 CSP 獎勵計畫資產集合上。</span><span class="sxs-lookup"><span data-stu-id="f5e35-660">The FY21 incentive program guides, overview slides, and walking decks are now posted on the relevant CSP incentive program asset collections on the [partner website](https://aka.ms/partnerincentives/).</span></span> <span data-ttu-id="f5e35-661">我們鼓勵合作夥伴下載並檢閱 FY21 計畫資產。</span><span class="sxs-lookup"><span data-stu-id="f5e35-661">We encourage partners to download and review the FY21 program assets.</span></span>

<span data-ttu-id="f5e35-662">更新後的 FY21 計畫費率將從 2020 年 10 月 1 日起生效。</span><span class="sxs-lookup"><span data-stu-id="f5e35-662">The updated FY21 program rates will be effective from October 1, 2020.</span></span> <span data-ttu-id="f5e35-663">合作夥伴會注意到，自 2020 年 12 月 15 日付款週期起的每月獎勵付款有對應的變更。</span><span class="sxs-lookup"><span data-stu-id="f5e35-663">Partners will notice corresponding changes to their monthly incentive payments beginning with the December 15, 2020, payment cycle.</span></span>

### <a name="next-steps"></a><span data-ttu-id="f5e35-664">後續步驟</span><span class="sxs-lookup"><span data-stu-id="f5e35-664">Next steps</span></span>

- <span data-ttu-id="f5e35-665">請檢閱 FY21 計畫資產，並針對精選產品和客戶動議的獎勵費率更新進行準備。</span><span class="sxs-lookup"><span data-stu-id="f5e35-665">Review the FY21 program assets, and prepare for updates to incentive rates on select products and customer motions.</span></span>

### <a name="questions"></a><span data-ttu-id="f5e35-666">有問題嗎？</span><span class="sxs-lookup"><span data-stu-id="f5e35-666">Questions?</span></span>

<span data-ttu-id="f5e35-667">在合作夥伴中心的搜尋列中搜尋 **獎勵**，即可取得獎勵相關問題的建議步驟和自助文章。</span><span class="sxs-lookup"><span data-stu-id="f5e35-667">Recommended steps and self-help articles for incentive-related questions are available by searching **Incentives** in the search bar of Partner Center.</span></span> 
________________
